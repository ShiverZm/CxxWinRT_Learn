...
namespace winrt::_02HelloWinRTApp::implementation
{
    ...
    void MainPageT<D, I...>::Connect(int32_t connectionId, IInspectable const& target)
    {
        ...
        case 2:
            {
                ...
                this->contentPanel(targetElement);
            }
            break;
        case 3:
            {
                auto targetElement = target.as<::winrt::Windows::UI::Xaml::Controls::StackPanel>();
                this->inputPanel(targetElement);
            }
            break;
        case 4:
            {
                auto targetElement = target.as<::winrt::Windows::UI::Xaml::Controls::TextBlock>();
                this->greetingOutput(targetElement);
            }
            break;
        case 5:
            {
        ...
        case 6:
            {
                ...
                this->inputButton(targetElement);
                ...
                targetElement.Click([weakThis](::winrt::Windows::Foundation::IInspectable const& p0, ::winrt::Windows::UI::Xaml::RoutedEventArgs const& p1){
                    ...
                    {
                        ::winrt::get_self<D>(t)->inputButton_Click(p0, p1);
                    }
                });
            }
            break;
        case 7:
            {
                auto targetElement = target.as<::winrt::Windows::UI::Xaml::VisualState>();
                this->wideState(targetElement);
            }
            break;
        case 8:
            {
                auto targetElement = target.as<::winrt::Windows::UI::Xaml::VisualState>();
                this->narrowState(targetElement);
            }
            break;
        }
        _contentLoaded = true;
