...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"_02HelloWinRTApp.MainPage"))
    {
        return winrt_make__02HelloWinRTApp_MainPage();
    }

    if (requal(name, L"_02HelloWinRTApp.XamlMetaDataProvider"))
    {
        return winrt_make__02HelloWinRTApp_XamlMetaDataProvider();
    }
