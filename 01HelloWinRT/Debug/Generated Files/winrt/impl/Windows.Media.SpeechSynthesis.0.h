...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::SpeechSynthesis::IInstalledVoicesStatic>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_AllVoices(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DefaultVoice(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::SpeechSynthesis::IInstalledVoicesStatic2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL TrySetDefaultVoiceAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::SpeechSynthesis::ISpeechSynthesizer>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL SynthesizeTextToStreamAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL SynthesizeSsmlToStreamAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_Voice(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Voice(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::SpeechSynthesis::ISpeechSynthesizerOptions>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IncludeWordBoundaryMetadata(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IncludeWordBoundaryMetadata(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_IncludeSentenceBoundaryMetadata(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IncludeSentenceBoundaryMetadata(bool) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::SpeechSynthesis::ISpeechSynthesizerOptions2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_AudioVolume(double*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AudioVolume(double) noexcept = 0;
            virtual int32_t WINRT_CALL get_SpeakingRate(double*) noexcept = 0;
            virtual int32_t WINRT_CALL put_SpeakingRate(double) noexcept = 0;
            virtual int32_t WINRT_CALL get_AudioPitch(double*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AudioPitch(double) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::SpeechSynthesis::ISpeechSynthesizerOptions3>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_AppendedSilence(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AppendedSilence(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_PunctuationSilence(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_PunctuationSilence(int32_t) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::SpeechSynthesis::IVoiceInformation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Gender(int32_t*) noexcept = 0;
        };
    };
    template <typename D>
