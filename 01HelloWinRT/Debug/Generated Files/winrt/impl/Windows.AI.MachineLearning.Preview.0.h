...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::AI::MachineLearning::Preview::IInferencingOptionsPreview>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_PreferredDeviceKind(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_PreferredDeviceKind(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsTracingEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsTracingEnabled(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxBatchSize(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_MaxBatchSize(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_MinimizeMemoryAllocation(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_MinimizeMemoryAllocation(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_ReclaimMemoryAfterEvaluation(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ReclaimMemoryAfterEvaluation(bool) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::AI::MachineLearning::Preview::ILearningModelPreview>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Description(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_InferencingOptions(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_InferencingOptions(void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::AI::MachineLearning::Preview::ILearningModelPreviewStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL LoadModelFromStorageFileAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL LoadModelFromStreamAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::AI::MachineLearning::Preview::ILearningModelVariableDescriptorPreview>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Name(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Description(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ModelFeatureKind(int32_t*) noexcept = 0;
    ...
    template <> struct abi<Windows::AI::MachineLearning::Preview::IMapVariableDescriptorPreview>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_ValidStringKeys(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ValidIntegerKeys(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::AI::MachineLearning::Preview::ISequenceVariableDescriptorPreview>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ElementType(void**) noexcept = 0;
        };
    };
