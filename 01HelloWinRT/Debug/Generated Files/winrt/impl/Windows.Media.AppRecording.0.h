...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::AppRecording::IAppRecordingManager>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL StartRecordingToFileAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RecordTimeSpanToFileAsync(int64_t, int64_t, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportedScreenshotMediaEncodingSubtypes(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SaveScreenshotToFilesAsync(void*, void*, int32_t, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::AppRecording::IAppRecordingResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_IsFileTruncated(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::AppRecording::IAppRecordingSaveScreenshotResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Succeeded(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ExtendedError(winrt::hresult*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SavedScreenshotInfos(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::AppRecording::IAppRecordingSavedScreenshotInfo>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_MediaEncodingSubtype(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::AppRecording::IAppRecordingStatus>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CanRecord(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CanRecordTimeSpan(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_HistoricalBufferDuration(int64_t*) noexcept = 0;
    ...
    template <> struct abi<Windows::Media::AppRecording::IAppRecordingStatusDetails>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsAnyAppBroadcasting(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsCaptureResourceUnavailable(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsGameStreamInProgress(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsTimeSpanRecordingDisabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsGpuConstrained(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsAppInactive(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsBlockedForApp(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsDisabledByUser(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsDisabledBySystem(bool*) noexcept = 0;
        };
    };
    template <typename D>
