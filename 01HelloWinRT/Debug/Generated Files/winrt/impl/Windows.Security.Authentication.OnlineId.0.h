...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Security::Authentication::OnlineId::IOnlineIdAuthenticator>
    {
        ...
        {
            virtual int32_t WINRT_CALL AuthenticateUserAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL AuthenticateUserAsyncAdvanced(void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL SignOutUserAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_ApplicationId(winrt::guid) noexcept = 0;
            virtual int32_t WINRT_CALL get_ApplicationId(winrt::guid*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CanSignOut(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AuthenticatedSafeCustomerId(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Security::Authentication::OnlineId::IOnlineIdServiceTicketRequestFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateOnlineIdServiceTicketRequest(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateOnlineIdServiceTicketRequestAdvanced(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Authentication::OnlineId::IOnlineIdSystemAuthenticatorForUser>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetTicketAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_ApplicationId(winrt::guid) noexcept = 0;
            virtual int32_t WINRT_CALL get_ApplicationId(winrt::guid*) noexcept = 0;
    ...
    template <> struct abi<Windows::Security::Authentication::OnlineId::IOnlineIdSystemAuthenticatorStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Default(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Security::Authentication::OnlineId::IOnlineIdSystemIdentity>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Ticket(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Security::Authentication::OnlineId::IUserIdentity>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Tickets(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Id(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SafeCustomerId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SignInName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_FirstName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_LastName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsBetaAccount(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsConfirmedPC(bool*) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_Security_Authentication_OnlineId_IOnlineIdAuthenticator
    {
        ...
        Windows::Security::Authentication::OnlineId::UserAuthenticationOperation AuthenticateUserAsync(param::iterable<Windows::Security::Authentication::OnlineId::OnlineIdServiceTicketRequest> const& requests, Windows::Security::Authentication::OnlineId::CredentialPromptType const& credentialPromptType) const;
