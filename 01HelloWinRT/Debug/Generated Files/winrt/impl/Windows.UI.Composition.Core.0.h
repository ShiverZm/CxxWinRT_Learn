...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Composition::Core::ICompositorController>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL EnsurePreviousCommitCompletedAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_CommitNeeded(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_CommitNeeded(winrt::event_token) noexcept = 0;
        };
    };
    template <typename D>
