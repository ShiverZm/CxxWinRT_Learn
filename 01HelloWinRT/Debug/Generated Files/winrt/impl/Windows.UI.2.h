...
namespace winrt::Windows::UI
{
    ...
    struct WINRT_EBO ColorHelper : Windows::UI::IColorHelper
    {
    ...
    struct WINRT_EBO Colors : Windows::UI::IColors
    {
    ...
    struct WINRT_EBO UIContentRoot : Windows::UI::IUIContentRoot
    {
    ...
    struct WINRT_EBO UIContext : Windows::UI::IUIContext
    {
