...
namespace winrt::Windows::Web::Syndication
{
    ...
    struct WINRT_EBO SyndicationAttribute : Windows::Web::Syndication::ISyndicationAttribute
    {
    ...
    struct WINRT_EBO SyndicationCategory : Windows::Web::Syndication::ISyndicationCategory
    {
    ...
    struct WINRT_EBO SyndicationClient : Windows::Web::Syndication::ISyndicationClient
    {
    ...
    struct WINRT_EBO SyndicationContent : Windows::Web::Syndication::ISyndicationContent
    {
    ...
    struct WINRT_EBO SyndicationFeed : Windows::Web::Syndication::ISyndicationFeed
    {
    ...
    struct WINRT_EBO SyndicationGenerator : Windows::Web::Syndication::ISyndicationGenerator,
    ...
    struct WINRT_EBO SyndicationItem : Windows::Web::Syndication::ISyndicationItem
    {
    ...
    struct WINRT_EBO SyndicationLink : Windows::Web::Syndication::ISyndicationLink
    {
    ...
    struct WINRT_EBO SyndicationNode : Windows::Web::Syndication::ISyndicationNode
    {
    ...
    struct WINRT_EBO SyndicationPerson : Windows::Web::Syndication::ISyndicationPerson
    {
    ...
    struct WINRT_EBO SyndicationText : Windows::Web::Syndication::ISyndicationText
    {
