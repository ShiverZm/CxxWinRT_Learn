...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::UserDataTasks::DataProvider::IUserDataTaskDataProviderConnection>
    {
        ...
        {
            virtual int32_t WINRT_CALL add_CreateOrUpdateTaskRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_CreateOrUpdateTaskRequested(winrt::event_token) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL add_SkipOccurrenceRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_SkipOccurrenceRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_CompleteTaskRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_CompleteTaskRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_DeleteTaskRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_DeleteTaskRequested(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::UserDataTasks::DataProvider::IUserDataTaskListCompleteTaskRequest>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_TaskListId(void**) noexcept = 0;
