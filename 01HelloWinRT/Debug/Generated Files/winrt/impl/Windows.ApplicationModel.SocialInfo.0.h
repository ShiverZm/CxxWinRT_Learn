...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::SocialInfo::ISocialFeedChildItem>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_PrimaryContent(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SecondaryContent(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Timestamp(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Timestamp(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_TargetUri(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_TargetUri(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Thumbnails(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SharedItem(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_SharedItem(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::SocialInfo::ISocialFeedItem>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_SharedItem(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_SharedItem(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_BadgeStyle(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_BadgeStyle(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_BadgeCountValue(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_BadgeCountValue(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_RemoteId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_RemoteId(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ChildItem(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_ChildItem(void*) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::SocialInfo::ISocialFeedSharedItem>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_OriginalSource(void*) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::SocialInfo::ISocialItemThumbnail>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_BitmapSize(struct struct_Windows_Graphics_Imaging_BitmapSize*) noexcept = 0;
            virtual int32_t WINRT_CALL put_BitmapSize(struct struct_Windows_Graphics_Imaging_BitmapSize) noexcept = 0;
            virtual int32_t WINRT_CALL SetImageAsync(void*, void**) noexcept = 0;
        };
    };
