...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::Casting::ICastingConnection>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL RequestStartCastingAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DisconnectAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::Casting::ICastingDevice>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetSupportedCastingPlaybackTypesAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateCastingConnection(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Casting::ICastingDevicePicker>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL add_CastingDeviceSelected(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_CastingDeviceSelected(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_CastingDevicePickerDismissed(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_CastingDevicePickerDismissed(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<Windows::Media::Casting::ICastingDevicePickerFilter>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_SupportsPictures(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_SupportsPictures(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportedCastingSources(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Casting::ICastingDeviceSelectedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SelectedCastingDevice(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Casting::ICastingDeviceStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetDeviceSelector(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetDeviceSelectorFromCastingSourceAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FromIdAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DeviceInfoSupportsCastingAsync(void*, void**) noexcept = 0;
        };
    };
