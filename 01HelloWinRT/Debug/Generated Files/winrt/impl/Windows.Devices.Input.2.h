...
namespace winrt::Windows::Devices::Input
{
    ...
    struct WINRT_EBO KeyboardCapabilities : Windows::Devices::Input::IKeyboardCapabilities
    {
    ...
    struct WINRT_EBO MouseCapabilities : Windows::Devices::Input::IMouseCapabilities
    {
    ...
    struct WINRT_EBO MouseDevice : Windows::Devices::Input::IMouseDevice
    {
    ...
    struct WINRT_EBO MouseEventArgs : Windows::Devices::Input::IMouseEventArgs
    {
    ...
    struct WINRT_EBO PenDevice : Windows::Devices::Input::IPenDevice
    {
    ...
    struct WINRT_EBO PointerDevice : Windows::Devices::Input::IPointerDevice,
    ...
    struct WINRT_EBO TouchCapabilities : Windows::Devices::Input::ITouchCapabilities
    {
