...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::LockScreen::ILockApplicationHost>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL add_Unlocking(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_Unlocking(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::LockScreen::ILockScreenBadge>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Glyph(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Number(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_AutomationName(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::LockScreen::ILockScreenInfo>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL add_LockScreenImageChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_LockScreenImageChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_LockScreenImage(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_BadgesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_BadgesChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_Badges(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_DetailTextChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_DetailTextChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_DetailText(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_AlarmIconChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_AlarmIconChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_AlarmIcon(void**) noexcept = 0;
        };
    };
