...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Networking::XboxLive::IXboxLiveDeviceAddress>
    {
        ...
        {
            virtual int32_t WINRT_CALL add_SnapshotChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_SnapshotChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL GetSnapshotAsBase64(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSnapshotAsBuffer(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSnapshotAsBytes(uint32_t, uint8_t*, uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL Compare(void*, int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsValid(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsLocal(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_NetworkAccessKind(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::XboxLive::IXboxLiveDeviceAddressStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateFromSnapshotBase64(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFromSnapshotBuffer(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFromSnapshotBytes(uint32_t, uint8_t*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetLocal(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxSnapshotBytesSize(uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::XboxLive::IXboxLiveEndpointPair>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetRemoteSocketAddressBytes(uint32_t, uint8_t*) noexcept = 0;
            virtual int32_t WINRT_CALL GetLocalSocketAddressBytes(uint32_t, uint8_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_State(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Template(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RemoteDeviceAddress(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RemoteHostName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RemotePort(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_LocalHostName(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Networking::XboxLive::IXboxLiveEndpointPairCreationResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_DeviceAddress(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Status(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsExistingPathEvaluation(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_EndpointPair(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Networking::XboxLive::IXboxLiveEndpointPairStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL FindEndpointPairBySocketAddressBytes(uint32_t, uint8_t*, uint32_t, uint8_t*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FindEndpointPairByHostNamesAndPorts(void*, void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::XboxLive::IXboxLiveEndpointPairTemplate>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL add_InboundEndpointPairCreated(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_InboundEndpointPairCreated(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL CreateEndpointPairDefaultAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateEndpointPairWithBehaviorsAsync(void*, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateEndpointPairForPortsDefaultAsync(void*, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateEndpointPairForPortsWithBehaviorsAsync(void*, void*, void*, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Name(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SocketKind(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_InitiatorBoundPortRangeLower(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_InitiatorBoundPortRangeUpper(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AcceptorBoundPortRangeLower(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AcceptorBoundPortRangeUpper(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_EndpointPairs(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::XboxLive::IXboxLiveEndpointPairTemplateStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetTemplateByName(void*, void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Networking::XboxLive::IXboxLiveQualityOfServiceMeasurement>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL MeasureAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetMetricResultsForDevice(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetMetricResultsForMetric(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetMetricResult(void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetPrivatePayloadResult(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Metrics(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DeviceAddresses(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ShouldRequestPrivatePayloads(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ShouldRequestPrivatePayloads(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_TimeoutInMilliseconds(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_TimeoutInMilliseconds(uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_NumberOfProbesToAttempt(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_NumberOfProbesToAttempt(uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_NumberOfResultsPending(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MetricResults(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PrivatePayloadResults(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::XboxLive::IXboxLiveQualityOfServiceMeasurementStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL PublishPrivatePayloadBytes(uint32_t, uint8_t*) noexcept = 0;
            virtual int32_t WINRT_CALL ClearPrivatePayload() noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxSimultaneousProbeConnections(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_MaxSimultaneousProbeConnections(uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsSystemOutboundBandwidthConstrained(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsSystemOutboundBandwidthConstrained(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsSystemInboundBandwidthConstrained(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsSystemInboundBandwidthConstrained(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_PublishedPrivatePayload(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_PublishedPrivatePayload(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxPrivatePayloadSize(uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::XboxLive::IXboxLiveQualityOfServiceMetricResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Status(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DeviceAddress(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Metric(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Value(uint64_t*) noexcept = 0;
        };
    };
