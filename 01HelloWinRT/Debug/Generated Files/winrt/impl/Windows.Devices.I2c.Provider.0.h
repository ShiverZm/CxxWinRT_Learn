...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::I2c::Provider::II2cControllerProvider>
    {
        ...
        {
            virtual int32_t WINRT_CALL GetDeviceProvider(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::I2c::Provider::II2cDeviceProvider>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL WritePartial(uint32_t, uint8_t*, struct struct_Windows_Devices_I2c_Provider_ProviderI2cTransferResult*) noexcept = 0;
            virtual int32_t WINRT_CALL Read(uint32_t, uint8_t*) noexcept = 0;
            virtual int32_t WINRT_CALL ReadPartial(uint32_t, uint8_t*, struct struct_Windows_Devices_I2c_Provider_ProviderI2cTransferResult*) noexcept = 0;
            virtual int32_t WINRT_CALL WriteRead(uint32_t, uint8_t*, uint32_t, uint8_t*) noexcept = 0;
            virtual int32_t WINRT_CALL WriteReadPartial(uint32_t, uint8_t*, uint32_t, uint8_t*, struct struct_Windows_Devices_I2c_Provider_ProviderI2cTransferResult*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::I2c::Provider::II2cProvider>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetControllersAsync(void**) noexcept = 0;
        };
    };
