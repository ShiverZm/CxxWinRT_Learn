...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Security::Credentials::UI::ICredentialPickerOptions>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_ErrorCode(uint32_t) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL put_AuthenticationProtocol(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_AuthenticationProtocol(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_CustomAuthenticationProtocol(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CustomAuthenticationProtocol(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_PreviousCredential(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PreviousCredential(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_AlwaysDisplayDialog(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_AlwaysDisplayDialog(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_CallerSavesCredential(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_CallerSavesCredential(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_CredentialSaveOption(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_CredentialSaveOption(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Credentials::UI::ICredentialPickerResults>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ErrorCode(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CredentialSaveOption(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CredentialSaved(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Credential(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_CredentialDomainName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_CredentialUserName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_CredentialPassword(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Credentials::UI::ICredentialPickerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL PickWithOptionsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL PickWithMessageAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL PickWithCaptionAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Credentials::UI::IUserConsentVerifierStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CheckAvailabilityAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestVerificationAsync(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
