...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_Category(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CategoryDescription(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_CategoryDescription(void*) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::Calls::Provider::IPhoneCallOrigin3>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_DisplayPicture(void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Calls::Provider::IPhoneCallOriginManagerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsCurrentAppActiveCallOriginApp(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL ShowPhoneCallOriginSettingsUI() noexcept = 0;
            virtual int32_t WINRT_CALL SetCallOrigin(winrt::guid, void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Calls::Provider::IPhoneCallOriginManagerStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL RequestSetAsActiveCallOriginAppAsync(void**) noexcept = 0;
        };
    };
