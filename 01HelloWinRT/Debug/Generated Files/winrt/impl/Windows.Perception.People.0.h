...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Perception::People::IEyesPose>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_IsCalibrationValid(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Gaze(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_UpdateTimestamp(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Perception::People::IHandMeshObserver>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_TriangleIndexCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_VertexCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL GetTriangleIndices(uint32_t, uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL GetVertexStateForPose(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_NeutralPose(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_NeutralPoseVersion(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ModelId(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Perception::People::IHandMeshVertexState>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetVertices(uint32_t, struct struct_Windows_Perception_People_HandMeshVertex*) noexcept = 0;
            virtual int32_t WINRT_CALL get_UpdateTimestamp(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Perception::People::IHandPose>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL TryGetJoint(void*, int32_t, struct struct_Windows_Perception_People_JointPose*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL TryGetJoints(void*, uint32_t, int32_t*, uint32_t, struct struct_Windows_Perception_People_JointPose*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL GetRelativeJoint(int32_t, int32_t, struct struct_Windows_Perception_People_JointPose*) noexcept = 0;
            virtual int32_t WINRT_CALL GetRelativeJoints(uint32_t, int32_t*, uint32_t, int32_t*, uint32_t, struct struct_Windows_Perception_People_JointPose*) noexcept = 0;
        };
    };
