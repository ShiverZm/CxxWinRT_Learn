...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragDropManager>
    {
        ...
        {
            virtual int32_t WINRT_CALL add_TargetRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_TargetRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_AreConcurrentOperationsEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AreConcurrentOperationsEnabled(bool) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragOperation>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_Data(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetPointerId(uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL SetDragUIContentFromSoftwareBitmap(void*) noexcept = 0;
            virtual int32_t WINRT_CALL SetDragUIContentFromSoftwareBitmapWithAnchorPoint(void*, Windows::Foundation::Point) noexcept = 0;
            virtual int32_t WINRT_CALL get_DragUIContentMode(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_DragUIContentMode(uint32_t) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDropOperationTarget>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL EnterAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL OverAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL LeaveAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DropAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDropOperationTargetRequestedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL SetTarget(void*) noexcept = 0;
        };
    };
    template <typename D>
