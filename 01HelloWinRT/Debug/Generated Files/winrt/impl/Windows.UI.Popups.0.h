...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Popups::IMessageDialogFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL CreateWithTitle(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Popups::IPopupMenu>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_Commands(void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowAsync(Windows::Foundation::Point, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowAsyncWithRect(Windows::Foundation::Rect, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowAsyncWithRectAndPlacement(Windows::Foundation::Rect, int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Popups::IUICommand>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_Invoked(void*) noexcept = 0;
    ...
    template <> struct abi<Windows::UI::Popups::IUICommandFactory>
    {
        ...
        {
            virtual int32_t WINRT_CALL Create(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateWithHandler(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateWithHandlerAndId(void*, void*, void*, void**) noexcept = 0;
        };
    };
