...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Web::UI::Interop::IWebViewControlAcceleratorKeyPressedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_RoutingStage(int32_t*) noexcept = 0;
    ...
    template <> struct abi<Windows::Web::UI::Interop::IWebViewControlProcess>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_IsPrivateNetworkClientServerCapabilityEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL CreateWebViewControlAsync(int64_t, Windows::Foundation::Rect, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetWebViewControls(void**) noexcept = 0;
            virtual int32_t WINRT_CALL Terminate() noexcept = 0;
            virtual int32_t WINRT_CALL add_ProcessExited(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ProcessExited(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Web::UI::Interop::IWebViewControlProcessFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateWithOptions(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Web::UI::Interop::IWebViewControlProcessOptions>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_EnterpriseId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_PrivateNetworkClientServerCapability(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_PrivateNetworkClientServerCapability(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Web::UI::Interop::IWebViewControlSite>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Process(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_Scale(double) noexcept = 0;
            virtual int32_t WINRT_CALL get_Scale(double*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL MoveFocus(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL add_MoveFocusRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_MoveFocusRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_AcceleratorKeyPressed(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_AcceleratorKeyPressed(winrt::event_token) noexcept = 0;
        };
    };
