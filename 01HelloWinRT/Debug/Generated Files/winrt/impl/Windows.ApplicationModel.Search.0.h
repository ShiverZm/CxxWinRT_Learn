...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Search::ILocalContentSuggestionSettings>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_AqsFilter(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AqsFilter(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PropertiesToMatch(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Search::ISearchPane>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL put_SearchHistoryEnabled(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_SearchHistoryEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_SearchHistoryContext(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SearchHistoryContext(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_QueryText(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL add_QueryChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_QueryChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_SuggestionsRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_SuggestionsRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_QuerySubmitted(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_QuerySubmitted(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_ResultSuggestionChosen(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ResultSuggestionChosen(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL SetLocalContentSuggestionSettings(void*) noexcept = 0;
            virtual int32_t WINRT_CALL ShowOverloadDefault() noexcept = 0;
            virtual int32_t WINRT_CALL ShowOverloadWithQuery(void*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ShowOnKeyboardInput(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_ShowOnKeyboardInput(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL TrySetQueryText(void*, bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Search::ISearchPaneQueryChangedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_QueryText(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Language(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_LinguisticDetails(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Search::ISearchPaneQueryLinguisticDetails>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_QueryTextAlternatives(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_QueryTextCompositionStart(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_QueryTextCompositionLength(uint32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::Search::ISearchPaneStaticsWithHideThisApplication>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL HideThisApplication() noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Search::ISearchPaneSuggestionsRequest>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_SearchSuggestionCollection(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::Search::ISearchQueryLinguisticDetailsFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateInstance(void*, uint32_t, uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Search::ISearchSuggestionCollection>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL AppendQuerySuggestion(void*) noexcept = 0;
            virtual int32_t WINRT_CALL AppendQuerySuggestions(void*) noexcept = 0;
            virtual int32_t WINRT_CALL AppendResultSuggestion(void*, void*, void*, void*, void*) noexcept = 0;
            virtual int32_t WINRT_CALL AppendSearchSeparator(void*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_ApplicationModel_Search_ISearchPane
    {
        ...
        bool Visible() const;
        winrt::event_token VisibilityChanged(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::Search::SearchPane, Windows::ApplicationModel::Search::SearchPaneVisibilityChangedEventArgs> const& handler) const;
        ...
        winrt::event_token QueryChanged(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::Search::SearchPane, Windows::ApplicationModel::Search::SearchPaneQueryChangedEventArgs> const& handler) const;
        ...
        void QueryChanged(winrt::event_token const& token) const noexcept;
        winrt::event_token SuggestionsRequested(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::Search::SearchPane, Windows::ApplicationModel::Search::SearchPaneSuggestionsRequestedEventArgs> const& handler) const;
        ...
        winrt::event_token QuerySubmitted(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::Search::SearchPane, Windows::ApplicationModel::Search::SearchPaneQuerySubmittedEventArgs> const& handler) const;
        ...
        void QuerySubmitted(winrt::event_token const& token) const noexcept;
        winrt::event_token ResultSuggestionChosen(Windows::Foundation::TypedEventHandler<Windows::ApplicationModel::Search::SearchPane, Windows::ApplicationModel::Search::SearchPaneResultSuggestionChosenEventArgs> const& handler) const;
        ...
        void ResultSuggestionChosen(winrt::event_token const& token) const noexcept;
        ...
        void Show() const;
        void Show(param::hstring const& query) const;
        void ShowOnKeyboardInput(bool value) const;
        bool ShowOnKeyboardInput() const;
        bool TrySetQueryText(param::hstring const& query) const;
    };
