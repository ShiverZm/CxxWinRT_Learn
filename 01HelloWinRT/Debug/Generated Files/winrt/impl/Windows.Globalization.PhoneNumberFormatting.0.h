...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Globalization::PhoneNumberFormatting::IPhoneNumberFormatter>
    {
        ...
        {
            virtual int32_t WINRT_CALL Format(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FormatWithOutputFormat(void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FormatPartialString(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FormatString(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FormatStringWithLeftToRightMarkers(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Globalization::PhoneNumberFormatting::IPhoneNumberFormatterStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL TryCreate(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetCountryCodeForRegion(void*, int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL GetNationalDirectDialingPrefixForRegion(void*, bool, void**) noexcept = 0;
            virtual int32_t WINRT_CALL WrapWithLeftToRightMarkers(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Globalization::PhoneNumberFormatting::IPhoneNumberInfo>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CountryCode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PhoneNumber(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetLengthOfGeographicalAreaCode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL GetNationalSignificantNumber(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetLengthOfNationalDestinationCode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL PredictNumberKind(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL GetGeographicRegionCode(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CheckNumberMatch(void*, int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Globalization::PhoneNumberFormatting::IPhoneNumberInfoStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL TryParse(void*, void**, int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL TryParseWithRegion(void*, void*, void**, int32_t*) noexcept = 0;
        };
    };
    template <typename D>
