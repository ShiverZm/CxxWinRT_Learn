...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Management::Workplace::IMdmAllowPolicyStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL IsBrowserAllowed(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL IsCameraAllowed(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL IsMicrosoftAccountAllowed(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL IsStoreAllowed(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Management::Workplace::IMdmPolicyStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetMessagingSyncPolicy(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Management::Workplace::IWorkplaceSettingsStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsMicrosoftAccountOptional(bool*) noexcept = 0;
        };
    };
    template <typename D>
