...
namespace winrt::Windows::Globalization
{
    struct ApplicationLanguages
    {
        ...
        static Windows::Foundation::Collections::IVectorView<hstring> GetLanguagesForUser(Windows::System::User const& user);
    };
    struct WINRT_EBO Calendar : Windows::Globalization::ICalendar,
    ...
    struct WINRT_EBO CurrencyAmount : Windows::Globalization::ICurrencyAmount
    {
    ...
    struct WINRT_EBO GeographicRegion : Windows::Globalization::IGeographicRegion
    {
    ...
    struct WINRT_EBO JapanesePhoneme : Windows::Globalization::IJapanesePhoneme
    {
    ...
    struct WINRT_EBO Language : Windows::Globalization::ILanguage,
        impl::require<Language, Windows::Globalization::ILanguage2, Windows::Globalization::ILanguageExtensionSubtags>
    {
