...
namespace winrt::Windows::ApplicationModel::Payments
{
    ...
    struct WINRT_EBO PaymentAddress : Windows::ApplicationModel::Payments::IPaymentAddress
    {
    ...
    struct WINRT_EBO PaymentCanMakePaymentResult : Windows::ApplicationModel::Payments::IPaymentCanMakePaymentResult
    {
    ...
    struct WINRT_EBO PaymentCurrencyAmount : Windows::ApplicationModel::Payments::IPaymentCurrencyAmount
    {
    ...
    struct WINRT_EBO PaymentDetails : Windows::ApplicationModel::Payments::IPaymentDetails
    {
    ...
    struct WINRT_EBO PaymentDetailsModifier : Windows::ApplicationModel::Payments::IPaymentDetailsModifier
    {
    ...
    struct WINRT_EBO PaymentItem : Windows::ApplicationModel::Payments::IPaymentItem
    {
    ...
    struct WINRT_EBO PaymentMediator : Windows::ApplicationModel::Payments::IPaymentMediator,
    ...
    struct WINRT_EBO PaymentMerchantInfo : Windows::ApplicationModel::Payments::IPaymentMerchantInfo
    {
    ...
    struct WINRT_EBO PaymentMethodData : Windows::ApplicationModel::Payments::IPaymentMethodData
    {
    ...
    struct WINRT_EBO PaymentOptions : Windows::ApplicationModel::Payments::IPaymentOptions
    {
    ...
    struct WINRT_EBO PaymentRequest : Windows::ApplicationModel::Payments::IPaymentRequest,
    ...
    struct WINRT_EBO PaymentRequestChangedArgs : Windows::ApplicationModel::Payments::IPaymentRequestChangedArgs
    {
    ...
    struct WINRT_EBO PaymentRequestChangedResult : Windows::ApplicationModel::Payments::IPaymentRequestChangedResult
    {
    ...
    struct WINRT_EBO PaymentRequestSubmitResult : Windows::ApplicationModel::Payments::IPaymentRequestSubmitResult
    {
    ...
    struct WINRT_EBO PaymentResponse : Windows::ApplicationModel::Payments::IPaymentResponse
    {
    ...
    struct WINRT_EBO PaymentShippingOption : Windows::ApplicationModel::Payments::IPaymentShippingOption
    {
    ...
    struct WINRT_EBO PaymentToken : Windows::ApplicationModel::Payments::IPaymentToken
    {
