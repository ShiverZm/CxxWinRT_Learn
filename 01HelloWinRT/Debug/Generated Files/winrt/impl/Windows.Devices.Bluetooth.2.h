...
{
    struct WINRT_EBO BluetoothAdapter : Windows::Devices::Bluetooth::IBluetoothAdapter,
    ...
    struct WINRT_EBO BluetoothClassOfDevice : Windows::Devices::Bluetooth::IBluetoothClassOfDevice
    {
    ...
    struct WINRT_EBO BluetoothDevice : Windows::Devices::Bluetooth::IBluetoothDevice,
    ...
    struct WINRT_EBO BluetoothDeviceId : Windows::Devices::Bluetooth::IBluetoothDeviceId
    {
    ...
    struct WINRT_EBO BluetoothLEAppearance : Windows::Devices::Bluetooth::IBluetoothLEAppearance
    {
    ...
    struct WINRT_EBO BluetoothLEDevice : Windows::Devices::Bluetooth::IBluetoothLEDevice,
    ...
    struct WINRT_EBO BluetoothSignalStrengthFilter : Windows::Devices::Bluetooth::IBluetoothSignalStrengthFilter
    {
