...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Security::DataProtection::IUserDataBufferUnprotectResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_UnprotectedBuffer(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::DataProtection::IUserDataProtectionManager>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL ProtectStorageItemAsync(void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetStorageItemProtectionInfoAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ProtectBufferAsync(void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL UnprotectBufferAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL IsContinuedDataAvailabilityExpected(int32_t, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL add_DataAvailabilityStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_DataAvailabilityStateChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::DataProtection::IUserDataProtectionManagerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL TryGetDefault(void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryGetForUser(void*, void**) noexcept = 0;
        };
    };
