...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Graphics::Printing::PrintTicket::IPrintTicketCapabilities>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_XmlNamespace(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_XmlNode(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DocumentBindingFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DocumentCollateFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DocumentDuplexFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DocumentHolePunchFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DocumentInputBinFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DocumentNUpFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DocumentStapleFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_JobPasscodeFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PageBorderlessFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PageMediaSizeFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PageMediaTypeFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PageOrientationFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PageOutputColorFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PageOutputQualityFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PageResolutionFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetFeature(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetParameterDefinition(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Printing::PrintTicket::IPrintTicketFeature>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetOption(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Options(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSelectedOption(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetSelectedOption(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectionType(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Printing::PrintTicket::IPrintTicketOption>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_XmlNode(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DisplayName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetPropertyNode(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetScoredPropertyNode(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetPropertyValue(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetScoredPropertyValue(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Printing::PrintTicket::IPrintTicketParameterDefinition>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_XmlNamespace(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_XmlNode(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DataType(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_UnitType(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RangeMin(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_RangeMax(int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Graphics::Printing::PrintTicket::IPrintTicketValue>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetValueAsInteger(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL GetValueAsString(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicket>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_XmlNamespace(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_XmlNode(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetCapabilities(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DocumentBindingFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DocumentCollateFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DocumentDuplexFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DocumentHolePunchFeature(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_PageResolutionFeature(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetFeature(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL NotifyXmlChangedAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL ValidateAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetParameterInitializer(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetParameterInitializerAsInteger(void*, void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetParameterInitializerAsString(void*, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL MergeAndValidateTicket(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Printing::PrintTicket::IWorkflowPrintTicketValidationResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Validated(bool*) noexcept = 0;
