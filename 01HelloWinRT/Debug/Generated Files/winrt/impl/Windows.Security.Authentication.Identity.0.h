...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Security::Authentication::Identity::IEnterpriseKeyCredentialRegistrationInfo>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_TenantId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_TenantName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Subject(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_KeyId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_KeyName(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Authentication::Identity::IEnterpriseKeyCredentialRegistrationManager>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetRegistrationsAsync(void**) noexcept = 0;
        };
    };
