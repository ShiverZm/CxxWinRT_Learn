...
namespace winrt::Windows::UI::Xaml::Markup
{
    ...
    struct WINRT_EBO MarkupExtension : Windows::UI::Xaml::Markup::IMarkupExtension,
    ...
    struct WINRT_EBO XamlBinaryWriter : Windows::UI::Xaml::Markup::IXamlBinaryWriter
    {
    ...
    struct WINRT_EBO XamlBindingHelper : Windows::UI::Xaml::Markup::IXamlBindingHelper
    {
    ...
    struct WINRT_EBO XamlMarkupHelper : Windows::UI::Xaml::Markup::IXamlMarkupHelper
    {
    ...
    struct WINRT_EBO XamlReader : Windows::UI::Xaml::Markup::IXamlReader
    {
