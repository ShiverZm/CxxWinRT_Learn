...
namespace winrt::Windows::Management::Deployment
{
    ...
    struct WINRT_EBO DeploymentResult : Windows::Management::Deployment::IDeploymentResult,
    ...
    struct WINRT_EBO PackageManager : Windows::Management::Deployment::IPackageManager,
    ...
    struct WINRT_EBO PackageManagerDebugSettings : Windows::Management::Deployment::IPackageManagerDebugSettings
    {
    ...
    struct WINRT_EBO PackageUserInformation : Windows::Management::Deployment::IPackageUserInformation
    {
    ...
    struct WINRT_EBO PackageVolume : Windows::Management::Deployment::IPackageVolume,
