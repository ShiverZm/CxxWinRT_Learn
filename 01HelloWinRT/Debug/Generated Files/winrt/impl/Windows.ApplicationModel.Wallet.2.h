...
{
    struct WINRT_EBO WalletBarcode : Windows::ApplicationModel::Wallet::IWalletBarcode
    {
    ...
    struct WINRT_EBO WalletItem : Windows::ApplicationModel::Wallet::IWalletItem
    {
    ...
    struct WINRT_EBO WalletItemCustomProperty : Windows::ApplicationModel::Wallet::IWalletItemCustomProperty
    {
    ...
    struct WINRT_EBO WalletItemStore : Windows::ApplicationModel::Wallet::IWalletItemStore
    {
    ...
    struct WINRT_EBO WalletRelevantLocation : Windows::ApplicationModel::Wallet::IWalletRelevantLocation
    {
    ...
    struct WINRT_EBO WalletTransaction : Windows::ApplicationModel::Wallet::IWalletTransaction
    {
    ...
    struct WINRT_EBO WalletVerb : Windows::ApplicationModel::Wallet::IWalletVerb
    {
