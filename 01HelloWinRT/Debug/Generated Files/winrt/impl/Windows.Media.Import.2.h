...
namespace winrt::Windows::Media::Import
{
    ...
    struct WINRT_EBO PhotoImportDeleteImportedItemsFromSourceResult : Windows::Media::Import::IPhotoImportDeleteImportedItemsFromSourceResult
    {
    ...
    struct WINRT_EBO PhotoImportFindItemsResult : Windows::Media::Import::IPhotoImportFindItemsResult,
    ...
    struct WINRT_EBO PhotoImportImportItemsResult : Windows::Media::Import::IPhotoImportImportItemsResult
    {
    ...
    struct WINRT_EBO PhotoImportItem : Windows::Media::Import::IPhotoImportItem,
    ...
    struct WINRT_EBO PhotoImportItemImportedEventArgs : Windows::Media::Import::IPhotoImportItemImportedEventArgs
    {
    ...
    struct WINRT_EBO PhotoImportOperation : Windows::Media::Import::IPhotoImportOperation
    {
    ...
    struct WINRT_EBO PhotoImportSelectionChangedEventArgs : Windows::Media::Import::IPhotoImportSelectionChangedEventArgs
    {
    ...
    struct WINRT_EBO PhotoImportSession : Windows::Media::Import::IPhotoImportSession,
    ...
    struct WINRT_EBO PhotoImportSidecar : Windows::Media::Import::IPhotoImportSidecar
    {
    ...
    struct WINRT_EBO PhotoImportSource : Windows::Media::Import::IPhotoImportSource
    {
    ...
    struct WINRT_EBO PhotoImportStorageMedium : Windows::Media::Import::IPhotoImportStorageMedium
    {
    ...
    struct WINRT_EBO PhotoImportVideoSegment : Windows::Media::Import::IPhotoImportVideoSegment
    {
