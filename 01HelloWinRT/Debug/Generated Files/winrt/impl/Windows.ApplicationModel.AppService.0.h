...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::AppService::IAppServiceCatalogStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL FindAppServiceProvidersAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::AppService::IAppServiceConnection>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_AppServiceName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_AppServiceName(void*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL add_RequestReceived(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_RequestReceived(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_ServiceClosed(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ServiceClosed(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::AppService::IAppServiceConnection2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL OpenRemoteAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_User(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_User(void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::AppService::IAppServiceConnectionStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL SendStatelessMessageAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::AppService::IAppServiceTriggerDetails>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_AppServiceConnection(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::AppService::IAppServiceTriggerDetails2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsRemoteSystemConnection(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::AppService::IAppServiceTriggerDetails3>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CheckCallerForCapabilityAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::AppService::IAppServiceTriggerDetails4>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CallerRemoteConnectionToken(void**) noexcept = 0;
        };
    };
