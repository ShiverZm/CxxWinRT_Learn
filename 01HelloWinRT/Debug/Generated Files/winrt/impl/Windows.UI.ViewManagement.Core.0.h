...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::ViewManagement::Core::ICoreInputView>
    {
        ...
        {
            virtual int32_t WINRT_CALL add_OcclusionsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_OcclusionsChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL GetCoreInputViewOcclusions(void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryShowPrimaryView(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL TryHidePrimaryView(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::ViewManagement::Core::ICoreInputView2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL add_XYFocusTransferringFromPrimaryView(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_XYFocusTransferringFromPrimaryView(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_XYFocusTransferredToPrimaryView(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_XYFocusTransferredToPrimaryView(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL TryTransferXYFocusToPrimaryView(Windows::Foundation::Rect, int32_t, bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::ViewManagement::Core::ICoreInputView3>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL TryShowWithKind(int32_t, bool*) noexcept = 0;
    ...
    template <> struct abi<Windows::UI::ViewManagement::Core::ICoreInputViewOcclusion>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_OcclusionKind(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::ViewManagement::Core::ICoreInputViewOcclusionsChangedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Occlusions(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::UI::ViewManagement::Core::ICoreInputViewTransferringXYFocusEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Origin(Windows::Foundation::Rect*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Direction(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_TransferHandled(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_TransferHandled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_KeepPrimaryViewVisible(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_KeepPrimaryViewVisible(bool*) noexcept = 0;
        };
    };
    template <typename D>
