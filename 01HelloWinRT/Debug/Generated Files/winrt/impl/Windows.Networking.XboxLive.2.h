...
{
    struct WINRT_EBO XboxLiveDeviceAddress : Windows::Networking::XboxLive::IXboxLiveDeviceAddress
    {
    ...
    struct WINRT_EBO XboxLiveEndpointPair : Windows::Networking::XboxLive::IXboxLiveEndpointPair
    {
    ...
    struct WINRT_EBO XboxLiveEndpointPairCreationResult : Windows::Networking::XboxLive::IXboxLiveEndpointPairCreationResult
    {
    ...
    struct WINRT_EBO XboxLiveEndpointPairStateChangedEventArgs : Windows::Networking::XboxLive::IXboxLiveEndpointPairStateChangedEventArgs
    {
    ...
    struct WINRT_EBO XboxLiveEndpointPairTemplate : Windows::Networking::XboxLive::IXboxLiveEndpointPairTemplate
    {
    ...
    struct WINRT_EBO XboxLiveInboundEndpointPairCreatedEventArgs : Windows::Networking::XboxLive::IXboxLiveInboundEndpointPairCreatedEventArgs
    {
    ...
    struct WINRT_EBO XboxLiveQualityOfServiceMeasurement : Windows::Networking::XboxLive::IXboxLiveQualityOfServiceMeasurement
    {
    ...
    struct WINRT_EBO XboxLiveQualityOfServiceMetricResult : Windows::Networking::XboxLive::IXboxLiveQualityOfServiceMetricResult
    {
    ...
    struct WINRT_EBO XboxLiveQualityOfServicePrivatePayloadResult : Windows::Networking::XboxLive::IXboxLiveQualityOfServicePrivatePayloadResult
    {
