...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Services::Maps::OfflineMaps::IOfflineMapPackage>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_EnclosingRegionName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_EstimatedSizeInBytes(uint64_t*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL RequestStartDownloadAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Services::Maps::OfflineMaps::IOfflineMapPackageQueryResult>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_Status(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Packages(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Services::Maps::OfflineMaps::IOfflineMapPackageStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL FindPackagesAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FindPackagesInBoundingBoxAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FindPackagesInGeocircleAsync(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
