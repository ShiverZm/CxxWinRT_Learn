...
{
    struct WINRT_EBO CameraIntrinsics : Windows::Media::Devices::Core::ICameraIntrinsics,
    ...
    struct WINRT_EBO DepthCorrelatedCoordinateMapper : Windows::Media::Devices::Core::IDepthCorrelatedCoordinateMapper
    {
    ...
    struct WINRT_EBO FrameControlCapabilities : Windows::Media::Devices::Core::IFrameControlCapabilities,
    ...
    struct WINRT_EBO FrameController : Windows::Media::Devices::Core::IFrameController,
    ...
    struct WINRT_EBO FrameExposureCapabilities : Windows::Media::Devices::Core::IFrameExposureCapabilities
    {
    ...
    struct WINRT_EBO FrameExposureCompensationCapabilities : Windows::Media::Devices::Core::IFrameExposureCompensationCapabilities
    {
    ...
    struct WINRT_EBO FrameExposureCompensationControl : Windows::Media::Devices::Core::IFrameExposureCompensationControl
    {
    ...
    struct WINRT_EBO FrameExposureControl : Windows::Media::Devices::Core::IFrameExposureControl
    {
    ...
    struct WINRT_EBO FrameFlashCapabilities : Windows::Media::Devices::Core::IFrameFlashCapabilities
    {
    ...
    struct WINRT_EBO FrameFlashControl : Windows::Media::Devices::Core::IFrameFlashControl
    {
    ...
    struct WINRT_EBO FrameFocusCapabilities : Windows::Media::Devices::Core::IFrameFocusCapabilities
    {
    ...
    struct WINRT_EBO FrameFocusControl : Windows::Media::Devices::Core::IFrameFocusControl
    {
    ...
    struct WINRT_EBO FrameIsoSpeedCapabilities : Windows::Media::Devices::Core::IFrameIsoSpeedCapabilities
    {
    ...
    struct WINRT_EBO FrameIsoSpeedControl : Windows::Media::Devices::Core::IFrameIsoSpeedControl
    {
    ...
    struct WINRT_EBO VariablePhotoSequenceController : Windows::Media::Devices::Core::IVariablePhotoSequenceController
    {
