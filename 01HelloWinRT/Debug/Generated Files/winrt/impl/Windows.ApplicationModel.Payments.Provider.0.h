...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Payments::Provider::IPaymentAppCanMakePaymentTriggerDetails>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL ReportCanMakePaymentResult(void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Payments::Provider::IPaymentAppManager>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL RegisterAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL UnregisterAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::Payments::Provider::IPaymentTransaction>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_PaymentRequest(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PayerEmail(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_PayerEmail(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PayerName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_PayerName(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PayerPhoneNumber(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_PayerPhoneNumber(void*) noexcept = 0;
            virtual int32_t WINRT_CALL UpdateShippingAddressAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL UpdateSelectedShippingOptionAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL AcceptAsync(void*, void**) noexcept = 0;
    ...
    {
        Windows::ApplicationModel::Payments::PaymentRequest Request() const;
    ...
    {
        Windows::Foundation::IAsyncAction RegisterAsync(param::iterable<hstring> const& supportedPaymentMethodIds) const;
