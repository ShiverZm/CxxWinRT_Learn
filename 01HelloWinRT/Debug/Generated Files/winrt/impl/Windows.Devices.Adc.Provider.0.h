...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::Adc::Provider::IAdcControllerProvider>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL AcquireChannel(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL ReleaseChannel(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL ReadValue(int32_t, int32_t*) noexcept = 0;
        };
    };
