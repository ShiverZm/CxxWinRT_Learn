...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Storage::Compression::ICompressorFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateCompressor(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateCompressorEx(void*, int32_t, uint32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Storage::Compression::IDecompressorFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateDecompressor(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
