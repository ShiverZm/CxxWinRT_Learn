...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::Bluetooth::Rfcomm::IRfcommDeviceService>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_ConnectionHostName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ConnectionServiceName(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_MaxProtectionLevel(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL GetSdpRawAttributesAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSdpRawAttributesWithCacheModeAsync(int32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::Bluetooth::Rfcomm::IRfcommDeviceServiceStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetDeviceSelectorForBluetoothDevice(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetDeviceSelectorForBluetoothDeviceWithCacheMode(void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetDeviceSelectorForBluetoothDeviceAndServiceId(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetDeviceSelectorForBluetoothDeviceAndServiceIdWithCacheMode(void*, void*, int32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::Bluetooth::Rfcomm::IRfcommServiceId>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL AsShortId(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL AsString(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Bluetooth::Rfcomm::IRfcommServiceIdStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL FromUuid(winrt::guid, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FromShortId(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SerialPort(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ObexObjectPush(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ObexFileTransfer(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PhoneBookAccessPce(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PhoneBookAccessPse(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_GenericFileTransfer(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Bluetooth::Rfcomm::IRfcommServiceProvider>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_ServiceId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SdpRawAttributes(void**) noexcept = 0;
            virtual int32_t WINRT_CALL StartAdvertising(void*) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Bluetooth::Rfcomm::IRfcommServiceProvider2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL StartAdvertisingWithRadioDiscoverability(void*, bool) noexcept = 0;
        };
    };
