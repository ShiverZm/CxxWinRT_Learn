...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Phone::StartScreen::IDualSimTile>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_IsPinnedToStart(bool*) noexcept = 0;
    ...
    template <> struct abi<Windows::Phone::StartScreen::IDualSimTileStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetTileForSim2(void**) noexcept = 0;
            virtual int32_t WINRT_CALL UpdateDisplayNameForSim1Async(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateTileUpdaterForSim1(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateTileUpdaterForSim2(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateBadgeUpdaterForSim1(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateBadgeUpdaterForSim2(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateToastNotifierForSim1(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateToastNotifierForSim2(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Phone::StartScreen::IToastNotificationManagerStatics3>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateToastNotifierForSecondaryTile(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
