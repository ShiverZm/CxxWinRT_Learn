...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Data::Json::IJsonArray>
    {
        ...
        {
            virtual int32_t WINRT_CALL GetObjectAt(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetArrayAt(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetStringAt(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNumberAt(uint32_t, double*) noexcept = 0;
            virtual int32_t WINRT_CALL GetBooleanAt(uint32_t, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Data::Json::IJsonErrorStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetJsonStatus(int32_t, int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Data::Json::IJsonObject>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetNamedValue(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetNamedValue(void*, void*) noexcept = 0;
            virtual int32_t WINRT_CALL GetNamedObject(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNamedArray(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNamedString(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNamedNumber(void*, double*) noexcept = 0;
            virtual int32_t WINRT_CALL GetNamedBoolean(void*, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Data::Json::IJsonObjectWithDefaultValues>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetNamedValueOrDefault(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNamedObjectOrDefault(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNamedStringOrDefault(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNamedArrayOrDefault(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNamedNumberOrDefault(void*, double, double*) noexcept = 0;
            virtual int32_t WINRT_CALL GetNamedBooleanOrDefault(void*, bool, bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Data::Json::IJsonValue>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ValueType(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL Stringify(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetString(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNumber(double*) noexcept = 0;
            virtual int32_t WINRT_CALL GetBoolean(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL GetArray(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetObject(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Data::Json::IJsonValueStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL Parse(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryParse(void*, void**, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL CreateBooleanValue(bool, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateNumberValue(double, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateStringValue(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Data::Json::IJsonValueStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateNullValue(void**) noexcept = 0;
        };
    };
    template <typename D>
