...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Contacts::DataProvider::IContactDataProviderConnection2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL add_CreateOrUpdateContactRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_CreateOrUpdateContactRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_DeleteContactRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_DeleteContactRequested(winrt::event_token) noexcept = 0;
        };
    };
