...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::CommunicationBlocking::ICommunicationBlockingAccessManagerStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_IsBlockingActive(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL IsBlockedNumberAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowBlockNumbersUI(void*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL ShowUnblockNumbersUI(void*, bool*) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::CommunicationBlocking::ICommunicationBlockingAppManagerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsCurrentAppActiveBlockingApp(bool*) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::CommunicationBlocking::ICommunicationBlockingAppManagerStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL RequestSetAsActiveBlockingAppAsync(void**) noexcept = 0;
        };
    };
    template <typename D>
