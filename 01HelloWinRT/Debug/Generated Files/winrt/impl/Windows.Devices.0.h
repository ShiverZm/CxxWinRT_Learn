...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::ILowLevelDevicesAggregateProvider>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_AdcControllerProvider(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PwmControllerProvider(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_GpioControllerProvider(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_I2cControllerProvider(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SpiControllerProvider(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::ILowLevelDevicesAggregateProviderFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL Create(void*, void*, void*, void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::ILowLevelDevicesControllerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_DefaultProvider(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_DefaultProvider(void*) noexcept = 0;
        };
    };
    template <typename D>
