...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::DataTransfer::ShareTarget::IQuickLink>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_SupportedDataFormats(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportedFileTypes(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::DataTransfer::ShareTarget::IShareOperation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_QuickLinkId(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL ReportCompletedWithQuickLink(void*) noexcept = 0;
