...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Networking::ServiceDiscovery::Dnssd::IDnssdRegistrationResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_HasInstanceNameChanged(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::ServiceDiscovery::Dnssd::IDnssdServiceInstance>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_DnssdServiceInstanceName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_DnssdServiceInstanceName(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_HostName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_HostName(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Port(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Port(uint16_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_Priority(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Priority(uint16_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_Weight(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Weight(uint16_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_TextAttributes(void**) noexcept = 0;
            virtual int32_t WINRT_CALL RegisterStreamSocketListenerAsync1(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RegisterStreamSocketListenerAsync2(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RegisterDatagramSocketAsync1(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RegisterDatagramSocketAsync2(void*, void*, void**) noexcept = 0;
        };
    };
