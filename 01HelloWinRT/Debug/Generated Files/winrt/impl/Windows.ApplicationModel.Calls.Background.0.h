...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Calls::Background::IPhoneCallBlockedTriggerDetails>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_CallBlockedReason(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Calls::Background::IPhoneCallOriginDataRequestTriggerDetails>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_RequestId(winrt::guid*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PhoneNumber(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Calls::Background::IPhoneIncomingCallDismissedTriggerDetails>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_DismissalTime(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_TextReplyMessage(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::Calls::Background::IPhoneLineChangedTriggerDetails>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL HasLinePropertyChanged(uint32_t, bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Calls::Background::IPhoneNewVoicemailMessageTriggerDetails>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_LineId(winrt::guid*) noexcept = 0;
            virtual int32_t WINRT_CALL get_VoicemailCount(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_OperatorMessage(void**) noexcept = 0;
        };
    };
    template <typename D>
