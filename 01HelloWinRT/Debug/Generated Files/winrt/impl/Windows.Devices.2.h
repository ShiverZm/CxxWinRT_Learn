...
{
    struct WINRT_EBO LowLevelDevicesAggregateProvider : Windows::Devices::ILowLevelDevicesAggregateProvider
    {
    ...
    struct WINRT_EBO LowLevelDevicesController : Windows::Devices::ILowLevelDevicesController
    {
