...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::ContentRestrictions::IContentRestrictionsBrowsePolicy>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_MaxBrowsableAgeRating(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PreferredAgeRating(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::ContentRestrictions::IRatedContentDescription>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_Category(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_Ratings(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_Ratings(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::ContentRestrictions::IRatedContentRestrictions>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetBrowsePolicyAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetRestrictionLevelAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestContentAccessAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_RestrictionsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_RestrictionsChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::ContentRestrictions::IRatedContentRestrictionsFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateWithMaxAgeRating(uint32_t, void**) noexcept = 0;
        };
    };
    template <typename D>
