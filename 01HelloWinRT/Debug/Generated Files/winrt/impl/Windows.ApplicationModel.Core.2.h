...
{
    struct WINRT_EBO AppListEntry : Windows::ApplicationModel::Core::IAppListEntry,
    ...
    struct WINRT_EBO CoreApplicationView : Windows::ApplicationModel::Core::ICoreApplicationView,
    ...
    struct WINRT_EBO CoreApplicationViewTitleBar : Windows::ApplicationModel::Core::ICoreApplicationViewTitleBar
    {
    ...
    struct WINRT_EBO HostedViewClosingEventArgs : Windows::ApplicationModel::Core::IHostedViewClosingEventArgs
    {
    ...
    struct WINRT_EBO UnhandledError : Windows::ApplicationModel::Core::IUnhandledError
    {
    ...
    struct WINRT_EBO UnhandledErrorDetectedEventArgs : Windows::ApplicationModel::Core::IUnhandledErrorDetectedEventArgs
    {
