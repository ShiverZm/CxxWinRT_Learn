...
namespace winrt::Windows::UI::Core
{
    ...
    struct WINRT_EBO AcceleratorKeyEventArgs : Windows::UI::Core::IAcceleratorKeyEventArgs,
    ...
    struct WINRT_EBO AutomationProviderRequestedEventArgs : Windows::UI::Core::IAutomationProviderRequestedEventArgs
    {
    ...
    struct WINRT_EBO BackRequestedEventArgs : Windows::UI::Core::IBackRequestedEventArgs
    {
    ...
    struct WINRT_EBO CharacterReceivedEventArgs : Windows::UI::Core::ICharacterReceivedEventArgs
    {
    ...
    struct WINRT_EBO ClosestInteractiveBoundsRequestedEventArgs : Windows::UI::Core::IClosestInteractiveBoundsRequestedEventArgs
    {
    ...
    struct WINRT_EBO CoreAcceleratorKeys : Windows::UI::Core::ICoreAcceleratorKeys
    {
    ...
    struct WINRT_EBO CoreComponentInputSource : Windows::UI::Core::ICoreInputSourceBase,
    ...
    struct WINRT_EBO CoreCursor : Windows::UI::Core::ICoreCursor
    {
    ...
    struct WINRT_EBO CoreDispatcher : Windows::UI::Core::ICoreDispatcher,
    ...
    struct WINRT_EBO CoreIndependentInputSource : Windows::UI::Core::ICoreInputSourceBase,
    ...
    struct WINRT_EBO CoreWindow : Windows::UI::Core::ICoreWindow,
    ...
    struct WINRT_EBO CoreWindowDialog : Windows::UI::Core::ICoreWindowDialog
    {
    ...
    struct WINRT_EBO CoreWindowEventArgs : Windows::UI::Core::ICoreWindowEventArgs
    {
    ...
    struct WINRT_EBO CoreWindowFlyout : Windows::UI::Core::ICoreWindowFlyout
    {
    ...
    struct WINRT_EBO CoreWindowPopupShowingEventArgs : Windows::UI::Core::ICoreWindowPopupShowingEventArgs
    {
    ...
    struct WINRT_EBO CoreWindowResizeManager : Windows::UI::Core::ICoreWindowResizeManager,
    ...
    struct WINRT_EBO IdleDispatchedHandlerArgs : Windows::UI::Core::IIdleDispatchedHandlerArgs
    {
    ...
    struct WINRT_EBO InputEnabledEventArgs : Windows::UI::Core::IInputEnabledEventArgs
    {
    ...
    struct WINRT_EBO KeyEventArgs : Windows::UI::Core::IKeyEventArgs,
    ...
    struct WINRT_EBO PointerEventArgs : Windows::UI::Core::IPointerEventArgs
    {
    ...
    struct WINRT_EBO SystemNavigationManager : Windows::UI::Core::ISystemNavigationManager,
    ...
    struct WINRT_EBO TouchHitTestingEventArgs : Windows::UI::Core::ITouchHitTestingEventArgs
    {
    ...
    struct WINRT_EBO VisibilityChangedEventArgs : Windows::UI::Core::IVisibilityChangedEventArgs
    {
    ...
    struct WINRT_EBO WindowActivatedEventArgs : Windows::UI::Core::IWindowActivatedEventArgs
    {
    ...
    struct WINRT_EBO WindowSizeChangedEventArgs : Windows::UI::Core::IWindowSizeChangedEventArgs
    {
