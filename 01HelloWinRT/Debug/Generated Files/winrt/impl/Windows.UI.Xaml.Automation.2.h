...
{
    struct WINRT_EBO AnnotationPatternIdentifiers : Windows::UI::Xaml::Automation::IAnnotationPatternIdentifiers
    {
    ...
    struct WINRT_EBO AutomationAnnotation : Windows::UI::Xaml::Automation::IAutomationAnnotation,
    ...
    struct WINRT_EBO AutomationElementIdentifiers : Windows::UI::Xaml::Automation::IAutomationElementIdentifiers
    {
    ...
    struct WINRT_EBO AutomationProperties : Windows::UI::Xaml::Automation::IAutomationProperties
    {
    ...
    struct WINRT_EBO AutomationProperty : Windows::UI::Xaml::Automation::IAutomationProperty
    {
    ...
    struct WINRT_EBO DockPatternIdentifiers : Windows::UI::Xaml::Automation::IDockPatternIdentifiers
    {
    ...
    struct WINRT_EBO DragPatternIdentifiers : Windows::UI::Xaml::Automation::IDragPatternIdentifiers
    {
    ...
    struct WINRT_EBO DropTargetPatternIdentifiers : Windows::UI::Xaml::Automation::IDropTargetPatternIdentifiers
    {
    ...
    struct WINRT_EBO ExpandCollapsePatternIdentifiers : Windows::UI::Xaml::Automation::IExpandCollapsePatternIdentifiers
    {
    ...
    struct WINRT_EBO GridItemPatternIdentifiers : Windows::UI::Xaml::Automation::IGridItemPatternIdentifiers
    {
    ...
    struct WINRT_EBO GridPatternIdentifiers : Windows::UI::Xaml::Automation::IGridPatternIdentifiers
    {
    ...
    struct WINRT_EBO MultipleViewPatternIdentifiers : Windows::UI::Xaml::Automation::IMultipleViewPatternIdentifiers
    {
    ...
    struct WINRT_EBO RangeValuePatternIdentifiers : Windows::UI::Xaml::Automation::IRangeValuePatternIdentifiers
    {
    ...
    struct WINRT_EBO ScrollPatternIdentifiers : Windows::UI::Xaml::Automation::IScrollPatternIdentifiers
    {
    ...
    struct WINRT_EBO SelectionItemPatternIdentifiers : Windows::UI::Xaml::Automation::ISelectionItemPatternIdentifiers
    {
    ...
    struct WINRT_EBO SelectionPatternIdentifiers : Windows::UI::Xaml::Automation::ISelectionPatternIdentifiers
    {
    ...
    struct WINRT_EBO SpreadsheetItemPatternIdentifiers : Windows::UI::Xaml::Automation::ISpreadsheetItemPatternIdentifiers
    {
    ...
    struct WINRT_EBO StylesPatternIdentifiers : Windows::UI::Xaml::Automation::IStylesPatternIdentifiers
    {
    ...
    struct WINRT_EBO TableItemPatternIdentifiers : Windows::UI::Xaml::Automation::ITableItemPatternIdentifiers
    {
    ...
    struct WINRT_EBO TablePatternIdentifiers : Windows::UI::Xaml::Automation::ITablePatternIdentifiers
    {
    ...
    struct WINRT_EBO TogglePatternIdentifiers : Windows::UI::Xaml::Automation::ITogglePatternIdentifiers
    {
    ...
    struct WINRT_EBO TransformPattern2Identifiers : Windows::UI::Xaml::Automation::ITransformPattern2Identifiers
    {
    ...
    struct WINRT_EBO TransformPatternIdentifiers : Windows::UI::Xaml::Automation::ITransformPatternIdentifiers
    {
    ...
    struct WINRT_EBO ValuePatternIdentifiers : Windows::UI::Xaml::Automation::IValuePatternIdentifiers
    {
    ...
    struct WINRT_EBO WindowPatternIdentifiers : Windows::UI::Xaml::Automation::IWindowPatternIdentifiers
    {
