...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::AppExtensions::IAppExtension>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetExtensionPropertiesAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetPublicFolderAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::AppExtensions::IAppExtensionCatalog>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL RequestRemovePackageAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_PackageInstalled(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_PackageInstalled(winrt::event_token) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL add_PackageUpdated(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_PackageUpdated(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::AppExtensions::IAppExtensionCatalogStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL Open(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::AppExtensions::IAppExtensionPackageInstalledEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_AppExtensionName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Package(void**) noexcept = 0;
