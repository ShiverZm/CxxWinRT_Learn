...
namespace winrt::Windows::Graphics::Printing3D
{
    ...
    struct WINRT_EBO Print3DManager : Windows::Graphics::Printing3D::IPrint3DManager
    {
    ...
    struct WINRT_EBO Print3DTask : Windows::Graphics::Printing3D::IPrint3DTask
    {
    ...
    struct WINRT_EBO Print3DTaskCompletedEventArgs : Windows::Graphics::Printing3D::IPrint3DTaskCompletedEventArgs
    {
    ...
    struct WINRT_EBO Print3DTaskRequest : Windows::Graphics::Printing3D::IPrint3DTaskRequest
    {
    ...
    struct WINRT_EBO Print3DTaskRequestedEventArgs : Windows::Graphics::Printing3D::IPrint3DTaskRequestedEventArgs
    {
    ...
    struct WINRT_EBO Print3DTaskSourceChangedEventArgs : Windows::Graphics::Printing3D::IPrint3DTaskSourceChangedEventArgs
    {
    ...
    struct WINRT_EBO Print3DTaskSourceRequestedArgs : Windows::Graphics::Printing3D::IPrint3DTaskSourceRequestedArgs
    {
    ...
    struct WINRT_EBO Printing3D3MFPackage : Windows::Graphics::Printing3D::IPrinting3D3MFPackage,
    ...
    struct WINRT_EBO Printing3DBaseMaterial : Windows::Graphics::Printing3D::IPrinting3DBaseMaterial
    {
    ...
    struct WINRT_EBO Printing3DBaseMaterialGroup : Windows::Graphics::Printing3D::IPrinting3DBaseMaterialGroup
    {
    ...
    struct WINRT_EBO Printing3DColorMaterial : Windows::Graphics::Printing3D::IPrinting3DColorMaterial,
    ...
    struct WINRT_EBO Printing3DColorMaterialGroup : Windows::Graphics::Printing3D::IPrinting3DColorMaterialGroup
    {
    ...
    struct WINRT_EBO Printing3DComponent : Windows::Graphics::Printing3D::IPrinting3DComponent
    {
    ...
    struct WINRT_EBO Printing3DComponentWithMatrix : Windows::Graphics::Printing3D::IPrinting3DComponentWithMatrix
    {
    ...
    struct WINRT_EBO Printing3DCompositeMaterial : Windows::Graphics::Printing3D::IPrinting3DCompositeMaterial
    {
    ...
    struct WINRT_EBO Printing3DCompositeMaterialGroup : Windows::Graphics::Printing3D::IPrinting3DCompositeMaterialGroup,
    ...
    struct WINRT_EBO Printing3DFaceReductionOptions : Windows::Graphics::Printing3D::IPrinting3DFaceReductionOptions
    {
    ...
    struct WINRT_EBO Printing3DMaterial : Windows::Graphics::Printing3D::IPrinting3DMaterial
    {
    ...
    struct WINRT_EBO Printing3DMesh : Windows::Graphics::Printing3D::IPrinting3DMesh
    {
    ...
    struct WINRT_EBO Printing3DMeshVerificationResult : Windows::Graphics::Printing3D::IPrinting3DMeshVerificationResult
    {
    ...
    struct WINRT_EBO Printing3DModel : Windows::Graphics::Printing3D::IPrinting3DModel,
    ...
    struct WINRT_EBO Printing3DModelTexture : Windows::Graphics::Printing3D::IPrinting3DModelTexture
    {
    ...
    struct WINRT_EBO Printing3DMultiplePropertyMaterial : Windows::Graphics::Printing3D::IPrinting3DMultiplePropertyMaterial
    {
    ...
    struct WINRT_EBO Printing3DMultiplePropertyMaterialGroup : Windows::Graphics::Printing3D::IPrinting3DMultiplePropertyMaterialGroup
    {
    ...
    struct WINRT_EBO Printing3DTexture2CoordMaterial : Windows::Graphics::Printing3D::IPrinting3DTexture2CoordMaterial
    {
    ...
    struct WINRT_EBO Printing3DTexture2CoordMaterialGroup : Windows::Graphics::Printing3D::IPrinting3DTexture2CoordMaterialGroup,
    ...
    struct WINRT_EBO Printing3DTextureResource : Windows::Graphics::Printing3D::IPrinting3DTextureResource
    {
