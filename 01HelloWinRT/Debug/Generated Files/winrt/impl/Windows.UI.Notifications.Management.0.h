...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Notifications::Management::IUserNotificationListener>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL add_NotificationChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_NotificationChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL GetNotificationsAsync(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNotification(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ClearNotifications() noexcept = 0;
            virtual int32_t WINRT_CALL RemoveNotification(uint32_t) noexcept = 0;
        };
    };
