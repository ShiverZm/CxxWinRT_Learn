...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::Scanners::IImageScanner>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_DefaultScanSource(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL IsScanSourceSupported(int32_t, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_FlatbedConfiguration(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_FeederConfiguration(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_AutoConfiguration(void**) noexcept = 0;
            virtual int32_t WINRT_CALL IsPreviewSupported(int32_t, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL ScanPreviewToStreamAsync(int32_t, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ScanFilesToFolderAsync(int32_t, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Scanners::IImageScannerFeederConfiguration>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CanAutoDetectPageSize(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AutoDetectPageSize(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AutoDetectPageSize(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_PageSize(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_PageSize(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_PageOrientation(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_PageOrientation(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_PageSizeDimensions(Windows::Foundation::Size*) noexcept = 0;
            virtual int32_t WINRT_CALL IsPageSizeSupported(int32_t, int32_t, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxNumberOfPages(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_MaxNumberOfPages(uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_CanScanDuplex(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Duplex(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Duplex(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_CanScanAhead(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ScanAhead(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ScanAhead(bool) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Scanners::IImageScannerFormatConfiguration>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_DefaultFormat(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Format(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Format(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL IsFormatSupported(int32_t, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::Scanners::IImageScannerScanResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ScannedFiles(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Scanners::IImageScannerSourceConfiguration>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_MinScanArea(Windows::Foundation::Size*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxScanArea(Windows::Foundation::Size*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedScanRegion(Windows::Foundation::Rect*) noexcept = 0;
            virtual int32_t WINRT_CALL put_SelectedScanRegion(Windows::Foundation::Rect) noexcept = 0;
            virtual int32_t WINRT_CALL get_AutoCroppingMode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AutoCroppingMode(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL IsAutoCroppingModeSupported(int32_t, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MinResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution*) noexcept = 0;
            virtual int32_t WINRT_CALL get_OpticalResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DesiredResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution*) noexcept = 0;
            virtual int32_t WINRT_CALL put_DesiredResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution) noexcept = 0;
            virtual int32_t WINRT_CALL get_ActualResolution(struct struct_Windows_Devices_Scanners_ImageScannerResolution*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DefaultColorMode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ColorMode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ColorMode(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL IsColorModeSupported(int32_t, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MinBrightness(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxBrightness(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_BrightnessStep(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DefaultBrightness(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Brightness(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Brightness(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_MinContrast(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxContrast(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ContrastStep(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DefaultContrast(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Contrast(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Contrast(int32_t) noexcept = 0;
        };
    };
