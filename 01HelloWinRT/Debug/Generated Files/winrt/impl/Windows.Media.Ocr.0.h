...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::Ocr::IOcrEngine>
    {
        ...
        {
            virtual int32_t WINRT_CALL RecognizeAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RecognizerLanguage(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Ocr::IOcrEngineStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_MaxImageDimension(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AvailableRecognizerLanguages(void**) noexcept = 0;
            virtual int32_t WINRT_CALL IsLanguageSupported(void*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL TryCreateFromLanguage(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryCreateFromUserProfileLanguages(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Ocr::IOcrLine>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Words(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Media::Ocr::IOcrResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_TextAngle(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Text(void**) noexcept = 0;
        };
    };
