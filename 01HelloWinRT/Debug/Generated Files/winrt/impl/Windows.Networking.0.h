...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Networking::IEndpointPair>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_LocalHostName(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_LocalServiceName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_LocalServiceName(void*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL put_RemoteServiceName(void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::IEndpointPairFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateEndpointPair(void*, void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::IHostName>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IPInformation(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RawName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DisplayName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_CanonicalName(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Networking::IHostNameFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateHostName(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::IHostNameStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL Compare(void*, void*, int32_t*) noexcept = 0;
        };
    };
    template <typename D>
