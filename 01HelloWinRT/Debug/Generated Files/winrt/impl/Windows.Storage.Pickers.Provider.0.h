...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Storage::Pickers::Provider::IFileOpenPickerUI>
    {
        ...
        {
            virtual int32_t WINRT_CALL AddFile(void*, void*, int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL RemoveFile(void*) noexcept = 0;
            virtual int32_t WINRT_CALL ContainsFile(void*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL CanAddFile(void*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AllowedFileTypes(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL add_FileRemoved(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_FileRemoved(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<Windows::Storage::Pickers::Provider::IFileSavePickerUI>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL TrySetFileName(void*, int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL add_FileNameChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_FileNameChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_TargetFileRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_TargetFileRequested(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Storage::Pickers::Provider::IPickerClosingEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ClosingOperation(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Storage::Pickers::Provider::ITargetFileRequest>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_TargetFile(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_TargetFile(void*) noexcept = 0;
            virtual int32_t WINRT_CALL GetDeferral(void**) noexcept = 0;
        };
    };
