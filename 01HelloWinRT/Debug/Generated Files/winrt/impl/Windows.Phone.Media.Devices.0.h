...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Phone::Media::Devices::IAudioRoutingManager>
    {
        ...
        {
            virtual int32_t WINRT_CALL GetAudioEndpoint(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL SetAudioEndpoint(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL add_AudioEndpointChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_AudioEndpointChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_AvailableAudioEndpoints(uint32_t*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Phone_Media_Devices_IAudioRoutingManager
    {
        ...
        winrt::event_token AudioEndpointChanged(Windows::Foundation::TypedEventHandler<Windows::Phone::Media::Devices::AudioRoutingManager, Windows::Foundation::IInspectable> const& endpointChangeHandler) const;
        ...
        void AudioEndpointChanged(winrt::event_token const& token) const noexcept;
