...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorAuthenticationManager>
    {
        ...
        {
            virtual int32_t WINRT_CALL GetOneTimePassCodeAsync(void*, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL AddDeviceAsync(void*, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RemoveDeviceAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL UpdateWnsChannelAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSessionsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSessionsAndUnregisteredAccountsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ApproveSessionUsingAuthSessionInfoAsync(int32_t, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ApproveSessionAsync(int32_t, void*, void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DenySessionUsingAuthSessionInfoAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DenySessionAsync(void*, void*, int32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorGetSessionsResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Sessions(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ServiceResponse(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorOneTimeCodedInfo>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_TimeInterval(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_TimeToLive(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ServiceResponse(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorSessionInfo>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_UserAccountId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SessionId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DisplaySessionId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ApprovalStatus(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AuthenticationType(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_RequestTime(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ExpirationTime(int64_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Authentication::Identity::Core::IMicrosoftAccountMultiFactorUnregisteredAccountsAndSessionInfo>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_Sessions(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_UnregisteredAccounts(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ServiceResponse(int32_t*) noexcept = 0;
        };
    };
    template <typename D>
