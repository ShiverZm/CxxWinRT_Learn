...
namespace winrt::Windows::UI::Popups
{
    ...
    struct WINRT_EBO MessageDialog : Windows::UI::Popups::IMessageDialog
    {
    ...
    struct WINRT_EBO PopupMenu : Windows::UI::Popups::IPopupMenu
    {
    ...
    struct WINRT_EBO UICommand : Windows::UI::Popups::IUICommand
    {
    ...
    struct WINRT_EBO UICommandSeparator : Windows::UI::Popups::IUICommand
    {
