...
namespace winrt::Windows::UI::Xaml::Printing
{
    ...
    struct WINRT_EBO AddPagesEventArgs : Windows::UI::Xaml::Printing::IAddPagesEventArgs
    {
    ...
    struct WINRT_EBO GetPreviewPageEventArgs : Windows::UI::Xaml::Printing::IGetPreviewPageEventArgs
    {
    ...
    struct WINRT_EBO PaginateEventArgs : Windows::UI::Xaml::Printing::IPaginateEventArgs
    {
    ...
    struct WINRT_EBO PrintDocument : Windows::UI::Xaml::Printing::IPrintDocument,
