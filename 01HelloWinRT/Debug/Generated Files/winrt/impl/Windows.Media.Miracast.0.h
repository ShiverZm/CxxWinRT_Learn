...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiver>
    {
        ...
        {
            virtual int32_t WINRT_CALL GetDefaultSettings(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetCurrentSettings(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetCurrentSettingsAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL DisconnectAllAndApplySettings(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DisconnectAllAndApplySettingsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetStatus(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL CreateSession(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateSessionAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ClearKnownTransmitters() noexcept = 0;
            virtual int32_t WINRT_CALL RemoveKnownTransmitter(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiverConnection>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL Disconnect(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL DisconnectWithMessage(int32_t, void*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_Transmitter(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_InputDevices(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_CursorImageChannel(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_StreamControl(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiverCursorImageChannel>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_MaxImageSize(struct struct_Windows_Graphics_SizeInt32*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Position(struct struct_Windows_Graphics_PointInt32*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ImageStream(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_ImageStreamChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ImageStreamChanged(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiverCursorImageChannelSettings>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_MaxImageSize(struct struct_Windows_Graphics_SizeInt32*) noexcept = 0;
            virtual int32_t WINRT_CALL put_MaxImageSize(struct struct_Windows_Graphics_SizeInt32) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiverGameControllerDevice>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_TransmitInput(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_TransmitInput(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsRequestedByTransmitter(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsTransmittingInput(bool*) noexcept = 0;
    ...
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiverInputDevices>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Keyboard(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_GameController(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiverMediaSourceCreatedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_CursorImageChannelSettings(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetDeferral(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiverSession>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL add_ConnectionCreated(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ConnectionCreated(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_MediaSourceCreated(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_MediaSourceCreated(winrt::event_token) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_AllowConnectionTakeover(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AllowConnectionTakeover(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxSimultaneousConnections(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_MaxSimultaneousConnections(int32_t) noexcept = 0;
    ...
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiverSettings>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_ModelName(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ModelNumber(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_ModelNumber(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AuthorizationMethod(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AuthorizationMethod(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_RequireAuthorizationFromKnownTransmitters(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_RequireAuthorizationFromKnownTransmitters(bool) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiverStatus>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ListeningStatus(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_WiFiStatus(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsConnectionTakeoverSupported(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxSimultaneousConnections(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_KnownTransmitters(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiverStreamControl>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetVideoStreamSettings(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetVideoStreamSettingsAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SuggestVideoStreamSettings(void*) noexcept = 0;
            virtual int32_t WINRT_CALL SuggestVideoStreamSettingsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_MuteAudio(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_MuteAudio(bool) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Miracast::IMiracastReceiverVideoStreamSettings>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Size(struct struct_Windows_Graphics_SizeInt32*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Size(struct struct_Windows_Graphics_SizeInt32) noexcept = 0;
            virtual int32_t WINRT_CALL get_Bitrate(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Bitrate(int32_t) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Miracast::IMiracastTransmitter>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_AuthorizationStatus(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AuthorizationStatus(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL GetConnections(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_MacAddress(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_LastConnectionTime(int64_t*) noexcept = 0;
        };
    };
    template <typename D>
