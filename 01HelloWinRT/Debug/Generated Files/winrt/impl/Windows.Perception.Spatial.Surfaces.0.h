...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Perception::Spatial::Surfaces::ISpatialSurfaceInfo>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL TryGetBounds(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryComputeLatestMeshAsync(double, void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryComputeLatestMeshWithOptionsAsync(double, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Perception::Spatial::Surfaces::ISpatialSurfaceMesh>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SurfaceInfo(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_CoordinateSystem(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_TriangleIndices(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_VertexPositions(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_VertexPositionScale(Windows::Foundation::Numerics::float3*) noexcept = 0;
            virtual int32_t WINRT_CALL get_VertexNormals(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Perception::Spatial::Surfaces::ISpatialSurfaceMeshBuffer>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Stride(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ElementCount(uint32_t*) noexcept = 0;
    ...
    template <> struct abi<Windows::Perception::Spatial::Surfaces::ISpatialSurfaceMeshOptions>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_VertexPositionFormat(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_VertexPositionFormat(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_TriangleIndexFormat(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_TriangleIndexFormat(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_VertexNormalFormat(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_VertexNormalFormat(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_IncludeVertexNormals(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IncludeVertexNormals(bool) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Perception::Spatial::Surfaces::ISpatialSurfaceMeshOptionsStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SupportedVertexPositionFormats(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportedTriangleIndexFormats(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportedVertexNormalFormats(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Perception::Spatial::Surfaces::ISpatialSurfaceObserver>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetObservedSurfaces(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetBoundingVolume(void*) noexcept = 0;
            virtual int32_t WINRT_CALL SetBoundingVolumes(void*) noexcept = 0;
            virtual int32_t WINRT_CALL add_ObservedSurfacesChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ObservedSurfacesChanged(winrt::event_token) noexcept = 0;
        };
    };
