...
{
    struct WINRT_EBO CoreIncrementalInkStroke : Windows::UI::Input::Inking::Core::ICoreIncrementalInkStroke
    {
    ...
    struct WINRT_EBO CoreInkIndependentInputSource : Windows::UI::Input::Inking::Core::ICoreInkIndependentInputSource
    {
    ...
    struct WINRT_EBO CoreInkPresenterHost : Windows::UI::Input::Inking::Core::ICoreInkPresenterHost
    {
    ...
    struct WINRT_EBO CoreWetStrokeUpdateEventArgs : Windows::UI::Input::Inking::Core::ICoreWetStrokeUpdateEventArgs
    {
    ...
    struct WINRT_EBO CoreWetStrokeUpdateSource : Windows::UI::Input::Inking::Core::ICoreWetStrokeUpdateSource
    {
