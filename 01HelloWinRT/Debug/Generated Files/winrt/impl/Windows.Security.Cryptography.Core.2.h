...
namespace winrt::Windows::Security::Cryptography::Core
{
    ...
    struct WINRT_EBO AsymmetricKeyAlgorithmProvider : Windows::Security::Cryptography::Core::IAsymmetricKeyAlgorithmProvider,
    ...
    struct WINRT_EBO CryptographicHash : Windows::Security::Cryptography::Core::IHashComputation
    {
    ...
    struct WINRT_EBO CryptographicKey : Windows::Security::Cryptography::Core::ICryptographicKey
    {
    ...
    struct WINRT_EBO EncryptedAndAuthenticatedData : Windows::Security::Cryptography::Core::IEncryptedAndAuthenticatedData
    {
    ...
    struct WINRT_EBO HashAlgorithmProvider : Windows::Security::Cryptography::Core::IHashAlgorithmProvider
    {
    ...
    struct WINRT_EBO KeyDerivationAlgorithmProvider : Windows::Security::Cryptography::Core::IKeyDerivationAlgorithmProvider
    {
    ...
    struct WINRT_EBO KeyDerivationParameters : Windows::Security::Cryptography::Core::IKeyDerivationParameters,
    ...
    struct WINRT_EBO MacAlgorithmProvider : Windows::Security::Cryptography::Core::IMacAlgorithmProvider,
    ...
    struct WINRT_EBO SymmetricKeyAlgorithmProvider : Windows::Security::Cryptography::Core::ISymmetricKeyAlgorithmProvider
    {
