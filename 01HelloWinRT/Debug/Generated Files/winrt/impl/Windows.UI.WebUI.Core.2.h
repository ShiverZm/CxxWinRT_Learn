...
namespace winrt::Windows::UI::WebUI::Core
{
    ...
    struct WINRT_EBO WebUICommandBar : Windows::UI::WebUI::Core::IWebUICommandBar
    {
    ...
    struct WINRT_EBO WebUICommandBarBitmapIcon : Windows::UI::WebUI::Core::IWebUICommandBarBitmapIcon
    {
    ...
    struct WINRT_EBO WebUICommandBarConfirmationButton : Windows::UI::WebUI::Core::IWebUICommandBarConfirmationButton
    {
    ...
    struct WINRT_EBO WebUICommandBarIconButton : Windows::UI::WebUI::Core::IWebUICommandBarIconButton
    {
    ...
    struct WINRT_EBO WebUICommandBarItemInvokedEventArgs : Windows::UI::WebUI::Core::IWebUICommandBarItemInvokedEventArgs
    {
    ...
    struct WINRT_EBO WebUICommandBarSizeChangedEventArgs : Windows::UI::WebUI::Core::IWebUICommandBarSizeChangedEventArgs
    {
    ...
    struct WINRT_EBO WebUICommandBarSymbolIcon : Windows::UI::WebUI::Core::IWebUICommandBarSymbolIcon
    {
