...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Services::Cortana::ICortanaActionableInsights>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL IsAvailableAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowInsightsForImageAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowInsightsForImageWithOptionsAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowInsightsForTextAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowInsightsForTextWithOptionsAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowInsightsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowInsightsWithOptionsAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Services::Cortana::ICortanaActionableInsightsOptions>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_SurroundingText(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_SurroundingText(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Services::Cortana::ICortanaPermissionsManager>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL ArePermissionsGrantedAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GrantPermissionsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RevokePermissionsAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Services::Cortana::ICortanaSettings>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_HasUserConsentToVoiceActivation(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsVoiceActivationEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsVoiceActivationEnabled(bool) noexcept = 0;
        };
    };
