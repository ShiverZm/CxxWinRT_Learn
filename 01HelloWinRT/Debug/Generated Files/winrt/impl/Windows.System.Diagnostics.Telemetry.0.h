...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::System::Diagnostics::Telemetry::IPlatformTelemetryClientStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL Register(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RegisterWithSettings(void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::System::Diagnostics::Telemetry::IPlatformTelemetryRegistrationSettings>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_StorageSize(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_StorageSize(uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_UploadQuotaSize(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_UploadQuotaSize(uint32_t) noexcept = 0;
        };
    };
    template <typename D>
