...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::Power::IBattery>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL add_ReportUpdated(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ReportUpdated(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Power::IBatteryReport>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ChargeRateInMilliwatts(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DesignCapacityInMilliwattHours(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_FullChargeCapacityInMilliwattHours(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RemainingCapacityInMilliwattHours(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Power::IBatteryStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_AggregateBattery(void**) noexcept = 0;
