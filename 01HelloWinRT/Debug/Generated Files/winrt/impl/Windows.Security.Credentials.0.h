...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Security::Credentials::ICredentialFactory>
    {
        ...
        {
            virtual int32_t WINRT_CALL CreatePasswordCredential(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Credentials::IKeyCredential>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL RetrievePublicKeyWithDefaultBlobType(void**) noexcept = 0;
            virtual int32_t WINRT_CALL RetrievePublicKeyWithBlobType(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestSignAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetAttestationAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Credentials::IKeyCredentialAttestationResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CertificateChainBuffer(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_AttestationBuffer(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Security::Credentials::IKeyCredentialManagerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL RenewAttestationAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestCreateAsync(void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL OpenAsync(void*, void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Security::Credentials::IKeyCredentialRetrievalResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Credential(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Status(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Credentials::IPasswordCredential>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Resource(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_Resource(void*) noexcept = 0;
    ...
    template <> struct abi<Windows::Security::Credentials::IPasswordVault>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL Retrieve(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FindAllByResource(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FindAllByUserName(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RetrieveAll(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Security::Credentials::IWebAccount2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL SignOutAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SignOutWithClientIdAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Credentials::IWebAccountFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateWebAccount(void*, void*, int32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Security::Credentials::IWebAccountProvider2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_DisplayPurpose(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Authority(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Security::Credentials::IWebAccountProvider4>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsSystemProvider(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Credentials::IWebAccountProviderFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateWebAccountProvider(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <typename D>
