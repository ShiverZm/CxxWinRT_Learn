...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Xaml::Navigation::IFrameNavigationOptions>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_IsNavigationStackEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsNavigationStackEnabled(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_TransitionInfoOverride(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_TransitionInfoOverride(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::UI::Xaml::Navigation::INavigatingCancelEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_NavigationMode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SourcePageType(struct struct_Windows_UI_Xaml_Interop_TypeName*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Xaml::Navigation::INavigatingCancelEventArgs2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_NavigationTransitionInfo(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::UI::Xaml::Navigation::IPageStackEntryFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateInstance(struct struct_Windows_UI_Xaml_Interop_TypeName, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Xaml::Navigation::IPageStackEntryStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SourcePageTypeProperty(void**) noexcept = 0;
        };
    };
