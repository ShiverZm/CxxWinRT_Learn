...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::PointOfService::Provider::IBarcodeScannerDisableScannerRequest2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL ReportFailedWithFailedReasonAsync(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReportFailedWithFailedReasonAndDescriptionAsync(int32_t, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::PointOfService::Provider::IBarcodeScannerFrameReader>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL TryAcquireLatestFrameAsync(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::PointOfService::Provider::IBarcodeScannerGetSymbologyAttributesRequest>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Symbology(uint32_t*) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::PointOfService::Provider::IBarcodeScannerProviderConnection>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_SupportedSymbologies(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL ReportScannedDataAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReportTriggerStateAsync(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReportErrorAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReportErrorAsyncWithScanReport(void*, bool, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_EnableScannerRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_EnableScannerRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_DisableScannerRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_DisableScannerRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_SetActiveSymbologiesRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_SetActiveSymbologiesRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_StartSoftwareTriggerRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_StartSoftwareTriggerRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_StopSoftwareTriggerRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_StopSoftwareTriggerRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_GetBarcodeSymbologyAttributesRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_GetBarcodeSymbologyAttributesRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_SetBarcodeSymbologyAttributesRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_SetBarcodeSymbologyAttributesRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_HideVideoPreviewRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_HideVideoPreviewRequested(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::PointOfService::Provider::IBarcodeScannerProviderConnection2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateFrameReaderAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFrameReaderWithFormatAsync(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFrameReaderWithFormatAndSizeAsync(int32_t, struct struct_Windows_Graphics_Imaging_BitmapSize, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::PointOfService::Provider::IBarcodeScannerSetActiveSymbologiesRequest>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Symbologies(void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReportCompletedAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReportFailedAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::PointOfService::Provider::IBarcodeSymbologyAttributesBuilder>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_IsCheckDigitValidationSupported(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsCheckDigitTransmissionSupported(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsCheckDigitTransmissionSupported(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsDecodeLengthSupported(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsDecodeLengthSupported(bool) noexcept = 0;
            virtual int32_t WINRT_CALL CreateAttributes(void**) noexcept = 0;
        };
    };
    template <typename D>
