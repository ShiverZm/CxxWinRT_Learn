...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::System::Profile::SystemManufacturers::IOemSupportInfo>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_SupportLink(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportAppLink(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportProvider(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::System::Profile::SystemManufacturers::ISystemSupportInfoStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_LocalSystemEdition(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_OemSupportInfo(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::SystemManufacturers::ISystemSupportInfoStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_LocalDeviceInfo(void**) noexcept = 0;
        };
    };
    template <typename D>
