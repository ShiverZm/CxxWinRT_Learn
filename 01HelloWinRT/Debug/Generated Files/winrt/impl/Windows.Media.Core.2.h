...
namespace winrt::Windows::Media::Core
{
    ...
    struct WINRT_EBO AudioStreamDescriptor : Windows::Media::Core::IAudioStreamDescriptor,
        impl::require<AudioStreamDescriptor, Windows::Media::Core::IAudioStreamDescriptor2, Windows::Media::Core::IAudioStreamDescriptor3, Windows::Media::Core::IMediaStreamDescriptor2>
    {
    ...
    struct WINRT_EBO TimedMetadataStreamDescriptor : Windows::Media::Core::IMediaStreamDescriptor,
        impl::require<TimedMetadataStreamDescriptor, Windows::Media::Core::IMediaStreamDescriptor2, Windows::Media::Core::ITimedMetadataStreamDescriptor>
    {
