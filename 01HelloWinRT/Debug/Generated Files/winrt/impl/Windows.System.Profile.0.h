...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::System::Profile::IAnalyticsInfoStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_VersionInfo(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DeviceForm(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::IAnalyticsInfoStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetSystemPropertiesAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::IAnalyticsVersionInfo>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_DeviceFamily(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DeviceFamilyVersion(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::IAppApplicabilityStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetUnsupportedAppRequirements(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::IEducationSettingsStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsEducationEnvironment(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::IHardwareIdentificationStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetPackageSpecificToken(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::IHardwareToken>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Signature(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::System::Profile::IKnownRetailInfoPropertiesStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_RetailAccessCode(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ManufacturerName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ModelName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DisplayModelName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Price(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsFeatured(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_FormFactor(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ScreenSize(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Weight(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DisplayDescription(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_BatteryLifeDescription(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ProcessorDescription(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Memory(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_StorageDescription(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_GraphicsDescription(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_FrontCameraDescription(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RearCameraDescription(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_HasNfc(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_HasSdSlot(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_HasOpticalDrive(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsOfficeInstalled(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_WindowsEdition(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::IPlatformDiagnosticsAndUsageDataSettingsStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CollectionLevel(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL add_CollectionLevelChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_CollectionLevelChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL CanCollectDiagnostics(int32_t, bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::IRetailInfoStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsDemoModeEnabled(bool*) noexcept = 0;
    ...
    template <> struct abi<Windows::System::Profile::ISharedModeSettingsStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ShouldAvoidLocalStorage(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::System::Profile::ISystemIdentificationStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetSystemIdForPublisher(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSystemIdForUser(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::ISystemSetupInfoStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_OutOfBoxExperienceState(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL add_OutOfBoxExperienceStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_OutOfBoxExperienceStateChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::IUnsupportedAppRequirement>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Requirement(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Reasons(uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Profile::IWindowsIntegrityPolicyStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_IsEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsEnabledForTrial(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CanDisable(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsDisableSupported(bool*) noexcept = 0;
