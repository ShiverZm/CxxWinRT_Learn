...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Gaming::Input::ForceFeedback::IConditionForceEffect>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL SetParameters(Windows::Foundation::Numerics::float3, float, float, float, float, float, float) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Gaming::Input::ForceFeedback::IConstantForceEffect>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL SetParameters(Windows::Foundation::Numerics::float3, int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL SetParametersWithEnvelope(Windows::Foundation::Numerics::float3, float, float, float, int64_t, int64_t, int64_t, int64_t, uint32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Gaming::Input::ForceFeedback::IForceFeedbackMotor>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_AreEffectsPaused(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MasterGain(double*) noexcept = 0;
            virtual int32_t WINRT_CALL put_MasterGain(double) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportedAxes(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL LoadEffectAsync(void*, void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL TryDisableAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryEnableAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryResetAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryUnloadEffectAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Gaming::Input::ForceFeedback::IPeriodicForceEffect>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_Kind(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL SetParameters(Windows::Foundation::Numerics::float3, float, float, float, int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL SetParametersWithEnvelope(Windows::Foundation::Numerics::float3, float, float, float, float, float, float, int64_t, int64_t, int64_t, int64_t, uint32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Gaming::Input::ForceFeedback::IRampForceEffect>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL SetParameters(Windows::Foundation::Numerics::float3, Windows::Foundation::Numerics::float3, int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL SetParametersWithEnvelope(Windows::Foundation::Numerics::float3, Windows::Foundation::Numerics::float3, float, float, float, int64_t, int64_t, int64_t, int64_t, uint32_t) noexcept = 0;
        };
    };
    template <typename D>
