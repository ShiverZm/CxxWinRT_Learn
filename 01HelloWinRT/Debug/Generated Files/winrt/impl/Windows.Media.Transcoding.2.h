...
{
    struct WINRT_EBO MediaTranscoder : Windows::Media::Transcoding::IMediaTranscoder,
    ...
    struct WINRT_EBO PrepareTranscodeResult : Windows::Media::Transcoding::IPrepareTranscodeResult
    {
