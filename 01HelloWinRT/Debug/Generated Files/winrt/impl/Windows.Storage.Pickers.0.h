...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Storage::Pickers::IFileOpenPicker>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_ViewMode(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_SettingsIdentifier(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_SettingsIdentifier(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SuggestedStartLocation(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_SuggestedStartLocation(int32_t) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL PickSingleFileAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL PickMultipleFilesAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Storage::Pickers::IFileOpenPickerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL ResumePickSingleFileAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Storage::Pickers::IFileOpenPickerWithOperationId>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL PickSingleFileAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::Pickers::IFileSavePicker>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_CommitButtonText(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_CommitButtonText(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_FileTypeChoices(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DefaultFileExtension(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_DefaultFileExtension(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SuggestedSaveFile(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_SuggestedSaveFile(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SuggestedFileName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_SuggestedFileName(void*) noexcept = 0;
            virtual int32_t WINRT_CALL PickSaveFileAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Storage::Pickers::IFolderPicker>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_CommitButtonText(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_FileTypeFilter(void**) noexcept = 0;
            virtual int32_t WINRT_CALL PickSingleFolderAsync(void**) noexcept = 0;
        };
    };
