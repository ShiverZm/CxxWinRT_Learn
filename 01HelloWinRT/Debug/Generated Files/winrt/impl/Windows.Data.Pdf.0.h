...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Data::Pdf::IPdfDocument>
    {
        ...
        {
            virtual int32_t WINRT_CALL GetPage(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PageCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsPasswordProtected(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Data::Pdf::IPdfDocumentStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL LoadFromFileWithPasswordAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL LoadFromStreamAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL LoadFromStreamWithPasswordAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Data::Pdf::IPdfPage>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL RenderToStreamAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RenderWithOptionsToStreamAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL PreparePageAsync(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_Dimensions(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Rotation(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PreferredZoom(float*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Data::Pdf::IPdfPageDimensions>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_MediaBox(Windows::Foundation::Rect*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CropBox(Windows::Foundation::Rect*) noexcept = 0;
            virtual int32_t WINRT_CALL get_BleedBox(Windows::Foundation::Rect*) noexcept = 0;
            virtual int32_t WINRT_CALL get_TrimBox(Windows::Foundation::Rect*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ArtBox(Windows::Foundation::Rect*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Data::Pdf::IPdfPageRenderOptions>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SourceRect(Windows::Foundation::Rect*) noexcept = 0;
            virtual int32_t WINRT_CALL put_SourceRect(Windows::Foundation::Rect) noexcept = 0;
            virtual int32_t WINRT_CALL get_DestinationWidth(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_DestinationWidth(uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_DestinationHeight(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_DestinationHeight(uint32_t) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_IsIgnoringHighContrast(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsIgnoringHighContrast(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_BitmapEncoderId(winrt::guid*) noexcept = 0;
            virtual int32_t WINRT_CALL put_BitmapEncoderId(winrt::guid) noexcept = 0;
        };
    };
    template <typename D>
