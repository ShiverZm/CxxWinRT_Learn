...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::Editing::IBackgroundAudioTrack>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_TrimTimeFromStart(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_TrimTimeFromStart(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_TrimTimeFromEnd(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_TrimTimeFromEnd(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_OriginalDuration(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_TrimmedDuration(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_UserData(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_Delay(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_Delay(int64_t*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL GetAudioEncodingProperties(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_AudioEffectDefinitions(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Editing::IBackgroundAudioTrackStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateFromEmbeddedAudioTrack(void*, void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Media::Editing::IMediaClip>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_UserData(void**) noexcept = 0;
            virtual int32_t WINRT_CALL Clone(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_StartTimeInComposition(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_EndTimeInComposition(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_EmbeddedAudioTracks(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedEmbeddedAudioTrackIndex(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_SelectedEmbeddedAudioTrackIndex(uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL put_Volume(double) noexcept = 0;
            virtual int32_t WINRT_CALL get_Volume(double*) noexcept = 0;
            virtual int32_t WINRT_CALL GetVideoEncodingProperties(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_AudioEffectDefinitions(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_VideoEffectDefinitions(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Editing::IMediaClipStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateFromColor(struct struct_Windows_UI_Color, int64_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFromFileAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFromImageFileAsync(void*, int64_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Editing::IMediaClipStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateFromSurface(void*, int64_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Editing::IMediaComposition>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Clips(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_BackgroundAudioTracks(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_UserData(void**) noexcept = 0;
            virtual int32_t WINRT_CALL Clone(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SaveAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetThumbnailAsync(int64_t, int32_t, int32_t, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetThumbnailsAsync(void*, int32_t, int32_t, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RenderToFileAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RenderToFileWithTrimmingPreferenceAsync(void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RenderToFileWithProfileAsync(void*, int32_t, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateDefaultEncodingProfile(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GenerateMediaStreamSource(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GenerateMediaStreamSourceWithProfile(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GeneratePreviewMediaStreamSource(int32_t, int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Editing::IMediaComposition2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_OverlayLayers(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::Editing::IMediaOverlay>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Position(Windows::Foundation::Rect*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Position(Windows::Foundation::Rect) noexcept = 0;
            virtual int32_t WINRT_CALL put_Delay(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_Delay(int64_t*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_AudioEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AudioEnabled(bool) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Editing::IMediaOverlayFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL CreateWithPositionAndOpacity(void*, Windows::Foundation::Rect, double, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Editing::IMediaOverlayLayer>
    {
        ...
        {
            virtual int32_t WINRT_CALL Clone(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Overlays(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_CustomCompositorDefinition(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Editing::IMediaOverlayLayerFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateWithCompositorDefinition(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
