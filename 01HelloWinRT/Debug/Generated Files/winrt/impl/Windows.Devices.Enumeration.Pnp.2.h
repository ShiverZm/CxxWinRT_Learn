...
{
    struct WINRT_EBO PnpObject : Windows::Devices::Enumeration::Pnp::IPnpObject
    {
    ...
    struct WINRT_EBO PnpObjectCollection : Windows::Foundation::Collections::IVectorView<Windows::Devices::Enumeration::Pnp::PnpObject>
    {
    ...
    struct WINRT_EBO PnpObjectUpdate : Windows::Devices::Enumeration::Pnp::IPnpObjectUpdate
    {
    ...
    struct WINRT_EBO PnpObjectWatcher : Windows::Devices::Enumeration::Pnp::IPnpObjectWatcher
    {
