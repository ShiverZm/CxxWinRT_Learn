...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::Import::IPhotoImportDeleteImportedItemsFromSourceResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_HasSucceeded(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DeletedItems(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PhotosCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PhotosSizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_VideosCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_VideosSizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SidecarsCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SidecarsSizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SiblingsCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SiblingsSizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_TotalCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_TotalSizeInBytes(uint64_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Import::IPhotoImportFindItemsResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Session(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_HasSucceeded(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_FoundItems(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PhotosCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PhotosSizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_VideosCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_VideosSizeInBytes(uint64_t*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL SelectNewAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetImportMode(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_ImportMode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedPhotosCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedPhotosSizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedVideosCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedVideosSizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedSidecarsCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedSidecarsSizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedSiblingsCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedSiblingsSizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedTotalCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SelectedTotalSizeInBytes(uint64_t*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL ImportItemsAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_ItemImported(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ItemImported(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Import::IPhotoImportFindItemsResult2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL AddItemsInDateRangeToSelection(int64_t, int64_t) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Import::IPhotoImportImportItemsResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Session(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_HasSucceeded(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ImportedItems(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PhotosCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PhotosSizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_VideosCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_VideosSizeInBytes(uint64_t*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_TotalCount(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_TotalSizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL DeleteImportedItemsFromSourceAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Import::IPhotoImportItem>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_ItemKey(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ContentType(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SizeInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Date(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Sibling(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Sidecars(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_VideoSegments(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_ImportedFileNames(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DeletedFileNames(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::Import::IPhotoImportItemImportedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ImportedItem(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Import::IPhotoImportManagerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL FindAllSourcesAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetPendingOperations(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Import::IPhotoImportOperation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Stage(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Session(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ContinueFindingItemsAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ContinueImportingItemsAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ContinueDeletingImportedItemsFromSourceAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Import::IPhotoImportSelectionChangedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsSelectionEmpty(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Import::IPhotoImportSession>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_DestinationFolder(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DestinationFolder(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_AppendSessionDateToDestinationFolder(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_AppendSessionDateToDestinationFolder(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_SubfolderCreationMode(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_SubfolderCreationMode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_DestinationFileNamePrefix(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DestinationFileNamePrefix(void**) noexcept = 0;
            virtual int32_t WINRT_CALL FindItemsAsync(int32_t, int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Import::IPhotoImportSession2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL put_SubfolderDateFormat(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_SubfolderDateFormat(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_RememberDeselectedItems(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_RememberDeselectedItems(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::Import::IPhotoImportSource>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_ConnectionProtocol(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ConnectionTransport(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Type(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PowerSource(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_BatteryLevelPercent(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DateTime(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_StorageMedia(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsLocked(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsMassStorage(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Thumbnail(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateImportSession(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Import::IPhotoImportSourceStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL FromFolderAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Import::IPhotoImportStorageMedium>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Description(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SerialNumber(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_StorageMediumType(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportedAccessMode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CapacityInBytes(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AvailableSpaceInBytes(uint64_t*) noexcept = 0;
