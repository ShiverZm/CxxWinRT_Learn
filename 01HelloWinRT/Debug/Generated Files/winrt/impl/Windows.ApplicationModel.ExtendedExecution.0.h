...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::ExtendedExecution::IExtendedExecutionSession>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_Reason(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Reason(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_Description(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_Description(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PercentProgress(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_PercentProgress(uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL add_Revoked(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_Revoked(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL RequestExtensionAsync(void**) noexcept = 0;
        };
    };
    template <typename D>
