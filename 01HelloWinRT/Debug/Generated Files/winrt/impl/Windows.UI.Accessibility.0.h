...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Accessibility::IScreenReaderPositionChangedEventArgs>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_ScreenPositionInRawPixels(Windows::Foundation::Rect*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsReadingText(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Accessibility::IScreenReaderService>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CurrentScreenReaderPosition(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_ScreenReaderPositionChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ScreenReaderPositionChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <typename D>
