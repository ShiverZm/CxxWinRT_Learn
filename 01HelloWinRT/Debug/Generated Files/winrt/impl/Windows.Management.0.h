...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Management::IMdmAlert>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Mark(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Mark(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_Source(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_Source(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Status(uint32_t*) noexcept = 0;
    ...
    template <> struct abi<Windows::Management::IMdmSession>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Alerts(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL StartWithAlertsAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Management::IMdmSessionManagerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SessionIds(void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryCreateSession(void**) noexcept = 0;
            virtual int32_t WINRT_CALL DeleteSessionById(void*) noexcept = 0;
            virtual int32_t WINRT_CALL GetSessionById(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_Management_IMdmSession
    {
        ...
        Windows::Foundation::IAsyncAction StartAsync(param::iterable<Windows::Management::MdmAlert> const& alerts) const;
    };
