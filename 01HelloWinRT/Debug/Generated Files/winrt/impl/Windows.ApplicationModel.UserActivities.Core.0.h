...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::UserActivities::Core::ICoreUserActivityManagerStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL CreateUserActivitySessionInBackground(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DeleteUserActivitySessionsInTimeRangeAsync(void*, int64_t, int64_t, void**) noexcept = 0;
        };
    };
    template <typename D>
