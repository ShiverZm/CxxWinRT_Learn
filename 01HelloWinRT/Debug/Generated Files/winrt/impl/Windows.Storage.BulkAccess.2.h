...
{
    struct WINRT_EBO FileInformation : Windows::Storage::BulkAccess::IStorageItemInformation,
    ...
    struct WINRT_EBO FileInformationFactory : Windows::Storage::BulkAccess::IFileInformationFactory
    {
    ...
    struct WINRT_EBO FolderInformation : Windows::Storage::BulkAccess::IStorageItemInformation,
