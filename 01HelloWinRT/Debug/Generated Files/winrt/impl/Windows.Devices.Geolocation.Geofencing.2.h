...
{
    struct WINRT_EBO Geofence : Windows::Devices::Geolocation::Geofencing::IGeofence
    {
    ...
    struct WINRT_EBO GeofenceMonitor : Windows::Devices::Geolocation::Geofencing::IGeofenceMonitor
    {
    ...
    struct WINRT_EBO GeofenceStateChangeReport : Windows::Devices::Geolocation::Geofencing::IGeofenceStateChangeReport
    {
