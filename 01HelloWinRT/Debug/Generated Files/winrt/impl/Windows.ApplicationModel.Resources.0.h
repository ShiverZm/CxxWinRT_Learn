...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Resources::IResourceLoader>
    {
        ...
        {
            virtual int32_t WINRT_CALL GetString(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Resources::IResourceLoader2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetStringForUri(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Resources::IResourceLoaderFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateResourceLoaderByName(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Resources::IResourceLoaderStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetStringForReference(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Resources::IResourceLoaderStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetForCurrentViewWithName(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetForViewIndependentUse(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetForViewIndependentUseWithName(void*, void**) noexcept = 0;
        };
    };
