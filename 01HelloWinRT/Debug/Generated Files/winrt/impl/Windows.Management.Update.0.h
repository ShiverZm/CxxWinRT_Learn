...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Management::Update::IPreviewBuildsManager>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_ArePreviewBuildsAllowed(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ArePreviewBuildsAllowed(bool) noexcept = 0;
            virtual int32_t WINRT_CALL GetCurrentState(void**) noexcept = 0;
