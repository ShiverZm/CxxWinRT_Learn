...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::DialProtocol::IDialApp>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL RequestLaunchAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL StopAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetAppStateAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::DialProtocol::IDialAppStateDetails>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_FullXml(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::DialProtocol::IDialDevice>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetDialApp(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::DialProtocol::IDialDevicePicker>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL add_DialDeviceSelected(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_DialDeviceSelected(winrt::event_token) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL add_DialDevicePickerDismissed(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_DialDevicePickerDismissed(winrt::event_token) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL PickSingleDialDeviceAsync(Windows::Foundation::Rect, void**) noexcept = 0;
            virtual int32_t WINRT_CALL PickSingleDialDeviceAsyncWithPlacement(Windows::Foundation::Rect, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL Hide() noexcept = 0;
            virtual int32_t WINRT_CALL SetDisplayStatus(void*, int32_t) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::DialProtocol::IDialDevicePickerFilter>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SupportedAppNames(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::DialProtocol::IDialDeviceSelectedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SelectedDialDevice(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::DialProtocol::IDialDeviceStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetDeviceSelector(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL FromIdAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DeviceInfoSupportsDialAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::DialProtocol::IDialReceiverApp>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetAdditionalDataAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetAdditionalDataAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::DialProtocol::IDialReceiverApp2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetUniqueDeviceNameAsync(void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Media_DialProtocol_IDialReceiverApp
    {
        ...
        Windows::Foundation::IAsyncAction SetAdditionalDataAsync(param::iterable<Windows::Foundation::Collections::IKeyValuePair<hstring, hstring>> const& additionalData) const;
    };
