...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Storage::Search::IContentIndexer>
    {
        ...
        {
            virtual int32_t WINRT_CALL AddAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL UpdateAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DeleteAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DeleteMultipleAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DeleteAllAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL RetrievePropertiesAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Revision(uint64_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::Search::IContentIndexerQuery>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetCountAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetPropertiesAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetPropertiesRangeAsync(uint32_t, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetRangeAsync(uint32_t, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_QueryFolder(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::Search::IContentIndexerQueryOperations>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateQueryWithSortOrderAndLanguage(void*, void*, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateQueryWithSortOrder(void*, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateQuery(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::Search::IContentIndexerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetIndexerWithName(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetIndexer(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::Search::IIndexableContent>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL put_Stream(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_StreamContentType(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_StreamContentType(void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::Search::IQueryOptions>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_FileTypeFilter(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_FolderDepth(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_FolderDepth(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_ApplicationSearchFilter(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_ApplicationSearchFilter(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_UserSearchFilter(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_UserSearchFilter(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Language(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_Language(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IndexerOption(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IndexerOption(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_SortOrder(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_GroupPropertyName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DateStackOption(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL SaveToString(void**) noexcept = 0;
            virtual int32_t WINRT_CALL LoadFromString(void*) noexcept = 0;
            virtual int32_t WINRT_CALL SetThumbnailPrefetch(int32_t, uint32_t, uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL SetPropertyPrefetch(uint32_t, void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::Search::IQueryOptionsFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateCommonFileQuery(int32_t, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateCommonFolderQuery(int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::Search::IQueryOptionsWithProviderFilter>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_StorageProviderIdFilter(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Storage::Search::IStorageFileQueryResult2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetMatchingPropertiesWithRanges(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::Search::IStorageFolderQueryOperations>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetIndexedStateAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFileQueryOverloadDefault(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFileQuery(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFileQueryWithOptions(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFolderQueryOverloadDefault(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFolderQuery(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateFolderQueryWithOptions(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateItemQuery(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateItemQueryWithOptions(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetFilesAsync(int32_t, uint32_t, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetFilesAsyncOverloadDefaultStartAndCount(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetFoldersAsync(int32_t, uint32_t, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetFoldersAsyncOverloadDefaultStartAndCount(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetItemsAsync(uint32_t, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL AreQueryOptionsSupported(void*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL IsCommonFolderQuerySupported(int32_t, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL IsCommonFileQuerySupported(int32_t, bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Storage::Search::IStorageLibraryContentChangedTriggerDetails>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_Folder(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateModifiedSinceQuery(int64_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::Search::IStorageQueryResultBase>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetItemCountAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Folder(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_ContentsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ContentsChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_OptionsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_OptionsChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL FindStartIndexAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetCurrentQueryOptions(void**) noexcept = 0;
            virtual int32_t WINRT_CALL ApplyNewQueryOptions(void*) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Storage_Search_IContentIndexer
    {
        ...
        Windows::Foundation::IAsyncAction DeleteMultipleAsync(param::iterable<hstring> const& contentIds) const;
