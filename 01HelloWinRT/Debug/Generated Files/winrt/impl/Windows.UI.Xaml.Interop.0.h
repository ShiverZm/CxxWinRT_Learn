...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Xaml::Interop::IBindableVector>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetAt(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Size(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL GetView(void**) noexcept = 0;
            virtual int32_t WINRT_CALL IndexOf(void*, uint32_t*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL SetAt(uint32_t, void*) noexcept = 0;
            virtual int32_t WINRT_CALL InsertAt(uint32_t, void*) noexcept = 0;
    ...
    template <> struct abi<Windows::UI::Xaml::Interop::INotifyCollectionChanged>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL add_CollectionChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_CollectionChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Xaml::Interop::INotifyCollectionChangedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_NewItems(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_OldItems(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_NewStartingIndex(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_OldStartingIndex(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Xaml::Interop::INotifyCollectionChangedEventArgsFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateInstanceWithAllParameters(int32_t, void*, void*, int32_t, int32_t, void*, void**, void**) noexcept = 0;
        };
    };
    ...
    {
        winrt::event_token VectorChanged(Windows::UI::Xaml::Interop::BindableVectorChangedEventHandler const& handler) const;
    ...
    {
        winrt::event_token CollectionChanged(Windows::UI::Xaml::Interop::NotifyCollectionChangedEventHandler const& handler) const;
        ...
        void CollectionChanged(winrt::event_token const& token) const noexcept;
    };
