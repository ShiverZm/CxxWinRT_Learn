...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::Capture::Core::IVariablePhotoCapturedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_UsedFrameControllerIndex(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_CapturedFrameControlValues(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::Capture::Core::IVariablePhotoSequenceCapture2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL UpdateSettingsAsync(void**) noexcept = 0;
        };
    };
    template <typename D>
