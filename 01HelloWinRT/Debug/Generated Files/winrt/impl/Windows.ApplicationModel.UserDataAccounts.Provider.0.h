...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::UserDataAccounts::Provider::IUserDataAccountPartnerAccountInfo>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Priority(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AccountKind(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::UserDataAccounts::Provider::IUserDataAccountProviderAddAccountOperation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ContentKinds(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PartnerAccountInfos(void**) noexcept = 0;
