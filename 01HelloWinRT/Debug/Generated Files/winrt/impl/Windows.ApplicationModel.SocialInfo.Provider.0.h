...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::SocialInfo::Provider::ISocialDashboardItemUpdater>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_OwnerRemoteId(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::SocialInfo::Provider::ISocialInfoProviderManagerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateSocialFeedUpdaterAsync(int32_t, int32_t, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateDashboardItemUpdaterAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL UpdateBadgeCountValue(void*, int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL ReportNewContentAvailable(void*, int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL ProvisionAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL DeprovisionAsync(void**) noexcept = 0;
        };
    };
    template <typename D>
