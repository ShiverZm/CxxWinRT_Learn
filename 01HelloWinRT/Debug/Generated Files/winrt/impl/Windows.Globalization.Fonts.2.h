...
{
    struct WINRT_EBO LanguageFont : Windows::Globalization::Fonts::ILanguageFont
    {
    ...
    struct WINRT_EBO LanguageFontGroup : Windows::Globalization::Fonts::ILanguageFontGroup
    {
