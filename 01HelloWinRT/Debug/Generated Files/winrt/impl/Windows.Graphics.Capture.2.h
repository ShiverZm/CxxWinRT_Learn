...
{
    struct WINRT_EBO Direct3D11CaptureFrame : Windows::Graphics::Capture::IDirect3D11CaptureFrame,
    ...
    struct WINRT_EBO Direct3D11CaptureFramePool : Windows::Graphics::Capture::IDirect3D11CaptureFramePool,
    ...
    struct WINRT_EBO GraphicsCaptureItem : Windows::Graphics::Capture::IGraphicsCaptureItem
    {
    ...
    struct WINRT_EBO GraphicsCapturePicker : Windows::Graphics::Capture::IGraphicsCapturePicker
    {
    ...
    struct WINRT_EBO GraphicsCaptureSession : Windows::Graphics::Capture::IGraphicsCaptureSession,
