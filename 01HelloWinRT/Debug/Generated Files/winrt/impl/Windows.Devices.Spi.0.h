...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::Spi::ISpiBusInfo>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_ChipSelectLineCount(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MinClockFrequency(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxClockFrequency(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportedDataBitLengths(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Spi::ISpiConnectionSettings>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ChipSelectLine(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ChipSelectLine(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_Mode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Mode(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_DataBitLength(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_DataBitLength(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_ClockFrequency(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ClockFrequency(int32_t) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Spi::ISpiController>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetDevice(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::Spi::ISpiDevice>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_ConnectionSettings(void**) noexcept = 0;
            virtual int32_t WINRT_CALL Write(uint32_t, uint8_t*) noexcept = 0;
            virtual int32_t WINRT_CALL Read(uint32_t, uint8_t*) noexcept = 0;
            virtual int32_t WINRT_CALL TransferSequential(uint32_t, uint8_t*, uint32_t, uint8_t*) noexcept = 0;
            virtual int32_t WINRT_CALL TransferFullDuplex(uint32_t, uint8_t*, uint32_t, uint8_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Spi::ISpiDeviceStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetDeviceSelectorFromFriendlyName(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetBusInfo(void*, void**) noexcept = 0;
