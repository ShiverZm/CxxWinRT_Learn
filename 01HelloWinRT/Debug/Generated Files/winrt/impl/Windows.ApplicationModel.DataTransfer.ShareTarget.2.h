...
{
    struct WINRT_EBO QuickLink : Windows::ApplicationModel::DataTransfer::ShareTarget::IQuickLink
    {
    ...
    struct WINRT_EBO ShareOperation : Windows::ApplicationModel::DataTransfer::ShareTarget::IShareOperation,
