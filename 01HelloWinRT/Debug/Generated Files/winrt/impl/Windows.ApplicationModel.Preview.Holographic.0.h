...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Preview::Holographic::IHolographicApplicationPreviewStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL IsCurrentViewPresentedOnHolographicDisplay(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL IsHolographicActivation(void*, bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Preview::Holographic::IHolographicKeyboardPlacementOverridePreview>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL SetPlacementOverride(void*, Windows::Foundation::Numerics::float3, Windows::Foundation::Numerics::float3) noexcept = 0;
            virtual int32_t WINRT_CALL SetPlacementOverrideWithMaxSize(void*, Windows::Foundation::Numerics::float3, Windows::Foundation::Numerics::float3, Windows::Foundation::Numerics::float2) noexcept = 0;
