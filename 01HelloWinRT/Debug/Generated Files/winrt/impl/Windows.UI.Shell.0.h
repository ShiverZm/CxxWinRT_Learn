...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Shell::IAdaptiveCardBuilderStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateAdaptiveCardFromJson(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Shell::ISecurityAppManager>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL Register(int32_t, void*, void*, bool, winrt::guid*) noexcept = 0;
            virtual int32_t WINRT_CALL Unregister(int32_t, winrt::guid) noexcept = 0;
            virtual int32_t WINRT_CALL UpdateState(int32_t, winrt::guid, int32_t, int32_t, void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Shell::ITaskbarManager>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_IsPinningAllowed(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL IsCurrentAppPinnedAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL IsAppListEntryPinnedAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestPinCurrentAppAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestPinAppListEntryAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Shell::ITaskbarManager2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL IsSecondaryTilePinnedAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestPinSecondaryTileAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryUnpinSecondaryTileAsync(void*, void**) noexcept = 0;
        };
    };
