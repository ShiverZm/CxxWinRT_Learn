...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Security::Cryptography::DataProtection::IDataProtectionProvider>
    {
        ...
        {
            virtual int32_t WINRT_CALL ProtectAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL UnprotectAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ProtectStreamAsync(void*, void*, void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Security::Cryptography::DataProtection::IDataProtectionProviderFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateOverloadExplicit(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
