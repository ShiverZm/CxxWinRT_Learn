...
{
    struct WINRT_EBO AppointmentCalendarCancelMeetingRequest : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarCancelMeetingRequest
    {
    ...
    struct WINRT_EBO AppointmentCalendarCancelMeetingRequestEventArgs : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarCancelMeetingRequestEventArgs
    {
    ...
    struct WINRT_EBO AppointmentCalendarCreateOrUpdateAppointmentRequest : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarCreateOrUpdateAppointmentRequest
    {
    ...
    struct WINRT_EBO AppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarCreateOrUpdateAppointmentRequestEventArgs
    {
    ...
    struct WINRT_EBO AppointmentCalendarForwardMeetingRequest : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarForwardMeetingRequest
    {
    ...
    struct WINRT_EBO AppointmentCalendarForwardMeetingRequestEventArgs : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarForwardMeetingRequestEventArgs
    {
    ...
    struct WINRT_EBO AppointmentCalendarProposeNewTimeForMeetingRequest : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarProposeNewTimeForMeetingRequest
    {
    ...
    struct WINRT_EBO AppointmentCalendarProposeNewTimeForMeetingRequestEventArgs : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarProposeNewTimeForMeetingRequestEventArgs
    {
    ...
    struct WINRT_EBO AppointmentCalendarSyncManagerSyncRequest : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarSyncManagerSyncRequest
    {
    ...
    struct WINRT_EBO AppointmentCalendarSyncManagerSyncRequestEventArgs : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarSyncManagerSyncRequestEventArgs
    {
    ...
    struct WINRT_EBO AppointmentCalendarUpdateMeetingResponseRequest : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarUpdateMeetingResponseRequest
    {
    ...
    struct WINRT_EBO AppointmentCalendarUpdateMeetingResponseRequestEventArgs : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentCalendarUpdateMeetingResponseRequestEventArgs
    {
    ...
    struct WINRT_EBO AppointmentDataProviderConnection : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentDataProviderConnection
    {
    ...
    struct WINRT_EBO AppointmentDataProviderTriggerDetails : Windows::ApplicationModel::Appointments::DataProvider::IAppointmentDataProviderTriggerDetails
    {
