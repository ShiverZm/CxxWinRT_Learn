...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Graphics::Capture::IDirect3D11CaptureFrame>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_SystemRelativeTime(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ContentSize(struct struct_Windows_Graphics_SizeInt32*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Capture::IDirect3D11CaptureFramePool>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL Recreate(void*, int32_t, int32_t, struct struct_Windows_Graphics_SizeInt32) noexcept = 0;
            virtual int32_t WINRT_CALL TryGetNextFrame(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL CreateCaptureSession(void*, void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Graphics::Capture::IDirect3D11CaptureFramePoolStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL Create(void*, int32_t, int32_t, struct struct_Windows_Graphics_SizeInt32, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Capture::IDirect3D11CaptureFramePoolStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateFreeThreaded(void*, int32_t, int32_t, struct struct_Windows_Graphics_SizeInt32, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Graphics::Capture::IGraphicsCaptureItemStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateFromVisual(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Capture::IGraphicsCapturePicker>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL PickSingleItemAsync(void**) noexcept = 0;
        };
    };
