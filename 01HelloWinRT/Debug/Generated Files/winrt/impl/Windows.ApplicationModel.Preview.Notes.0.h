...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsScreenLocked(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL ShowNote(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL ShowNoteRelativeTo(int32_t, int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL ShowNoteWithPlacement(int32_t, void*) noexcept = 0;
            virtual int32_t WINRT_CALL HideNote(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL GetNotePlacement(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL TrySetNoteSize(int32_t, Windows::Foundation::Size, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL SetFocusToNextView() noexcept = 0;
            virtual int32_t WINRT_CALL SetNotesThumbnailAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_SystemLockStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_SystemLockStateChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_NotePlacementChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_NotePlacementChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_NoteVisibilityChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_NoteVisibilityChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreview2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL ShowNoteRelativeToWithOptions(int32_t, int32_t, void*) noexcept = 0;
            virtual int32_t WINRT_CALL ShowNoteWithPlacementWithOptions(int32_t, void*, void*) noexcept = 0;
            virtual int32_t WINRT_CALL SetFocusToPreviousView() noexcept = 0;
            virtual int32_t WINRT_CALL SetThumbnailImageForTaskSwitcherAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewShowNoteOptions>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ShowWithFocus(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ShowWithFocus(bool) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Preview::Notes::INotesWindowManagerPreviewStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetForCurrentApp(void**) noexcept = 0;
        };
    };
    template <typename D>
