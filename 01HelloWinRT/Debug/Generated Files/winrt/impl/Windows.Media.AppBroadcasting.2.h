...
{
    struct WINRT_EBO AppBroadcastingMonitor : Windows::Media::AppBroadcasting::IAppBroadcastingMonitor
    {
    ...
    struct WINRT_EBO AppBroadcastingStatus : Windows::Media::AppBroadcasting::IAppBroadcastingStatus
    {
    ...
    struct WINRT_EBO AppBroadcastingStatusDetails : Windows::Media::AppBroadcasting::IAppBroadcastingStatusDetails
    {
    ...
    struct WINRT_EBO AppBroadcastingUI : Windows::Media::AppBroadcasting::IAppBroadcastingUI
    {
