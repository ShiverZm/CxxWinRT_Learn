...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::System::Power::IBackgroundEnergyManagerStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_LowUsageLevel(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_NearMaxAcceptableUsageLevel(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxAcceptableUsageLevel(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ExcessiveUsageLevel(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_NearTerminationUsageLevel(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_TerminationUsageLevel(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_RecentEnergyUsage(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_RecentEnergyUsageLevel(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL add_RecentEnergyUsageIncreased(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_RecentEnergyUsageIncreased(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_RecentEnergyUsageReturnedToLow(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_RecentEnergyUsageReturnedToLow(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::System::Power::IPowerManagerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_EnergySaverStatus(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL add_EnergySaverStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_EnergySaverStatusChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_BatteryStatus(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL add_BatteryStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_BatteryStatusChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_PowerSupplyStatus(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL add_PowerSupplyStatusChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_PowerSupplyStatusChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_RemainingChargePercent(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL add_RemainingChargePercentChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_RemainingChargePercentChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_RemainingDischargeTime(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL add_RemainingDischargeTimeChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_RemainingDischargeTimeChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <typename D>
