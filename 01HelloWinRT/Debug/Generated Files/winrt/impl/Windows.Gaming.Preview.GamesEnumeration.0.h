...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Gaming::Preview::GamesEnumeration::IGameListEntry>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL SetCategoryAsync(int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Gaming::Preview::GamesEnumeration::IGameListEntry2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_LaunchableState(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_LauncherExecutable(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_LaunchParameters(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetLauncherExecutableFileAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetLauncherExecutableFileWithParamsAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_TitleId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetTitleIdAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_GameModeConfiguration(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Gaming::Preview::GamesEnumeration::IGameListStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL FindAllAsyncPackageFamilyName(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_GameAdded(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_GameAdded(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_GameRemoved(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_GameRemoved(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_GameUpdated(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_GameUpdated(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Gaming::Preview::GamesEnumeration::IGameListStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL MergeEntriesAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL UnmergeEntryAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Gaming::Preview::GamesEnumeration::IGameModeConfiguration>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_RelatedProcessNames(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_PercentGpuTimeAllocatedToGame(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_PercentGpuTimeAllocatedToGame(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PercentGpuMemoryAllocatedToGame(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_PercentGpuMemoryAllocatedToGame(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PercentGpuMemoryAllocatedToSystemCompositor(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_PercentGpuMemoryAllocatedToSystemCompositor(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxCpuCount(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_MaxCpuCount(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CpuExclusivityMaskLow(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_CpuExclusivityMaskLow(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CpuExclusivityMaskHigh(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_CpuExclusivityMaskHigh(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AffinitizeToExclusiveCpus(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AffinitizeToExclusiveCpus(bool) noexcept = 0;
    ...
    template <> struct abi<Windows::Gaming::Preview::GamesEnumeration::IGameModeUserConfiguration>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_GamingRelatedProcessNames(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SaveAsync(void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Gaming_Preview_GamesEnumeration_IGameModeConfiguration
    {
        ...
        void PercentGpuTimeAllocatedToGame(Windows::Foundation::IReference<int32_t> const& value) const;
        Windows::Foundation::IReference<int32_t> PercentGpuMemoryAllocatedToGame() const;
        void PercentGpuMemoryAllocatedToGame(Windows::Foundation::IReference<int32_t> const& value) const;
        Windows::Foundation::IReference<int32_t> PercentGpuMemoryAllocatedToSystemCompositor() const;
        void PercentGpuMemoryAllocatedToSystemCompositor(Windows::Foundation::IReference<int32_t> const& value) const;
        Windows::Foundation::IReference<int32_t> MaxCpuCount() const;
        void MaxCpuCount(Windows::Foundation::IReference<int32_t> const& value) const;
        Windows::Foundation::IReference<int32_t> CpuExclusivityMaskLow() const;
        void CpuExclusivityMaskLow(Windows::Foundation::IReference<int32_t> const& value) const;
        Windows::Foundation::IReference<int32_t> CpuExclusivityMaskHigh() const;
        void CpuExclusivityMaskHigh(Windows::Foundation::IReference<int32_t> const& value) const;
