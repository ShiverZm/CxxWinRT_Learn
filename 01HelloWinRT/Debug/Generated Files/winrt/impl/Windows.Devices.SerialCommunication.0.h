...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::SerialCommunication::IPinChangedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_PinChange(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::SerialCommunication::ISerialDevice>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_BaudRate(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_BaudRate(uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_BreakSignalState(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_BreakSignalState(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_BytesReceived(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CarrierDetectState(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ClearToSendState(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DataBits(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_DataBits(uint16_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_DataSetReadyState(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Handshake(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Handshake(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsDataTerminalReadyEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsDataTerminalReadyEnabled(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsRequestToSendEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsRequestToSendEnabled(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_Parity(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Parity(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_PortName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ReadTimeout(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ReadTimeout(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_StopBits(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_StopBits(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_UsbVendorId(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_UsbProductId(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_WriteTimeout(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_WriteTimeout(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_InputStream(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_OutputStream(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_ErrorReceived(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ErrorReceived(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_PinChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_PinChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::SerialCommunication::ISerialDeviceStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetDeviceSelectorFromPortName(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetDeviceSelectorFromUsbVidPid(uint16_t, uint16_t, void**) noexcept = 0;
