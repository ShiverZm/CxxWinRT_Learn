...
namespace winrt::Windows::Media::Capture
{
    ...
    struct WINRT_EBO AdvancedCapturedPhoto : Windows::Media::Capture::IAdvancedCapturedPhoto,
    ...
    struct WINRT_EBO AdvancedPhotoCapture : Windows::Media::Capture::IAdvancedPhotoCapture
    {
    ...
    struct WINRT_EBO AppBroadcastBackgroundService : Windows::Media::Capture::IAppBroadcastBackgroundService,
    ...
    struct WINRT_EBO AppBroadcastBackgroundServiceSignInInfo : Windows::Media::Capture::IAppBroadcastBackgroundServiceSignInInfo,
    ...
    struct WINRT_EBO AppBroadcastBackgroundServiceStreamInfo : Windows::Media::Capture::IAppBroadcastBackgroundServiceStreamInfo,
    ...
    struct WINRT_EBO AppBroadcastCameraCaptureStateChangedEventArgs : Windows::Media::Capture::IAppBroadcastCameraCaptureStateChangedEventArgs
    {
    ...
    struct WINRT_EBO AppBroadcastGlobalSettings : Windows::Media::Capture::IAppBroadcastGlobalSettings
    {
    ...
    struct WINRT_EBO AppBroadcastHeartbeatRequestedEventArgs : Windows::Media::Capture::IAppBroadcastHeartbeatRequestedEventArgs
    {
    ...
    struct WINRT_EBO AppBroadcastMicrophoneCaptureStateChangedEventArgs : Windows::Media::Capture::IAppBroadcastMicrophoneCaptureStateChangedEventArgs
    {
    ...
    struct WINRT_EBO AppBroadcastPlugIn : Windows::Media::Capture::IAppBroadcastPlugIn
    {
    ...
    struct WINRT_EBO AppBroadcastPlugInManager : Windows::Media::Capture::IAppBroadcastPlugInManager
    {
    ...
    struct WINRT_EBO AppBroadcastPlugInStateChangedEventArgs : Windows::Media::Capture::IAppBroadcastPlugInStateChangedEventArgs
    {
    ...
    struct WINRT_EBO AppBroadcastPreview : Windows::Media::Capture::IAppBroadcastPreview
    {
    ...
    struct WINRT_EBO AppBroadcastPreviewStateChangedEventArgs : Windows::Media::Capture::IAppBroadcastPreviewStateChangedEventArgs
    {
    ...
    struct WINRT_EBO AppBroadcastPreviewStreamReader : Windows::Media::Capture::IAppBroadcastPreviewStreamReader
    {
    ...
    struct WINRT_EBO AppBroadcastPreviewStreamVideoFrame : Windows::Media::Capture::IAppBroadcastPreviewStreamVideoFrame
    {
    ...
    struct WINRT_EBO AppBroadcastPreviewStreamVideoHeader : Windows::Media::Capture::IAppBroadcastPreviewStreamVideoHeader
    {
    ...
    struct WINRT_EBO AppBroadcastProviderSettings : Windows::Media::Capture::IAppBroadcastProviderSettings
    {
    ...
    struct WINRT_EBO AppBroadcastServices : Windows::Media::Capture::IAppBroadcastServices
    {
    ...
    struct WINRT_EBO AppBroadcastSignInStateChangedEventArgs : Windows::Media::Capture::IAppBroadcastSignInStateChangedEventArgs
    {
    ...
    struct WINRT_EBO AppBroadcastState : Windows::Media::Capture::IAppBroadcastState
    {
    ...
    struct WINRT_EBO AppBroadcastStreamAudioFrame : Windows::Media::Capture::IAppBroadcastStreamAudioFrame
    {
    ...
    struct WINRT_EBO AppBroadcastStreamAudioHeader : Windows::Media::Capture::IAppBroadcastStreamAudioHeader
    {
    ...
    struct WINRT_EBO AppBroadcastStreamReader : Windows::Media::Capture::IAppBroadcastStreamReader
    {
    ...
    struct WINRT_EBO AppBroadcastStreamStateChangedEventArgs : Windows::Media::Capture::IAppBroadcastStreamStateChangedEventArgs
    {
    ...
    struct WINRT_EBO AppBroadcastStreamVideoFrame : Windows::Media::Capture::IAppBroadcastStreamVideoFrame
    {
    ...
    struct WINRT_EBO AppBroadcastStreamVideoHeader : Windows::Media::Capture::IAppBroadcastStreamVideoHeader
    {
    ...
    struct WINRT_EBO AppBroadcastTriggerDetails : Windows::Media::Capture::IAppBroadcastTriggerDetails
    {
    ...
    struct WINRT_EBO AppBroadcastViewerCountChangedEventArgs : Windows::Media::Capture::IAppBroadcastViewerCountChangedEventArgs
    {
    ...
    struct WINRT_EBO AppCapture : Windows::Media::Capture::IAppCapture
    {
    ...
    struct WINRT_EBO AppCaptureAlternateShortcutKeys : Windows::Media::Capture::IAppCaptureAlternateShortcutKeys,
    ...
    struct WINRT_EBO AppCaptureDurationGeneratedEventArgs : Windows::Media::Capture::IAppCaptureDurationGeneratedEventArgs
    {
    ...
    struct WINRT_EBO AppCaptureFileGeneratedEventArgs : Windows::Media::Capture::IAppCaptureFileGeneratedEventArgs
    {
    ...
    struct WINRT_EBO AppCaptureMetadataWriter : Windows::Media::Capture::IAppCaptureMetadataWriter,
    ...
    struct WINRT_EBO AppCaptureMicrophoneCaptureStateChangedEventArgs : Windows::Media::Capture::IAppCaptureMicrophoneCaptureStateChangedEventArgs
    {
    ...
    struct WINRT_EBO AppCaptureRecordOperation : Windows::Media::Capture::IAppCaptureRecordOperation
    {
    ...
    struct WINRT_EBO AppCaptureRecordingStateChangedEventArgs : Windows::Media::Capture::IAppCaptureRecordingStateChangedEventArgs
    {
    ...
    struct WINRT_EBO AppCaptureServices : Windows::Media::Capture::IAppCaptureServices
    {
    ...
    struct WINRT_EBO AppCaptureSettings : Windows::Media::Capture::IAppCaptureSettings,
    ...
    struct WINRT_EBO AppCaptureState : Windows::Media::Capture::IAppCaptureState
    {
    ...
    struct WINRT_EBO CameraCaptureUI : Windows::Media::Capture::ICameraCaptureUI
    {
    ...
    struct WINRT_EBO CameraCaptureUIPhotoCaptureSettings : Windows::Media::Capture::ICameraCaptureUIPhotoCaptureSettings
    {
    ...
    struct WINRT_EBO CameraCaptureUIVideoCaptureSettings : Windows::Media::Capture::ICameraCaptureUIVideoCaptureSettings
    {
    ...
    struct WINRT_EBO CapturedFrame : Windows::Media::Capture::ICapturedFrame,
        impl::require<CapturedFrame, Windows::Media::Capture::ICapturedFrame2, Windows::Media::Capture::ICapturedFrameWithSoftwareBitmap>
    {
    ...
    struct WINRT_EBO CapturedFrameControlValues : Windows::Media::Capture::ICapturedFrameControlValues,
    ...
    struct WINRT_EBO CapturedPhoto : Windows::Media::Capture::ICapturedPhoto
    {
    ...
    struct WINRT_EBO GameBarServices : Windows::Media::Capture::IGameBarServices
    {
    ...
    struct WINRT_EBO GameBarServicesCommandEventArgs : Windows::Media::Capture::IGameBarServicesCommandEventArgs
    {
    ...
    struct WINRT_EBO GameBarServicesManager : Windows::Media::Capture::IGameBarServicesManager
    {
    ...
    struct WINRT_EBO GameBarServicesManagerGameBarServicesCreatedEventArgs : Windows::Media::Capture::IGameBarServicesManagerGameBarServicesCreatedEventArgs
    {
    ...
    struct WINRT_EBO GameBarServicesTargetInfo : Windows::Media::Capture::IGameBarServicesTargetInfo
    {
    ...
    struct WINRT_EBO LowLagMediaRecording : Windows::Media::Capture::ILowLagMediaRecording,
    ...
    struct WINRT_EBO LowLagPhotoCapture : Windows::Media::Capture::ILowLagPhotoCapture
    {
    ...
    struct WINRT_EBO LowLagPhotoSequenceCapture : Windows::Media::Capture::ILowLagPhotoSequenceCapture
    {
    ...
    struct WINRT_EBO MediaCapture : Windows::Media::Capture::IMediaCapture,
    ...
    struct WINRT_EBO MediaCaptureDeviceExclusiveControlStatusChangedEventArgs : Windows::Media::Capture::IMediaCaptureDeviceExclusiveControlStatusChangedEventArgs
    {
    ...
    struct WINRT_EBO MediaCaptureFailedEventArgs : Windows::Media::Capture::IMediaCaptureFailedEventArgs
    {
    ...
    struct WINRT_EBO MediaCaptureFocusChangedEventArgs : Windows::Media::Capture::IMediaCaptureFocusChangedEventArgs
    {
    ...
    struct WINRT_EBO MediaCaptureInitializationSettings : Windows::Media::Capture::IMediaCaptureInitializationSettings,
    ...
    struct WINRT_EBO MediaCapturePauseResult : Windows::Media::Capture::IMediaCapturePauseResult,
    ...
    struct WINRT_EBO MediaCaptureSettings : Windows::Media::Capture::IMediaCaptureSettings,
    ...
    struct WINRT_EBO MediaCaptureStopResult : Windows::Media::Capture::IMediaCaptureStopResult,
    ...
    struct WINRT_EBO MediaCaptureVideoProfile : Windows::Media::Capture::IMediaCaptureVideoProfile,
    ...
    struct WINRT_EBO MediaCaptureVideoProfileMediaDescription : Windows::Media::Capture::IMediaCaptureVideoProfileMediaDescription,
    ...
    struct WINRT_EBO OptionalReferencePhotoCapturedEventArgs : Windows::Media::Capture::IOptionalReferencePhotoCapturedEventArgs
    {
    ...
    struct WINRT_EBO PhotoCapturedEventArgs : Windows::Media::Capture::IPhotoCapturedEventArgs
    {
    ...
    struct WINRT_EBO PhotoConfirmationCapturedEventArgs : Windows::Media::Capture::IPhotoConfirmationCapturedEventArgs
    {
    ...
    struct WINRT_EBO ScreenCapture : Windows::Media::Capture::IScreenCapture
    {
    ...
    struct WINRT_EBO SourceSuspensionChangedEventArgs : Windows::Media::Capture::ISourceSuspensionChangedEventArgs
    {
    ...
    struct WINRT_EBO VideoStreamConfiguration : Windows::Media::Capture::IVideoStreamConfiguration
    {
