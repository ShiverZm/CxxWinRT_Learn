...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Contacts::Provider::IContactPickerUI>
    {
        ...
        {
            virtual int32_t WINRT_CALL AddContact(void*, void*, int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL RemoveContact(void*) noexcept = 0;
            virtual int32_t WINRT_CALL ContainsContact(void*, bool*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL add_ContactRemoved(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ContactRemoved(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Contacts::Provider::IContactPickerUI2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL AddContact(void*, int32_t*) noexcept = 0;
