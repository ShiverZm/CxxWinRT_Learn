...
namespace winrt::Windows::UI::ApplicationSettings
{
    ...
    struct WINRT_EBO AccountsSettingsPane : Windows::UI::ApplicationSettings::IAccountsSettingsPane
    {
        ...
        static Windows::Foundation::IAsyncAction ShowManageAccountsForUserAsync(Windows::System::User const& user);
        static Windows::Foundation::IAsyncAction ShowAddAccountForUserAsync(Windows::System::User const& user);
    };
    struct WINRT_EBO AccountsSettingsPaneCommandsRequestedEventArgs : Windows::UI::ApplicationSettings::IAccountsSettingsPaneCommandsRequestedEventArgs,
    ...
    struct WINRT_EBO AccountsSettingsPaneEventDeferral : Windows::UI::ApplicationSettings::IAccountsSettingsPaneEventDeferral
    {
    ...
    struct WINRT_EBO CredentialCommand : Windows::UI::ApplicationSettings::ICredentialCommand
    {
    ...
    struct WINRT_EBO SettingsCommand : Windows::UI::Popups::IUICommand
    {
    ...
    struct WINRT_EBO SettingsPane : Windows::UI::ApplicationSettings::ISettingsPane
    {
    ...
    struct WINRT_EBO SettingsPaneCommandsRequest : Windows::UI::ApplicationSettings::ISettingsPaneCommandsRequest
    {
    ...
    struct WINRT_EBO SettingsPaneCommandsRequestedEventArgs : Windows::UI::ApplicationSettings::ISettingsPaneCommandsRequestedEventArgs
    {
    ...
    struct WINRT_EBO WebAccountCommand : Windows::UI::ApplicationSettings::IWebAccountCommand
    {
    ...
    struct WINRT_EBO WebAccountInvokedArgs : Windows::UI::ApplicationSettings::IWebAccountInvokedArgs
    {
    ...
    struct WINRT_EBO WebAccountProviderCommand : Windows::UI::ApplicationSettings::IWebAccountProviderCommand
    {
