...
namespace winrt::Windows::ApplicationModel::Resources::Core
{
    ...
    struct WINRT_EBO NamedResource : Windows::ApplicationModel::Resources::Core::INamedResource
    {
    ...
    struct WINRT_EBO ResourceCandidate : Windows::ApplicationModel::Resources::Core::IResourceCandidate,
    ...
    struct WINRT_EBO ResourceCandidateVectorView : Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Resources::Core::ResourceCandidate>
    {
    ...
    struct WINRT_EBO ResourceContext : Windows::ApplicationModel::Resources::Core::IResourceContext
    {
        ...
        ResourceContext();
        static Windows::ApplicationModel::Resources::Core::ResourceContext CreateMatchingContext(param::iterable<Windows::ApplicationModel::Resources::Core::ResourceQualifier> const& result);
    ...
    struct WINRT_EBO ResourceContextLanguagesVectorView : Windows::Foundation::Collections::IVectorView<hstring>
    {
    ...
    struct WINRT_EBO ResourceManager : Windows::ApplicationModel::Resources::Core::IResourceManager,
    ...
    struct WINRT_EBO ResourceMap : Windows::ApplicationModel::Resources::Core::IResourceMap
    {
    ...
    struct WINRT_EBO ResourceMapIterator : Windows::Foundation::Collections::IIterator<Windows::Foundation::Collections::IKeyValuePair<hstring, Windows::ApplicationModel::Resources::Core::NamedResource>>
    {
    ...
    struct WINRT_EBO ResourceMapMapView : Windows::Foundation::Collections::IMapView<hstring, Windows::ApplicationModel::Resources::Core::ResourceMap>
    {
    ...
    struct WINRT_EBO ResourceMapMapViewIterator : Windows::Foundation::Collections::IIterator<Windows::Foundation::Collections::IKeyValuePair<hstring, Windows::ApplicationModel::Resources::Core::ResourceMap>>
    {
    ...
    struct WINRT_EBO ResourceQualifier : Windows::ApplicationModel::Resources::Core::IResourceQualifier
    {
    ...
    struct WINRT_EBO ResourceQualifierMapView : Windows::Foundation::Collections::IMapView<hstring, hstring>
    {
    ...
    struct WINRT_EBO ResourceQualifierObservableMap : Windows::Foundation::Collections::IObservableMap<hstring, hstring>
    {
    ...
    struct WINRT_EBO ResourceQualifierVectorView : Windows::Foundation::Collections::IVectorView<Windows::ApplicationModel::Resources::Core::ResourceQualifier>
    {
