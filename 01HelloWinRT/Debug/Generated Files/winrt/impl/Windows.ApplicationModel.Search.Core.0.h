...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Search::Core::ISearchSuggestion>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_DetailText(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Image(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ImageAlternateText(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Search::Core::ISearchSuggestionManager>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL SetQuery(void*) noexcept = 0;
            virtual int32_t WINRT_CALL SetQueryWithLanguage(void*, void*) noexcept = 0;
            virtual int32_t WINRT_CALL SetQueryWithSearchQueryLinguisticDetails(void*, void*, void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Suggestions(void**) noexcept = 0;
            virtual int32_t WINRT_CALL AddToHistory(void*) noexcept = 0;
            virtual int32_t WINRT_CALL AddToHistoryWithLanguage(void*, void*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL add_RequestingFocusOnKeyboardInput(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_RequestingFocusOnKeyboardInput(winrt::event_token) noexcept = 0;
        };
    };
