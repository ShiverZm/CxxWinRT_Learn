...
namespace winrt::Windows::Gaming::Input
{
    ...
    struct WINRT_EBO ArcadeStick : Windows::Gaming::Input::IArcadeStick,
    ...
    struct WINRT_EBO FlightStick : Windows::Gaming::Input::IFlightStick,
    ...
    struct WINRT_EBO Gamepad : Windows::Gaming::Input::IGamepad,
    ...
    struct WINRT_EBO Headset : Windows::Gaming::Input::IHeadset,
    ...
    struct WINRT_EBO RacingWheel : Windows::Gaming::Input::IRacingWheel,
    ...
    struct WINRT_EBO RawGameController : Windows::Gaming::Input::IRawGameController,
    ...
    struct WINRT_EBO UINavigationController : Windows::Gaming::Input::IUINavigationController,
