...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::UserDataAccounts::IUserDataAccount>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_UserDisplayName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_UserDisplayName(void*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL FindEmailMailboxesAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL FindContactListsAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL FindContactAnnotationListsAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::UserDataAccounts::IUserDataAccount2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_IsProtectedUnderLock(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::UserDataAccounts::IUserDataAccount3>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ExplictReadAccessPackageFamilyNames(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::UserDataAccounts::IUserDataAccount4>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CanShowCreateContactGroup(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_CanShowCreateContactGroup(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_ProviderProperties(void**) noexcept = 0;
            virtual int32_t WINRT_CALL FindUserDataTaskListsAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL FindContactGroupsAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL TryShowCreateContactGroupAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsProtectedUnderLock(bool) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::UserDataAccounts::IUserDataAccountManagerStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL RequestStoreAsync(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowAddAccountAsync(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowAccountSettingsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShowAccountErrorResolverAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::UserDataAccounts::IUserDataAccountStore>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL FindAccountsAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetAccountAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateAccountAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::UserDataAccounts::IUserDataAccountStore2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateAccountWithPackageRelativeAppIdAsync(void*, void*, void**) noexcept = 0;
    ...
    template <> struct abi<Windows::ApplicationModel::UserDataAccounts::IUserDataAccountStore3>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateAccountWithPackageRelativeAppIdAndEnterpriseIdAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
