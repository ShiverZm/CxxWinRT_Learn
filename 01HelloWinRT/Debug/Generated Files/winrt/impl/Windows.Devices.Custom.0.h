...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::Custom::ICustomDevice>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL SendIOControlAsync(void*, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL TrySendIOControlAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Custom::ICustomDeviceStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL FromIdAsync(void*, int32_t, int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Custom::IIOControlCode>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_BufferingMethod(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Function(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DeviceType(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ControlCode(uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Custom::IIOControlCodeFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateIOControlCode(uint16_t, uint16_t, int32_t, int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Custom::IKnownDeviceTypesStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Unknown(uint16_t*) noexcept = 0;
        };
    };
    template <typename D>
