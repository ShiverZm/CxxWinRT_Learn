...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::AppBroadcasting::IAppBroadcastingMonitor>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_IsCurrentAppBroadcasting(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL add_IsCurrentAppBroadcastingChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_IsCurrentAppBroadcastingChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::AppBroadcasting::IAppBroadcastingStatus>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CanStartBroadcast(bool*) noexcept = 0;
    ...
    {
        bool CanStartBroadcast() const;
        Windows::Media::AppBroadcasting::AppBroadcastingStatusDetails Details() const;
    };
