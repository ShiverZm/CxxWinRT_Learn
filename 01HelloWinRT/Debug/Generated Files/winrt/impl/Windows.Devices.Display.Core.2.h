...
namespace winrt::Windows::Devices::Display::Core
{
    ...
    struct WINRT_EBO DisplayAdapter : Windows::Devices::Display::Core::IDisplayAdapter
    {
    ...
    struct WINRT_EBO DisplayDevice : Windows::Devices::Display::Core::IDisplayDevice
    {
    ...
    struct WINRT_EBO DisplayFence : Windows::Devices::Display::Core::IDisplayFence
    {
    ...
    struct WINRT_EBO DisplayManager : Windows::Devices::Display::Core::IDisplayManager,
    ...
    struct WINRT_EBO DisplayManagerChangedEventArgs : Windows::Devices::Display::Core::IDisplayManagerChangedEventArgs
    {
    ...
    struct WINRT_EBO DisplayManagerDisabledEventArgs : Windows::Devices::Display::Core::IDisplayManagerDisabledEventArgs
    {
    ...
    struct WINRT_EBO DisplayManagerEnabledEventArgs : Windows::Devices::Display::Core::IDisplayManagerEnabledEventArgs
    {
    ...
    struct WINRT_EBO DisplayManagerPathsFailedOrInvalidatedEventArgs : Windows::Devices::Display::Core::IDisplayManagerPathsFailedOrInvalidatedEventArgs
    {
    ...
    struct WINRT_EBO DisplayManagerResultWithState : Windows::Devices::Display::Core::IDisplayManagerResultWithState
    {
    ...
    struct WINRT_EBO DisplayModeInfo : Windows::Devices::Display::Core::IDisplayModeInfo
    {
    ...
    struct WINRT_EBO DisplayPath : Windows::Devices::Display::Core::IDisplayPath
    {
    ...
    struct WINRT_EBO DisplayPrimaryDescription : Windows::Devices::Display::Core::IDisplayPrimaryDescription
    {
    ...
    struct WINRT_EBO DisplayScanout : Windows::Devices::Display::Core::IDisplayScanout
    {
    ...
    struct WINRT_EBO DisplaySource : Windows::Devices::Display::Core::IDisplaySource
    {
    ...
    struct WINRT_EBO DisplayState : Windows::Devices::Display::Core::IDisplayState
    {
    ...
    struct WINRT_EBO DisplayStateOperationResult : Windows::Devices::Display::Core::IDisplayStateOperationResult
    {
    ...
    struct WINRT_EBO DisplaySurface : Windows::Devices::Display::Core::IDisplaySurface
    {
    ...
    struct WINRT_EBO DisplayTarget : Windows::Devices::Display::Core::IDisplayTarget
    {
    ...
    struct WINRT_EBO DisplayTask : Windows::Devices::Display::Core::IDisplayTask
    {
    ...
    struct WINRT_EBO DisplayTaskPool : Windows::Devices::Display::Core::IDisplayTaskPool
    {
    ...
    struct WINRT_EBO DisplayView : Windows::Devices::Display::Core::IDisplayView
    {
    ...
    struct WINRT_EBO DisplayWireFormat : Windows::Devices::Display::Core::IDisplayWireFormat
    {
