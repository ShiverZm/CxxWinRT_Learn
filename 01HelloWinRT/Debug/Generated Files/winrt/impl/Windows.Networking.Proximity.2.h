...
namespace winrt::Windows::Networking::Proximity
{
    ...
    struct WINRT_EBO ConnectionRequestedEventArgs : Windows::Networking::Proximity::IConnectionRequestedEventArgs
    {
    ...
    struct WINRT_EBO PeerInformation : Windows::Networking::Proximity::IPeerInformation,
    ...
    struct WINRT_EBO PeerWatcher : Windows::Networking::Proximity::IPeerWatcher
    {
    ...
    struct WINRT_EBO ProximityDevice : Windows::Networking::Proximity::IProximityDevice
    {
    ...
    struct WINRT_EBO ProximityMessage : Windows::Networking::Proximity::IProximityMessage
    {
    ...
    struct WINRT_EBO TriggeredConnectionStateChangedEventArgs : Windows::Networking::Proximity::ITriggeredConnectionStateChangedEventArgs
    {
