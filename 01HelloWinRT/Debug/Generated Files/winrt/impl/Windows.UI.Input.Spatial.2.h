...
{
    struct WINRT_EBO SpatialGestureRecognizer : Windows::UI::Input::Spatial::ISpatialGestureRecognizer
    {
    ...
    struct WINRT_EBO SpatialHoldCanceledEventArgs : Windows::UI::Input::Spatial::ISpatialHoldCanceledEventArgs
    {
    ...
    struct WINRT_EBO SpatialHoldCompletedEventArgs : Windows::UI::Input::Spatial::ISpatialHoldCompletedEventArgs
    {
    ...
    struct WINRT_EBO SpatialHoldStartedEventArgs : Windows::UI::Input::Spatial::ISpatialHoldStartedEventArgs
    {
    ...
    struct WINRT_EBO SpatialInteraction : Windows::UI::Input::Spatial::ISpatialInteraction
    {
    ...
    struct WINRT_EBO SpatialInteractionController : Windows::UI::Input::Spatial::ISpatialInteractionController,
    ...
    struct WINRT_EBO SpatialInteractionControllerProperties : Windows::UI::Input::Spatial::ISpatialInteractionControllerProperties
    {
    ...
    struct WINRT_EBO SpatialInteractionDetectedEventArgs : Windows::UI::Input::Spatial::ISpatialInteractionDetectedEventArgs,
    ...
    struct WINRT_EBO SpatialInteractionManager : Windows::UI::Input::Spatial::ISpatialInteractionManager
    {
    ...
    struct WINRT_EBO SpatialInteractionSource : Windows::UI::Input::Spatial::ISpatialInteractionSource,
    ...
    struct WINRT_EBO SpatialInteractionSourceEventArgs : Windows::UI::Input::Spatial::ISpatialInteractionSourceEventArgs,
    ...
    struct WINRT_EBO SpatialInteractionSourceLocation : Windows::UI::Input::Spatial::ISpatialInteractionSourceLocation,
    ...
    struct WINRT_EBO SpatialInteractionSourceProperties : Windows::UI::Input::Spatial::ISpatialInteractionSourceProperties
    {
    ...
    struct WINRT_EBO SpatialInteractionSourceState : Windows::UI::Input::Spatial::ISpatialInteractionSourceState,
    ...
    struct WINRT_EBO SpatialManipulationCanceledEventArgs : Windows::UI::Input::Spatial::ISpatialManipulationCanceledEventArgs
    {
    ...
    struct WINRT_EBO SpatialManipulationCompletedEventArgs : Windows::UI::Input::Spatial::ISpatialManipulationCompletedEventArgs
    {
    ...
    struct WINRT_EBO SpatialManipulationDelta : Windows::UI::Input::Spatial::ISpatialManipulationDelta
    {
    ...
    struct WINRT_EBO SpatialManipulationStartedEventArgs : Windows::UI::Input::Spatial::ISpatialManipulationStartedEventArgs
    {
    ...
    struct WINRT_EBO SpatialManipulationUpdatedEventArgs : Windows::UI::Input::Spatial::ISpatialManipulationUpdatedEventArgs
    {
    ...
    struct WINRT_EBO SpatialNavigationCanceledEventArgs : Windows::UI::Input::Spatial::ISpatialNavigationCanceledEventArgs
    {
    ...
    struct WINRT_EBO SpatialNavigationCompletedEventArgs : Windows::UI::Input::Spatial::ISpatialNavigationCompletedEventArgs
    {
    ...
    struct WINRT_EBO SpatialNavigationStartedEventArgs : Windows::UI::Input::Spatial::ISpatialNavigationStartedEventArgs
    {
    ...
    struct WINRT_EBO SpatialNavigationUpdatedEventArgs : Windows::UI::Input::Spatial::ISpatialNavigationUpdatedEventArgs
    {
    ...
    struct WINRT_EBO SpatialPointerInteractionSourcePose : Windows::UI::Input::Spatial::ISpatialPointerInteractionSourcePose,
    ...
    struct WINRT_EBO SpatialPointerPose : Windows::UI::Input::Spatial::ISpatialPointerPose,
    ...
    struct WINRT_EBO SpatialRecognitionEndedEventArgs : Windows::UI::Input::Spatial::ISpatialRecognitionEndedEventArgs
    {
    ...
    struct WINRT_EBO SpatialRecognitionStartedEventArgs : Windows::UI::Input::Spatial::ISpatialRecognitionStartedEventArgs
    {
    ...
    struct WINRT_EBO SpatialTappedEventArgs : Windows::UI::Input::Spatial::ISpatialTappedEventArgs
    {
