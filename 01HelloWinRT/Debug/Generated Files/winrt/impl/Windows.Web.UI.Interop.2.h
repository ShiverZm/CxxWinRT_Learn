...
{
    struct WINRT_EBO WebViewControl : Windows::Web::UI::IWebViewControl,
    ...
    struct WINRT_EBO WebViewControlAcceleratorKeyPressedEventArgs : Windows::Web::UI::Interop::IWebViewControlAcceleratorKeyPressedEventArgs
    {
    ...
    struct WINRT_EBO WebViewControlMoveFocusRequestedEventArgs : Windows::Web::UI::Interop::IWebViewControlMoveFocusRequestedEventArgs
    {
    ...
    struct WINRT_EBO WebViewControlProcess : Windows::Web::UI::Interop::IWebViewControlProcess
    {
    ...
    struct WINRT_EBO WebViewControlProcessOptions : Windows::Web::UI::Interop::IWebViewControlProcessOptions
    {
