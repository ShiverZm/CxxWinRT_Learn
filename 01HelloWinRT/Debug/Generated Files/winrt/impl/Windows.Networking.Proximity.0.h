...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Networking::Proximity::IConnectionRequestedEventArgs>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_PeerInformation(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::Proximity::IPeerFinderStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_AllowBluetooth(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AllowBluetooth(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_AllowInfrastructure(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AllowInfrastructure(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_AllowWiFiDirect(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AllowWiFiDirect(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_DisplayName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_DisplayName(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportedDiscoveryTypes(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AlternateIdentities(void**) noexcept = 0;
            virtual int32_t WINRT_CALL Start() noexcept = 0;
            virtual int32_t WINRT_CALL StartWithMessage(void*) noexcept = 0;
            virtual int32_t WINRT_CALL Stop() noexcept = 0;
            virtual int32_t WINRT_CALL add_TriggeredConnectionStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_TriggeredConnectionStateChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_ConnectionRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ConnectionRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL FindAllPeersAsync(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Networking::Proximity::IPeerFinderStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_DiscoveryData(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_DiscoveryData(void*) noexcept = 0;
    ...
    template <> struct abi<Windows::Networking::Proximity::IProximityDevice>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL SubscribeForMessage(void*, void*, int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL PublishMessage(void*, void*, int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL PublishMessageWithCallback(void*, void*, void*, int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL PublishBinaryMessage(void*, void*, int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL PublishBinaryMessageWithCallback(void*, void*, void*, int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL PublishUriMessage(void*, int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL PublishUriMessageWithCallback(void*, void*, int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL StopSubscribingForMessage(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL StopPublishingMessage(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL add_DeviceArrived(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_DeviceArrived(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_DeviceDeparted(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_DeviceDeparted(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaxMessageBytes(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_BitsPerSecond(uint64_t*) noexcept = 0;
    ...
    template <> struct abi<Windows::Networking::Proximity::IProximityMessage>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_MessageType(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SubscriptionId(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Data(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_DataAsString(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Networking::Proximity::MessageTransmittedHandler>
    {
        struct WINRT_NOVTABLE type : unknown_abi
        {
            virtual int32_t WINRT_CALL Invoke(void*, int64_t) noexcept = 0;
        };
    };
    template <typename D>
