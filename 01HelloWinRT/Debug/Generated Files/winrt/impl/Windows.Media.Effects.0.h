...
namespace winrt::impl
{
    ...
    template <> struct category<Windows::Media::Effects::ISlowMotionEffectDefinition>
    {
        using type = interface_category;
    };
    ...
    template <> struct category<Windows::Media::Effects::SlowMotionEffectDefinition>
    {
        using type = class_category;
    };
    ...
    template <> struct name<Windows::Media::Effects::ISlowMotionEffectDefinition>
    {
        static constexpr auto & value{ L"Windows.Media.Effects.ISlowMotionEffectDefinition" };
    };
    ...
    template <> struct name<Windows::Media::Effects::SlowMotionEffectDefinition>
    {
        static constexpr auto & value{ L"Windows.Media.Effects.SlowMotionEffectDefinition" };
    };
    ...
    template <> struct guid_storage<Windows::Media::Effects::ISlowMotionEffectDefinition>
    {
        static constexpr guid value{ 0x35053CD0,0x176C,0x4763,{ 0x82,0xC4,0x1B,0x02,0xDB,0xE3,0x17,0x37 } };
    };
    ...
    template <> struct default_interface<Windows::Media::Effects::SlowMotionEffectDefinition>
    {
        using type = Windows::Media::Effects::ISlowMotionEffectDefinition;
    };
    ...
    template <> struct abi<Windows::Media::Effects::IAudioCaptureEffectsManager>
    {
        ...
        {
            virtual int32_t WINRT_CALL add_AudioCaptureEffectsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_AudioCaptureEffectsChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL GetAudioCaptureEffects(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Effects::IAudioEffect>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_AudioEffectType(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Effects::IAudioEffectDefinition>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ActivatableClassId(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Media::Effects::IAudioEffectDefinitionFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL CreateWithProperties(void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Effects::IAudioEffectsManagerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateAudioRenderEffectsManager(void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateAudioRenderEffectsManagerWithMode(void*, int32_t, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateAudioCaptureEffectsManager(void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateAudioCaptureEffectsManagerWithMode(void*, int32_t, int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Effects::IAudioRenderEffectsManager>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL add_AudioRenderEffectsChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_AudioRenderEffectsChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL GetAudioRenderEffects(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Effects::IAudioRenderEffectsManager2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_EffectsProviderThumbnail(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_EffectsProviderSettingsLabel(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Media::Effects::IBasicAudioEffect>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_UseInputFrameForOutput(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportedEncodingProperties(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetEncodingProperties(void*) noexcept = 0;
            virtual int32_t WINRT_CALL ProcessFrame(void*) noexcept = 0;
            virtual int32_t WINRT_CALL Close(int32_t) noexcept = 0;
    ...
    template <> struct abi<Windows::Media::Effects::IBasicVideoEffect>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_SupportedMemoryTypes(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_TimeIndependent(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportedEncodingProperties(void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetEncodingProperties(void*, void*) noexcept = 0;
            virtual int32_t WINRT_CALL ProcessFrame(void*) noexcept = 0;
            virtual int32_t WINRT_CALL Close(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL DiscardQueuedFrames() noexcept = 0;
        };
    ...
    template <> struct abi<Windows::Media::Effects::ICompositeVideoFrameContext>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SurfacesToOverlay(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_BackgroundFrame(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_OutputFrame(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetOverlayForSurface(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Effects::IProcessAudioFrameContext>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_InputFrame(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_OutputFrame(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::Effects::ISlowMotionEffectDefinition>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_TimeStretchRate(double*) noexcept = 0;
            virtual int32_t WINRT_CALL put_TimeStretchRate(double) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Effects::IVideoCompositor>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_TimeIndependent(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL SetEncodingProperties(void*, void*) noexcept = 0;
            virtual int32_t WINRT_CALL CompositeFrame(void*) noexcept = 0;
            virtual int32_t WINRT_CALL Close(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL DiscardQueuedFrames() noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Media::Effects::IVideoTransformEffectDefinition>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_PaddingColor(struct struct_Windows_UI_Color*) noexcept = 0;
            virtual int32_t WINRT_CALL put_PaddingColor(struct struct_Windows_UI_Color) noexcept = 0;
            virtual int32_t WINRT_CALL get_OutputSize(Windows::Foundation::Size*) noexcept = 0;
            virtual int32_t WINRT_CALL put_OutputSize(Windows::Foundation::Size) noexcept = 0;
            virtual int32_t WINRT_CALL get_CropRectangle(Windows::Foundation::Rect*) noexcept = 0;
            virtual int32_t WINRT_CALL put_CropRectangle(Windows::Foundation::Rect) noexcept = 0;
            virtual int32_t WINRT_CALL get_Rotation(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Rotation(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_Mirror(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_Mirror(uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL put_ProcessingAlgorithm(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_ProcessingAlgorithm(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Effects::IVideoTransformEffectDefinition2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SphericalProjection(void**) noexcept = 0;
        };
    };
