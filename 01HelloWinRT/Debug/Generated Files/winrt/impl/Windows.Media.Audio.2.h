...
{
    struct WINRT_EBO AudioDeviceInputNode : Windows::Media::Audio::IAudioDeviceInputNode,
    ...
    struct WINRT_EBO AudioDeviceOutputNode : Windows::Media::Audio::IAudioDeviceOutputNode,
    ...
    struct WINRT_EBO AudioFileInputNode : Windows::Media::Audio::IAudioFileInputNode,
    ...
    struct WINRT_EBO AudioFileOutputNode : Windows::Media::Audio::IAudioFileOutputNode
    {
    ...
    struct WINRT_EBO AudioFrameCompletedEventArgs : Windows::Media::Audio::IAudioFrameCompletedEventArgs
    {
    ...
    struct WINRT_EBO AudioFrameInputNode : Windows::Media::Audio::IAudioFrameInputNode,
    ...
    struct WINRT_EBO AudioFrameOutputNode : Windows::Media::Audio::IAudioFrameOutputNode
    {
    ...
    struct WINRT_EBO AudioGraph : Windows::Media::Audio::IAudioGraph,
    ...
    struct WINRT_EBO AudioGraphBatchUpdater : Windows::Foundation::IClosable
    {
    ...
    struct WINRT_EBO AudioGraphConnection : Windows::Media::Audio::IAudioGraphConnection
    {
    ...
    struct WINRT_EBO AudioGraphSettings : Windows::Media::Audio::IAudioGraphSettings,
    ...
    struct WINRT_EBO AudioGraphUnrecoverableErrorOccurredEventArgs : Windows::Media::Audio::IAudioGraphUnrecoverableErrorOccurredEventArgs
    {
    ...
    struct WINRT_EBO AudioNodeEmitter : Windows::Media::Audio::IAudioNodeEmitter,
    ...
    struct WINRT_EBO AudioNodeEmitterConeProperties : Windows::Media::Audio::IAudioNodeEmitterConeProperties
    {
    ...
    struct WINRT_EBO AudioNodeEmitterDecayModel : Windows::Media::Audio::IAudioNodeEmitterDecayModel
    {
    ...
    struct WINRT_EBO AudioNodeEmitterNaturalDecayModelProperties : Windows::Media::Audio::IAudioNodeEmitterNaturalDecayModelProperties
    {
    ...
    struct WINRT_EBO AudioNodeEmitterShape : Windows::Media::Audio::IAudioNodeEmitterShape
    {
    ...
    struct WINRT_EBO AudioNodeListener : Windows::Media::Audio::IAudioNodeListener
    {
    ...
    struct WINRT_EBO AudioStateMonitor : Windows::Media::Audio::IAudioStateMonitor
    {
    ...
    struct WINRT_EBO AudioSubmixNode : Windows::Media::Audio::IAudioInputNode,
    ...
    struct WINRT_EBO CreateAudioDeviceInputNodeResult : Windows::Media::Audio::ICreateAudioDeviceInputNodeResult,
    ...
    struct WINRT_EBO CreateAudioDeviceOutputNodeResult : Windows::Media::Audio::ICreateAudioDeviceOutputNodeResult,
    ...
    struct WINRT_EBO CreateAudioFileInputNodeResult : Windows::Media::Audio::ICreateAudioFileInputNodeResult,
    ...
    struct WINRT_EBO CreateAudioFileOutputNodeResult : Windows::Media::Audio::ICreateAudioFileOutputNodeResult,
    ...
    struct WINRT_EBO CreateAudioGraphResult : Windows::Media::Audio::ICreateAudioGraphResult,
    ...
    struct WINRT_EBO CreateMediaSourceAudioInputNodeResult : Windows::Media::Audio::ICreateMediaSourceAudioInputNodeResult,
    ...
    struct WINRT_EBO EchoEffectDefinition : Windows::Media::Audio::IEchoEffectDefinition
    {
    ...
    struct WINRT_EBO EqualizerBand : Windows::Media::Audio::IEqualizerBand
    {
    ...
    struct WINRT_EBO EqualizerEffectDefinition : Windows::Media::Audio::IEqualizerEffectDefinition
    {
    ...
    struct WINRT_EBO FrameInputNodeQuantumStartedEventArgs : Windows::Media::Audio::IFrameInputNodeQuantumStartedEventArgs
    {
    ...
    struct WINRT_EBO LimiterEffectDefinition : Windows::Media::Audio::ILimiterEffectDefinition
    {
    ...
    struct WINRT_EBO MediaSourceAudioInputNode : Windows::Media::Audio::IMediaSourceAudioInputNode
    {
    ...
    struct WINRT_EBO ReverbEffectDefinition : Windows::Media::Audio::IReverbEffectDefinition
    {
    ...
    struct WINRT_EBO SetDefaultSpatialAudioFormatResult : Windows::Media::Audio::ISetDefaultSpatialAudioFormatResult
    {
    ...
    struct WINRT_EBO SpatialAudioDeviceConfiguration : Windows::Media::Audio::ISpatialAudioDeviceConfiguration
    {
    ...
    struct WINRT_EBO SpatialAudioFormatConfiguration : Windows::Media::Audio::ISpatialAudioFormatConfiguration
    {
