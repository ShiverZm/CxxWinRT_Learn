...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Gaming::XboxLive::Storage::IGameSaveBlobInfoQuery>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetBlobInfoAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetBlobInfoWithIndexAndMaxAsync(uint32_t, uint32_t, void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Gaming::XboxLive::Storage::IGameSaveContainer>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL SubmitUpdatesAsync(void*, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReadAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL SubmitPropertySetUpdatesAsync(void*, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateBlobInfoQuery(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Gaming::XboxLive::Storage::IGameSaveContainerInfo>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_Name(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_TotalSize(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DisplayName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_LastModifiedTime(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_NeedsSync(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Gaming::XboxLive::Storage::IGameSaveContainerInfoQuery>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetContainerInfoAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetContainerInfoWithIndexAndMaxAsync(uint32_t, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetItemCountAsync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Gaming::XboxLive::Storage::IGameSaveProvider>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL CreateContainer(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL DeleteContainerAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateContainerInfoQuery(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateContainerInfoQueryWithName(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetRemainingBytesInQuotaAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ContainersChangedSinceLastSync(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Gaming::XboxLive::Storage::IGameSaveProviderStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetForUserAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSyncOnDemandForUserAsync(void*, void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Windows_Gaming_XboxLive_Storage_IGameSaveBlobGetResult
    {
        Windows::Gaming::XboxLive::Storage::GameSaveErrorStatus Status() const;
        Windows::Foundation::Collections::IMapView<hstring, Windows::Storage::Streams::IBuffer> Value() const;
    };
    ...
    {
        Windows::Gaming::XboxLive::Storage::GameSaveErrorStatus Status() const;
        Windows::Foundation::Collections::IVectorView<Windows::Gaming::XboxLive::Storage::GameSaveBlobInfo> Value() const;
    };
    ...
    {
        hstring Name() const;
        Windows::Gaming::XboxLive::Storage::GameSaveProvider Provider() const;
    ...
    struct consume_Windows_Gaming_XboxLive_Storage_IGameSaveContainerInfo
    {
        ...
        Windows::Foundation::DateTime LastModifiedTime() const;
    ...
    {
        Windows::Gaming::XboxLive::Storage::GameSaveErrorStatus Status() const;
        Windows::Foundation::Collections::IVectorView<Windows::Gaming::XboxLive::Storage::GameSaveContainerInfo> Value() const;
    };
    ...
    struct consume_Windows_Gaming_XboxLive_Storage_IGameSaveProvider
    {
        ...
        Windows::Foundation::Collections::IVectorView<hstring> ContainersChangedSinceLastSync() const;
    };
    ...
    {
        Windows::Gaming::XboxLive::Storage::GameSaveErrorStatus Status() const;
        Windows::Gaming::XboxLive::Storage::GameSaveProvider Value() const;
    };
