...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowBackgroundSession>
    {
        ...
        {
            virtual int32_t WINRT_CALL add_SetupRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_SetupRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_Submitted(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_Submitted(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowBackgroundSetupRequestedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetUserPrintTicketAsync(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowConfiguration>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SourceAppDisplayName(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowForegroundSession>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL add_SetupRequested(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_SetupRequested(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_XpsDataAvailable(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_XpsDataAvailable(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_Status(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL Start() noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowSourceContent>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetJobPrintTicketAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSourceSpoolDataAsStreamContent(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSourceSpoolDataAsXpsObjectModel(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowSpoolStreamContent>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetInputStream(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowStreamTarget>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetOutputStream(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowSubmittedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetTarget(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetDeferral(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowSubmittedOperation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL Complete(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_Configuration(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_XpsContent(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowTarget>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_TargetAsStream(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_TargetAsXpsObjectModelPackage(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Graphics::Printing::Workflow::IPrintWorkflowTriggerDetails>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_PrintWorkflowSession(void**) noexcept = 0;
        };
    };
