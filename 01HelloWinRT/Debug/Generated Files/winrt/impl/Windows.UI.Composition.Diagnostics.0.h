...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Composition::Diagnostics::ICompositionDebugHeatMaps>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL ShowMemoryUsage(void*) noexcept = 0;
            virtual int32_t WINRT_CALL ShowOverdraw(void*, uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL ShowRedraw(void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Composition::Diagnostics::ICompositionDebugSettings>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_HeatMaps(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Composition::Diagnostics::ICompositionDebugSettingsStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL TryGetSettings(void*, void**) noexcept = 0;
        };
    };
    template <typename D>
