...
namespace winrt::Windows::Perception::People
{
    ...
    struct WINRT_EBO EyesPose : Windows::Perception::People::IEyesPose
    {
    ...
    struct WINRT_EBO HandMeshObserver : Windows::Perception::People::IHandMeshObserver
    {
    ...
    struct WINRT_EBO HandMeshVertexState : Windows::Perception::People::IHandMeshVertexState
    {
    ...
    struct WINRT_EBO HandPose : Windows::Perception::People::IHandPose
    {
    ...
    struct WINRT_EBO HeadPose : Windows::Perception::People::IHeadPose
    {
