...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Storage::AccessCache::IItemRemovedEventArgs>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_RemovedEntry(struct struct_Windows_Storage_AccessCache_AccessListEntry*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::AccessCache::IStorageApplicationPermissionsStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_FutureAccessList(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_MostRecentlyUsedList(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::AccessCache::IStorageApplicationPermissionsStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetFutureAccessListForUser(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetMostRecentlyUsedListForUser(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::AccessCache::IStorageItemAccessList>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL AddOverloadDefaultMetadata(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL Add(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL AddOrReplaceOverloadDefaultMetadata(void*, void*) noexcept = 0;
            virtual int32_t WINRT_CALL AddOrReplace(void*, void*, void*) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL GetItemWithOptionsAsync(void*, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetFileWithOptionsAsync(void*, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetFolderWithOptionsAsync(void*, uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL Remove(void*) noexcept = 0;
            virtual int32_t WINRT_CALL ContainsItem(void*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL Clear() noexcept = 0;
            virtual int32_t WINRT_CALL CheckAccess(void*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Entries(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_MaximumItemsAllowed(uint32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::AccessCache::IStorageItemMostRecentlyUsedList>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL add_ItemRemoved(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ItemRemoved(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Storage::AccessCache::IStorageItemMostRecentlyUsedList2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL AddWithMetadataAndVisibility(void*, void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL AddOrReplaceWithMetadataAndVisibility(void*, void*, void*, int32_t) noexcept = 0;
        };
    };
    template <typename D>
