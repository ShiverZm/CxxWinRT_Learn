...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::VoiceCommands::IVoiceCommand>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_CommandName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Properties(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SpeechRecognitionResult(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::VoiceCommands::IVoiceCommandConfirmationResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Confirmed(bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::VoiceCommands::IVoiceCommandContentTile>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_TextLine1(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_TextLine1(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_TextLine2(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_TextLine2(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_TextLine3(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_TextLine3(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Image(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_Image(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AppContext(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_AppContext(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AppLaunchArgument(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_AppLaunchArgument(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ContentTileType(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ContentTileType(int32_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::VoiceCommands::IVoiceCommandDefinitionManagerStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL InstallCommandDefinitionsFromStorageFileAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_InstalledCommandDefinitions(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::VoiceCommands::IVoiceCommandResponse>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_RepeatMessage(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_RepeatMessage(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_AppLaunchArgument(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_AppLaunchArgument(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_VoiceCommandContentTiles(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::VoiceCommands::IVoiceCommandResponseStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_MaxSupportedVoiceCommandContentTiles(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL CreateResponse(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateResponseWithTiles(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateResponseForPrompt(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateResponseForPromptWithTiles(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::VoiceCommands::IVoiceCommandServiceConnection>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetVoiceCommandAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestConfirmationAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestDisambiguationAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReportProgressAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReportSuccessAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReportFailureAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestAppLaunchAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Language(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_VoiceCommandCompleted(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_VoiceCommandCompleted(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::VoiceCommands::IVoiceCommandServiceConnectionStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL FromAppServiceTriggerDetails(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::VoiceCommands::IVoiceCommandUserMessage>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_SpokenMessage(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_SpokenMessage(void*) noexcept = 0;
        };
    };
    template <typename D>
