...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Core::AnimationMetrics::IAnimationDescription>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_Animations(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_StaggerDelay(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_StaggerDelayFactor(float*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DelayLimit(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ZOrder(int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::UI::Core::AnimationMetrics::IOpacityAnimation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_InitialOpacity(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_FinalOpacity(float*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Core::AnimationMetrics::IPropertyAnimation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Control1(Windows::Foundation::Point*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Control2(Windows::Foundation::Point*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Core::AnimationMetrics::IScaleAnimation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_InitialScaleX(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_InitialScaleY(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_FinalScaleX(float*) noexcept = 0;
            virtual int32_t WINRT_CALL get_FinalScaleY(float*) noexcept = 0;
            virtual int32_t WINRT_CALL get_NormalizedOrigin(Windows::Foundation::Point*) noexcept = 0;
        };
    };
    template <typename D>
