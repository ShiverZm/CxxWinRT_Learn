...
{
    struct WINRT_EBO CoreDragDropManager : Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragDropManager
    {
    ...
    struct WINRT_EBO CoreDragInfo : Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragInfo,
    ...
    struct WINRT_EBO CoreDragOperation : Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragOperation,
    ...
    struct WINRT_EBO CoreDragUIOverride : Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDragUIOverride
    {
    ...
    struct WINRT_EBO CoreDropOperationTargetRequestedEventArgs : Windows::ApplicationModel::DataTransfer::DragDrop::Core::ICoreDropOperationTargetRequestedEventArgs
    {
