...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::Lights::ILamp>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_BrightnessLevel(float*) noexcept = 0;
            virtual int32_t WINRT_CALL put_BrightnessLevel(float) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsColorSettable(bool*) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Lights::ILampArray>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_HardwareVersion(uint16_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_LampArrayKind(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_LampCount(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_MinUpdateInterval(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_BoundingBox(Windows::Foundation::Numerics::float3*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsEnabled(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_BrightnessLevel(double*) noexcept = 0;
            virtual int32_t WINRT_CALL put_BrightnessLevel(double) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsConnected(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SupportsVirtualKeys(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL GetLampInfo(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetIndicesForKey(int32_t, uint32_t* __resultSize, int32_t**) noexcept = 0;
            virtual int32_t WINRT_CALL GetIndicesForPurposes(uint32_t, uint32_t* __resultSize, int32_t**) noexcept = 0;
            virtual int32_t WINRT_CALL SetColor(struct struct_Windows_UI_Color) noexcept = 0;
            virtual int32_t WINRT_CALL SetColorForIndex(int32_t, struct struct_Windows_UI_Color) noexcept = 0;
            virtual int32_t WINRT_CALL SetSingleColorForIndices(struct struct_Windows_UI_Color, uint32_t, int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL SetColorsForIndices(uint32_t, struct struct_Windows_UI_Color*, uint32_t, int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL SetColorsForKey(struct struct_Windows_UI_Color, int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL SetColorsForKeys(uint32_t, struct struct_Windows_UI_Color*, uint32_t, int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL SetColorsForPurposes(struct struct_Windows_UI_Color, uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL SendMessageAsync(int32_t, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestMessageAsync(int32_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::Lights::ILampInfo>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Index(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Purposes(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Position(Windows::Foundation::Numerics::float3*) noexcept = 0;
            virtual int32_t WINRT_CALL get_RedLevelCount(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_GreenLevelCount(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_BlueLevelCount(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_GainLevelCount(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_FixedColor(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNearestSupportedColor(struct struct_Windows_UI_Color, struct struct_Windows_UI_Color*) noexcept = 0;
            virtual int32_t WINRT_CALL get_UpdateLatency(int64_t*) noexcept = 0;
        };
    };
