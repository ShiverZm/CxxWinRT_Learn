...
{
    struct WINRT_EBO GazeDevicePreview : Windows::Devices::Input::Preview::IGazeDevicePreview
    {
    ...
    struct WINRT_EBO GazeDeviceWatcherAddedPreviewEventArgs : Windows::Devices::Input::Preview::IGazeDeviceWatcherAddedPreviewEventArgs
    {
    ...
    struct WINRT_EBO GazeDeviceWatcherPreview : Windows::Devices::Input::Preview::IGazeDeviceWatcherPreview
    {
    ...
    struct WINRT_EBO GazeDeviceWatcherRemovedPreviewEventArgs : Windows::Devices::Input::Preview::IGazeDeviceWatcherRemovedPreviewEventArgs
    {
    ...
    struct WINRT_EBO GazeDeviceWatcherUpdatedPreviewEventArgs : Windows::Devices::Input::Preview::IGazeDeviceWatcherUpdatedPreviewEventArgs
    {
    ...
    struct WINRT_EBO GazeEnteredPreviewEventArgs : Windows::Devices::Input::Preview::IGazeEnteredPreviewEventArgs
    {
    ...
    struct WINRT_EBO GazeExitedPreviewEventArgs : Windows::Devices::Input::Preview::IGazeExitedPreviewEventArgs
    {
    ...
    struct WINRT_EBO GazeInputSourcePreview : Windows::Devices::Input::Preview::IGazeInputSourcePreview
    {
    ...
    struct WINRT_EBO GazeMovedPreviewEventArgs : Windows::Devices::Input::Preview::IGazeMovedPreviewEventArgs
    {
    ...
    struct WINRT_EBO GazePointPreview : Windows::Devices::Input::Preview::IGazePointPreview
    {
