...
namespace winrt::Windows::Graphics::Display::Core
{
    ...
    struct WINRT_EBO HdmiDisplayInformation : Windows::Graphics::Display::Core::IHdmiDisplayInformation
    {
    ...
    struct WINRT_EBO HdmiDisplayMode : Windows::Graphics::Display::Core::IHdmiDisplayMode,
