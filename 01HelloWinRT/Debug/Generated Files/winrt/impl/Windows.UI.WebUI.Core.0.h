...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::WebUI::Core::IWebUICommandBar>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_ClosedDisplayMode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ClosedDisplayMode(int32_t) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_PrimaryCommands(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SecondaryCommands(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_MenuOpened(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_MenuOpened(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_MenuClosed(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_MenuClosed(winrt::event_token) noexcept = 0;
    ...
    template <> struct abi<Windows::UI::WebUI::Core::IWebUICommandBarConfirmationButton>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL add_ItemInvoked(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ItemInvoked(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::UI::WebUI::Core::IWebUICommandBarIconButton>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_IsToggleButton(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsToggleButton(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsChecked(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsChecked(bool) noexcept = 0;
    ...
    template <> struct abi<Windows::UI::WebUI::Core::IWebUICommandBarItemInvokedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsPrimaryCommand(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::UI::WebUI::Core::IWebUICommandBarSymbolIcon>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Symbol(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_Symbol(void*) noexcept = 0;
        };
    };
