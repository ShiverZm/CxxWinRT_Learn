...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::System::Diagnostics::DevicePortal::IDevicePortalConnectionStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetForAppServiceConnection(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Diagnostics::DevicePortal::IDevicePortalWebSocketConnection>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetServerMessageWebSocketForRequest(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetServerMessageWebSocketForRequest2(void*, int32_t, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetServerMessageWebSocketForRequest3(void*, int32_t, void*, uint32_t, uint32_t, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetServerStreamWebSocketForRequest(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetServerStreamWebSocketForRequest2(void*, void*, uint32_t, bool, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Diagnostics::DevicePortal::IDevicePortalWebSocketConnectionRequestReceivedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsWebSocketUpgradeRequest(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_WebSocketProtocolsRequested(void**) noexcept = 0;
