...
{
    struct WINRT_EBO AtomPubClient : Windows::Web::AtomPub::IAtomPubClient
    {
    ...
    struct WINRT_EBO ResourceCollection : Windows::Web::AtomPub::IResourceCollection
    {
    ...
    struct WINRT_EBO ServiceDocument : Windows::Web::AtomPub::IServiceDocument
    {
    ...
    struct WINRT_EBO Workspace : Windows::Web::AtomPub::IWorkspace
    {
