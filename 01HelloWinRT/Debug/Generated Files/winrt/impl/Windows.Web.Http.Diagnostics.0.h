...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Web::Http::Diagnostics::IHttpDiagnosticProvider>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL add_RequestSent(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_RequestSent(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_ResponseReceived(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_ResponseReceived(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_RequestResponseCompleted(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_RequestResponseCompleted(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Web::Http::Diagnostics::IHttpDiagnosticProviderRequestResponseCompletedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Timestamps(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RequestedUri(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ProcessId(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ThreadId(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Initiator(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SourceLocations(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Web::Http::Diagnostics::IHttpDiagnosticProviderRequestResponseTimestamps>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CacheCheckedTimestamp(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ConnectionInitiatedTimestamp(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_NameResolvedTimestamp(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SslNegotiatedTimestamp(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ConnectionCompletedTimestamp(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RequestSentTimestamp(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RequestCompletedTimestamp(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ResponseReceivedTimestamp(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ResponseCompletedTimestamp(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Web::Http::Diagnostics::IHttpDiagnosticProviderStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateFromProcessDiagnosticInfo(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Web::Http::Diagnostics::IHttpDiagnosticSourceLocation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_LineNumber(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ColumnNumber(uint64_t*) noexcept = 0;
        };
    };
    template <typename D>
