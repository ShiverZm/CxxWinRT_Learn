...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::Input::Preview::IGazeDevicePreview>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_CanTrackEyes(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_CanTrackHead(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ConfigurationState(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL RequestCalibrationAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetNumericControlDescriptions(uint16_t, uint16_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetBooleanControlDescriptions(uint16_t, uint16_t, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::Input::Preview::IGazeInputSourcePreview>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL add_GazeMoved(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_GazeMoved(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_GazeEntered(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_GazeEntered(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_GazeExited(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_GazeExited(winrt::event_token) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::Input::Preview::IGazePointPreview>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SourceDevice(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_EyeGazePosition(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_HeadGazePosition(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Timestamp(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_HidInputReport(void**) noexcept = 0;
        };
    };
    template <typename D>
