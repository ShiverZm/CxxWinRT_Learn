...
{
    struct WINRT_EBO Buffer : Windows::Storage::Streams::IBuffer
    {
    ...
    struct WINRT_EBO DataReader : Windows::Storage::Streams::IDataReader,
    ...
    struct WINRT_EBO DataReaderLoadOperation : Windows::Foundation::IAsyncOperation<uint32_t>
    {
    ...
    struct WINRT_EBO DataWriter : Windows::Storage::Streams::IDataWriter,
    ...
    struct WINRT_EBO DataWriterStoreOperation : Windows::Foundation::IAsyncOperation<uint32_t>
    {
    ...
    struct WINRT_EBO FileInputStream : Windows::Storage::Streams::IInputStream
    {
    ...
    struct WINRT_EBO FileOutputStream : Windows::Storage::Streams::IOutputStream
    {
    ...
    struct WINRT_EBO FileRandomAccessStream : Windows::Storage::Streams::IRandomAccessStream
    {
    ...
    struct WINRT_EBO InMemoryRandomAccessStream : Windows::Storage::Streams::IRandomAccessStream
    {
    ...
    struct WINRT_EBO InputStreamOverStream : Windows::Storage::Streams::IInputStream
    {
    ...
    struct WINRT_EBO OutputStreamOverStream : Windows::Storage::Streams::IOutputStream
    {
    ...
    struct WINRT_EBO RandomAccessStreamOverStream : Windows::Storage::Streams::IRandomAccessStream
    {
    ...
    struct WINRT_EBO RandomAccessStreamReference : Windows::Storage::Streams::IRandomAccessStreamReference
    {
