...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL AuthenticateWithCallbackUriAsync(uint32_t, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL AuthenticateWithoutCallbackUriAsync(uint32_t, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetCurrentApplicationCallbackUri(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL AuthenticateAndContinue(void*) noexcept = 0;
            virtual int32_t WINRT_CALL AuthenticateWithCallbackUriAndContinue(void*, void*) noexcept = 0;
            virtual int32_t WINRT_CALL AuthenticateWithCallbackUriContinuationDataAndOptionsAndContinue(void*, void*, void*, uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL AuthenticateSilentlyAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL AuthenticateSilentlyWithOptionsAsync(void*, uint32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Security::Authentication::Web::IWebAuthenticationResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_ResponseErrorDetail(uint32_t*) noexcept = 0;
        };
    };
    template <typename D>
