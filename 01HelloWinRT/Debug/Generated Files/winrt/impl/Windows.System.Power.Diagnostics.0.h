...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::System::Power::Diagnostics::IBackgroundEnergyDiagnosticsStatics>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_DeviceSpecificConversionFactor(double*) noexcept = 0;
            virtual int32_t WINRT_CALL ComputeTotalEnergyUsage(uint64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL ResetTotalEnergyUsage() noexcept = 0;
        };
    };
