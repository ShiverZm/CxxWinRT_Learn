...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IDeliveryOptimizationSettings>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_DownloadMode(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_DownloadModeSource(int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IStoreConfigurationStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL SetSystemConfiguration(void*, void*, int64_t, void*) noexcept = 0;
            virtual int32_t WINRT_CALL SetMobileOperatorConfiguration(void*, uint32_t, uint32_t) noexcept = 0;
            virtual int32_t WINRT_CALL SetStoreWebAccountId(void*) noexcept = 0;
            virtual int32_t WINRT_CALL IsStoreWebAccountId(void*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_HardwareManufacturerInfo(void**) noexcept = 0;
            virtual int32_t WINRT_CALL FilterUnsupportedSystemFeaturesAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IStoreConfigurationStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_PurchasePromptingPolicy(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_PurchasePromptingPolicy(void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IStoreConfigurationStatics3>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL HasStoreWebAccount(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL HasStoreWebAccountForUser(void*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL GetStoreLogDataAsync(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetStoreWebAccountIdForUser(void*, void*) noexcept = 0;
            virtual int32_t WINRT_CALL IsStoreWebAccountIdForUser(void*, void*, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL GetPurchasePromptingPolicyForUser(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetPurchasePromptingPolicyForUser(void*, void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IStoreConfigurationStatics4>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetStoreWebAccountId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetStoreWebAccountIdForUser(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetEnterpriseStoreWebAccountId(void*) noexcept = 0;
            virtual int32_t WINRT_CALL SetEnterpriseStoreWebAccountIdForUser(void*, void*) noexcept = 0;
            virtual int32_t WINRT_CALL GetEnterpriseStoreWebAccountId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetEnterpriseStoreWebAccountIdForUser(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ShouldRestrictToEnterpriseStoreOnly(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL ShouldRestrictToEnterpriseStoreOnlyForUser(void*, bool*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IStoreConfigurationStatics5>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL IsPinToDesktopSupported(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL IsPinToTaskbarSupported(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL IsPinToStartSupported(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL PinToDesktop(void*) noexcept = 0;
            virtual int32_t WINRT_CALL PinToDesktopForUser(void*, void*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IStoreHardwareManufacturerInfo>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_HardwareManufacturerId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_StoreContentModifierId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ModelName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ManufacturerName(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IStorePreview>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL RequestProductPurchaseByProductIdAndSkuIdAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL LoadAddOnProductInfosAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IStorePreviewProductInfo>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_ProductType(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Title(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Description(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SkuInfoList(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IStorePreviewPurchaseResults>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ProductPurchaseStatus(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IStorePreviewSkuInfo>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_ProductId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SkuId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_SkuType(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Title(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Description(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL get_FormattedListPrice(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ExtendedData(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::Preview::IWebAuthenticationCoreManagerHelper>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL RequestTokenWithUIElementHostingAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestTokenWithUIElementHostingAndWebAccountAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <typename D>
    ...
    struct consume_Windows_ApplicationModel_Store_Preview_IStoreConfigurationStatics2
    {
        ...
        void PurchasePromptingPolicy(Windows::Foundation::IReference<uint32_t> const& value) const;
    };
    ...
    struct consume_Windows_ApplicationModel_Store_Preview_IStoreConfigurationStatics3
    {
        ...
        void SetPurchasePromptingPolicyForUser(Windows::System::User const& user, Windows::Foundation::IReference<uint32_t> const& value) const;
    };
