...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::System::Preview::ITwoPanelHingedDevicePosturePreview>
    {
        ...
        {
            virtual int32_t WINRT_CALL GetCurrentPostureAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_PostureChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_PostureChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::System::Preview::ITwoPanelHingedDevicePosturePreviewReading>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_HingeState(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Panel1Orientation(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Panel1Id(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Panel2Orientation(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Panel2Id(void**) noexcept = 0;
        };
    };
