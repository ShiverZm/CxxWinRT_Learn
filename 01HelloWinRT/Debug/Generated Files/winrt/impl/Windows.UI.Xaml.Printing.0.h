...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::UI::Xaml::Printing::IAddPagesEventArgs>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_PrintTaskOptions(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Xaml::Printing::IGetPreviewPageEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_PageNumber(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Xaml::Printing::IPaginateEventArgs>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_PrintTaskOptions(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_CurrentPreviewPageNumber(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::UI::Xaml::Printing::IPrintDocument>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_DocumentSource(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_Paginate(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_Paginate(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_GetPreviewPage(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_GetPreviewPage(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_AddPages(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_AddPages(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL AddPage(void*) noexcept = 0;
            virtual int32_t WINRT_CALL AddPagesComplete() noexcept = 0;
            virtual int32_t WINRT_CALL SetPreviewPageCount(int32_t, int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL SetPreviewPage(int32_t, void*) noexcept = 0;
    ...
    template <> struct abi<Windows::UI::Xaml::Printing::IPrintDocumentStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_DocumentSourceProperty(void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_UI_Xaml_Printing_IPrintDocument
    {
        ...
        winrt::event_token Paginate(Windows::UI::Xaml::Printing::PaginateEventHandler const& handler) const;
        ...
        void Paginate(winrt::event_token const& token) const noexcept;
        winrt::event_token GetPreviewPage(Windows::UI::Xaml::Printing::GetPreviewPageEventHandler const& handler) const;
        ...
        void GetPreviewPage(winrt::event_token const& token) const noexcept;
        winrt::event_token AddPages(Windows::UI::Xaml::Printing::AddPagesEventHandler const& handler) const;
        ...
        void AddPages(winrt::event_token const& token) const noexcept;
    ...
    {
        Windows::UI::Xaml::Printing::PrintDocument CreateInstance(Windows::Foundation::IInspectable const& baseInterface, Windows::Foundation::IInspectable& innerInterface) const;
    };
