...
namespace winrt::Windows::ApplicationModel::Store
{
    ...
    struct WINRT_EBO LicenseInformation : Windows::ApplicationModel::Store::ILicenseInformation
    {
    ...
    struct WINRT_EBO ListingInformation : Windows::ApplicationModel::Store::IListingInformation,
    ...
    struct WINRT_EBO ProductLicense : Windows::ApplicationModel::Store::IProductLicense,
    ...
    struct WINRT_EBO ProductListing : Windows::ApplicationModel::Store::IProductListing,
    ...
    struct WINRT_EBO ProductPurchaseDisplayProperties : Windows::ApplicationModel::Store::IProductPurchaseDisplayProperties
    {
    ...
    struct WINRT_EBO PurchaseResults : Windows::ApplicationModel::Store::IPurchaseResults
    {
    ...
    struct WINRT_EBO UnfulfilledConsumable : Windows::ApplicationModel::Store::IUnfulfilledConsumable
    {
