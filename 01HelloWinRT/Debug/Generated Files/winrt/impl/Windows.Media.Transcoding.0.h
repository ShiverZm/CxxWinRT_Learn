...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Media::Transcoding::IMediaTranscoder>
    {
        ...
        {
            virtual int32_t WINRT_CALL put_TrimStartTime(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_TrimStartTime(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_TrimStopTime(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_TrimStopTime(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_AlwaysReencode(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_AlwaysReencode(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_HardwareAccelerationEnabled(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_HardwareAccelerationEnabled(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL AddAudioEffect(void*) noexcept = 0;
            virtual int32_t WINRT_CALL AddAudioEffectWithSettings(void*, bool, void*) noexcept = 0;
            virtual int32_t WINRT_CALL AddVideoEffect(void*) noexcept = 0;
            virtual int32_t WINRT_CALL AddVideoEffectWithSettings(void*, bool, void*) noexcept = 0;
            virtual int32_t WINRT_CALL ClearEffects() noexcept = 0;
            virtual int32_t WINRT_CALL PrepareFileTranscodeAsync(void*, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL PrepareStreamTranscodeAsync(void*, void*, void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Transcoding::IMediaTranscoder2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL PrepareMediaStreamSourceTranscodeAsync(void*, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_VideoProcessingAlgorithm(int32_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_VideoProcessingAlgorithm(int32_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Media::Transcoding::IPrepareTranscodeResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CanTranscode(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_FailureReason(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL TranscodeAsync(void**) noexcept = 0;
        };
    };
    template <typename D>
