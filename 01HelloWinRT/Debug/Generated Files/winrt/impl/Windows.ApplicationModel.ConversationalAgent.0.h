...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::ConversationalAgent::IConversationalAgentSession>
    {
        ...
        {
            virtual int32_t WINRT_CALL add_SessionInterrupted(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_SessionInterrupted(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_SignalDetected(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_SignalDetected(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL add_SystemStateChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_SystemStateChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL get_AgentState(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Signal(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsIndicatorLightAvailable(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsScreenAvailable(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsUserAuthenticated(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsVoiceActivationAvailable(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsInterruptible(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsInterrupted(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL RequestInterruptibleAsync(bool, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestInterruptible(bool, int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL RequestAgentStateChangeAsync(int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestAgentStateChange(int32_t, int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL RequestForegroundActivationAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestForegroundActivation(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL GetAudioClientAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetAudioClient(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateAudioDeviceInputNodeAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateAudioDeviceInputNode(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetAudioCaptureDeviceIdAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetAudioCaptureDeviceId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetAudioRenderDeviceIdAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetAudioRenderDeviceId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSignalModelIdAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSignalModelId(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL SetSignalModelIdAsync(uint32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL SetSignalModelId(uint32_t, bool*) noexcept = 0;
            virtual int32_t WINRT_CALL GetSupportedSignalModelIdsAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetSupportedSignalModelIds(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::ConversationalAgent::IConversationalAgentSessionStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetCurrentSessionAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetCurrentSessionSync(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::ConversationalAgent::IConversationalAgentSignal>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsSignalVerificationRequired(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL put_IsSignalVerificationRequired(bool) noexcept = 0;
            virtual int32_t WINRT_CALL get_SignalId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_SignalId(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SignalName(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_SignalName(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SignalContext(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_SignalContext(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SignalStart(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_SignalStart(int64_t) noexcept = 0;
            virtual int32_t WINRT_CALL get_SignalEnd(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_SignalEnd(int64_t) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::ConversationalAgent::IConversationalAgentSystemStateChangedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SystemStateChangeType(int32_t*) noexcept = 0;
        };
    };
    template <typename D>
