...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Perception::IPerceptionTimestamp>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_TargetTime(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PredictionAmount(int64_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Perception::IPerceptionTimestamp2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SystemRelativeTargetTime(int64_t*) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Perception::IPerceptionTimestampHelperStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL FromHistoricalTargetTime(int64_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Perception::IPerceptionTimestampHelperStatics2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL FromSystemRelativeTargetTime(int64_t, void**) noexcept = 0;
        };
    };
    template <typename D>
