...
{
    struct WINRT_EBO IndexedResourceCandidate : Windows::ApplicationModel::Resources::Management::IIndexedResourceCandidate
    {
    ...
    struct WINRT_EBO IndexedResourceQualifier : Windows::ApplicationModel::Resources::Management::IIndexedResourceQualifier
    {
    ...
    struct WINRT_EBO ResourceIndexer : Windows::ApplicationModel::Resources::Management::IResourceIndexer
    {
