...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::ApplicationModel::Store::ICurrentApp>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_LicenseInformation(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_LinkUri(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_AppId(winrt::guid*) noexcept = 0;
            virtual int32_t WINRT_CALL RequestAppPurchaseAsync(bool, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestProductPurchaseAsync(void*, bool, void**) noexcept = 0;
            virtual int32_t WINRT_CALL LoadListingInformationAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetAppReceiptAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetProductReceiptAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::Store::ICurrentAppSimulator>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL GetAppReceiptAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetProductReceiptAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReloadSimulatorAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::ICurrentAppSimulatorStaticsWithFiltering>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL LoadListingInformationByProductIdsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL LoadListingInformationByKeywordsAsync(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::ICurrentAppSimulatorWithCampaignId>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetAppPurchaseCampaignIdAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::ICurrentAppSimulatorWithConsumables>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL ReportConsumableFulfillmentAsync(void*, winrt::guid, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestProductPurchaseWithResultsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL RequestProductPurchaseWithDisplayPropertiesAsync(void*, void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL GetUnfulfilledConsumablesAsync(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::ICurrentAppStaticsWithFiltering>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL LoadListingInformationByProductIdsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL LoadListingInformationByKeywordsAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ReportProductFulfillment(void*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::Store::ILicenseInformation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ProductLicenses(void**) noexcept = 0;
            ...
            virtual int32_t WINRT_CALL add_LicenseChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_LicenseChanged(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::IListingInformation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_CurrentMarket(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Description(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ProductListings(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_FormattedPrice(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Name(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_AgeRating(uint32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::Store::IProductLicenseWithFulfillment>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_IsConsumable(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::Store::IProductListingWithConsumables>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_ProductType(int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::ApplicationModel::Store::IProductPurchaseDisplayPropertiesFactory>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateProductPurchaseDisplayProperties(void*, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::ApplicationModel::Store::IPurchaseResults>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_TransactionId(winrt::guid*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ReceiptXml(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_OfferId(void**) noexcept = 0;
        };
    };
