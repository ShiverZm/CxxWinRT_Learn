...
namespace winrt::Windows::Gaming::Input::Custom
{
    ...
    struct WINRT_EBO GipFirmwareUpdateResult : Windows::Gaming::Input::Custom::IGipFirmwareUpdateResult
    {
    ...
    struct WINRT_EBO GipGameControllerProvider : Windows::Gaming::Input::Custom::IGipGameControllerProvider
    {
    ...
    struct WINRT_EBO HidGameControllerProvider : Windows::Gaming::Input::Custom::IHidGameControllerProvider
    {
    ...
    struct WINRT_EBO XusbGameControllerProvider : Windows::Gaming::Input::Custom::IXusbGameControllerProvider
    {
