...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::WiFi::IWiFiAdapter>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL ScanAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_NetworkReport(void**) noexcept = 0;
            virtual int32_t WINRT_CALL add_AvailableNetworksChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_AvailableNetworksChanged(winrt::event_token) noexcept = 0;
            virtual int32_t WINRT_CALL ConnectAsync(void*, int32_t, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ConnectWithPasswordCredentialAsync(void*, int32_t, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ConnectWithPasswordCredentialAndSsidAsync(void*, int32_t, void*, void*, void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::WiFi::IWiFiAdapter2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL GetWpsConfigurationAsync(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL ConnectWithPasswordCredentialAndSsidAndConnectionMethodAsync(void*, int32_t, void*, void*, int32_t, void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::WiFi::IWiFiAdapterStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL FindAllAdaptersAsync(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::WiFi::IWiFiAvailableNetwork>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_Uptime(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Ssid(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_Bssid(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_ChannelCenterFrequencyInKilohertz(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_NetworkRssiInDecibelMilliwatts(double*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SignalBars(uint8_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_NetworkKind(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_PhyKind(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_SecuritySettings(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_BeaconInterval(int64_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_IsWiFiDirect(bool*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::WiFi::IWiFiNetworkReport>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_AvailableNetworks(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::WiFi::IWiFiWpsConfigurationResult>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_SupportedWpsKinds(void**) noexcept = 0;
        };
    };
    template <typename D>
