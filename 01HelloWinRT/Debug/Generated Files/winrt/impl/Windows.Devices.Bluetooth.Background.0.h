...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Devices::Bluetooth::Background::IBluetoothLEAdvertisementWatcherTriggerDetails>
    {
        ...
        {
            virtual int32_t WINRT_CALL get_Error(int32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL get_Advertisements(void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Devices::Bluetooth::Background::IGattCharacteristicNotificationTriggerDetails2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_ValueChangedEvents(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::Bluetooth::Background::IGattServiceProviderConnectionStatics>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_AllServices(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Devices::Bluetooth::Background::IRfcommConnectionTriggerDetails>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_Incoming(bool*) noexcept = 0;
            virtual int32_t WINRT_CALL get_RemoteDevice(void**) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Bluetooth::Background::IRfcommInboundConnectionInformation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_SdpRecord(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_SdpRecord(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_LocalServiceId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_LocalServiceId(void*) noexcept = 0;
            virtual int32_t WINRT_CALL get_ServiceCapabilities(uint32_t*) noexcept = 0;
            virtual int32_t WINRT_CALL put_ServiceCapabilities(uint32_t) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Devices::Bluetooth::Background::IRfcommOutboundConnectionInformation>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL get_RemoteServiceId(void**) noexcept = 0;
            virtual int32_t WINRT_CALL put_RemoteServiceId(void*) noexcept = 0;
        };
    };
    template <typename D>
