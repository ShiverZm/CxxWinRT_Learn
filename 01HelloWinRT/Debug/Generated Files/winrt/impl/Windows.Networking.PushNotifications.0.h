...
namespace winrt::impl
{
    ...
    template <> struct abi<Windows::Networking::PushNotifications::IPushNotificationChannel>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL add_PushNotificationReceived(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t WINRT_CALL remove_PushNotificationReceived(winrt::event_token) noexcept = 0;
        };
    };
    template <> struct abi<Windows::Networking::PushNotifications::IPushNotificationChannelManagerForUser>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreatePushNotificationChannelForApplicationAsync(void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreatePushNotificationChannelForApplicationAsyncWithId(void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreatePushNotificationChannelForSecondaryTileAsync(void*, void**) noexcept = 0;
    ...
    template <> struct abi<Windows::Networking::PushNotifications::IPushNotificationChannelManagerForUser2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            virtual int32_t WINRT_CALL CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsync(void*, void*, void**) noexcept = 0;
            virtual int32_t WINRT_CALL CreateRawPushNotificationChannelWithAlternateKeyForApplicationAsyncWithId(void*, void*, void*, void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Networking::PushNotifications::IPushNotificationReceivedEventArgs>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_ToastNotification(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_TileNotification(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_BadgeNotification(void**) noexcept = 0;
            virtual int32_t WINRT_CALL get_RawNotification(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<Windows::Networking::PushNotifications::IRawNotification2>
    {
        struct WINRT_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t WINRT_CALL get_ChannelId(void**) noexcept = 0;
        };
    };
    template <typename D>
