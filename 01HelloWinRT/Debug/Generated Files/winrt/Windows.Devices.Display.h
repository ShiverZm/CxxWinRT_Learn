...
namespace winrt::impl
{
    ...
    template <typename D> com_array<uint8_t> consume_Windows_Devices_Display_IDisplayMonitor<D>::GetDescriptor(Windows::Devices::Display::DisplayMonitorDescriptorKind const& descriptorKind) const
    {
        ...
        uint8_t* result;
        check_hresult(WINRT_SHIM(Windows::Devices::Display::IDisplayMonitor)->GetDescriptor(get_abi(descriptorKind), &result_impl_size, &result));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::Display::IDisplayMonitorStatics)->FromIdAsync(get_abi(deviceId), &operation));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::Display::IDisplayMonitorStatics)->FromInterfaceIdAsync(get_abi(deviceInterfaceId), &operation));
        return { operation, take_ownership_from_abi };
    }
    template <typename D>
