...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Perception::People::IEyesPose)->get_Gaze(&value));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Perception::People::IEyesPose)->get_UpdateTimestamp(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Perception::People::IEyesPoseStatics)->RequestAccessAsync(&operation));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandMeshObserver)->get_Source(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandMeshObserver)->GetTriangleIndices(indices.size(), put_abi(indices)));
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandMeshObserver)->GetVertexStateForPose(get_abi(handPose), &result));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandMeshObserver)->get_NeutralPose(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandMeshVertexState)->get_CoordinateSystem(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandMeshVertexState)->GetVertices(vertices.size(), put_abi(vertices)));
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandMeshVertexState)->get_UpdateTimestamp(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        bool result;
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandPose)->TryGetJoints(get_abi(coordinateSystem), joints.size(), get_abi(joints), jointPoses.size(), put_abi(jointPoses), &result));
        return result;
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Perception::People::IHandPose)->GetRelativeJoints(joints.size(), get_abi(joints), referenceJoints.size(), get_abi(referenceJoints), jointPoses.size(), put_abi(jointPoses)));
    }
    ...
    {
        int32_t WINRT_CALL get_IsCalibrationValid(bool* value) noexcept final try
        {
        ...
        int32_t WINRT_CALL get_Gaze(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_UpdateTimestamp(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::Perception::People::IHandMeshObserver> : produce_base<D, Windows::Perception::People::IHandMeshObserver>
    {
        ...
        int32_t WINRT_CALL get_TriangleIndexCount(uint32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL GetTriangleIndices(uint32_t __indicesSize, uint16_t* indices) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL GetVertexStateForPose(void* handPose, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_NeutralPose(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_NeutralPoseVersion(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_ModelId(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::Perception::People::IHandMeshVertexState> : produce_base<D, Windows::Perception::People::IHandMeshVertexState>
    {
        ...
        int32_t WINRT_CALL GetVertices(uint32_t __verticesSize, struct struct_Windows_Perception_People_HandMeshVertex* vertices) noexcept final try
        {
    ...
    {
        int32_t WINRT_CALL TryGetJoint(void* coordinateSystem, int32_t joint, struct struct_Windows_Perception_People_JointPose* jointPose, bool* result) noexcept final try
        {
        ...
        int32_t WINRT_CALL TryGetJoints(void* coordinateSystem, uint32_t __jointsSize, int32_t* joints, uint32_t __jointPosesSize, struct struct_Windows_Perception_People_JointPose* jointPoses, bool* result) noexcept final try
        {
        ...
        int32_t WINRT_CALL GetRelativeJoint(int32_t joint, int32_t referenceJoint, struct struct_Windows_Perception_People_JointPose* result) noexcept final try
        {
        ...
        int32_t WINRT_CALL GetRelativeJoints(uint32_t __jointsSize, int32_t* joints, uint32_t __referenceJointsSize, int32_t* referenceJoints, uint32_t __jointPosesSize, struct struct_Windows_Perception_People_JointPose* jointPoses) noexcept final try
        {
            zero_abi<Windows::Perception::People::JointPose>(jointPoses, __jointPosesSize);
            typename D::abi_guard guard(this->shim());
