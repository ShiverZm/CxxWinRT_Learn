...
namespace winrt::impl
{
    ...
    {
        int32_t WINRT_CALL get_DeviceSpecificConversionFactor(double* value) noexcept final try
        {
        ...
        int32_t WINRT_CALL ComputeTotalEnergyUsage(uint64_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL ResetTotalEnergyUsage() noexcept final try
        {
            typename D::abi_guard guard(this->shim());
