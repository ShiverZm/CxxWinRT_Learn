...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Composition::Core::ICompositorController)->get_Compositor(&value));
    ...
    {
        void* action{};
        check_hresult(WINRT_SHIM(Windows::UI::Composition::Core::ICompositorController)->EnsurePreviousCommitCompletedAsync(&action));
    ...
    struct produce<D, Windows::UI::Composition::Core::ICompositorController> : produce_base<D, Windows::UI::Composition::Core::ICompositorController>
    {
        ...
        int32_t WINRT_CALL Commit() noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().Commit();
            return 0;
        ...
        int32_t WINRT_CALL EnsurePreviousCommitCompletedAsync(void** action) noexcept final try
        {
            clear_abi(action);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL add_CommitNeeded(void* handler, winrt::event_token* token) noexcept final try
        {
