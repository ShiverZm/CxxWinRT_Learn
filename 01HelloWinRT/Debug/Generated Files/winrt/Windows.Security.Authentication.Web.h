...
namespace winrt::impl
{
    ...
    {
        void* asyncInfo{};
        check_hresult(WINRT_SHIM(Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics)->AuthenticateWithCallbackUriAsync(get_abi(options), get_abi(requestUri), get_abi(callbackUri), &asyncInfo));
    ...
    {
        void* asyncInfo{};
        check_hresult(WINRT_SHIM(Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics)->AuthenticateWithoutCallbackUriAsync(get_abi(options), get_abi(requestUri), &asyncInfo));
        return { asyncInfo, take_ownership_from_abi };
    }
    ...
    {
        void* asyncInfo{};
        check_hresult(WINRT_SHIM(Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics2)->AuthenticateSilentlyAsync(get_abi(requestUri), &asyncInfo));
        return { asyncInfo, take_ownership_from_abi };
    }
    ...
    {
        void* asyncInfo{};
        check_hresult(WINRT_SHIM(Windows::Security::Authentication::Web::IWebAuthenticationBrokerStatics2)->AuthenticateSilentlyWithOptionsAsync(get_abi(requestUri), get_abi(options), &asyncInfo));
        return { asyncInfo, take_ownership_from_abi };
    }
