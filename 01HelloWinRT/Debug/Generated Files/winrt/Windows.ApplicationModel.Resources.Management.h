...
namespace winrt::impl
{
    ...
    {
        void* qualifierValue{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::Management::IIndexedResourceCandidate)->GetQualifierValue(get_abi(qualifierName), &qualifierValue));
    ...
    {
        void* candidate{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::Management::IResourceIndexer)->IndexFilePath(get_abi(filePath), &candidate));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::Management::IResourceIndexer)->IndexFileContentsAsync(get_abi(file), &operation));
    ...
    {
        void* indexer{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::Management::IResourceIndexerFactory)->CreateResourceIndexer(get_abi(projectRoot), &indexer));
    ...
    {
        void* indexer{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::Management::IResourceIndexerFactory2)->CreateResourceIndexerWithExtension(get_abi(projectRoot), get_abi(extensionDllPath), &indexer));
        return { indexer, take_ownership_from_abi };
    }
    template <typename D>
