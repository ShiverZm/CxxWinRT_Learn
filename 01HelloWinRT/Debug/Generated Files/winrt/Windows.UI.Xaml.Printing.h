...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Xaml::Printing::IAddPagesEventArgs)->get_PrintTaskOptions(&value));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Xaml::Printing::IPaginateEventArgs)->get_PrintTaskOptions(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Xaml::Printing::IPrintDocument)->get_DocumentSource(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Xaml::Printing::IPrintDocumentFactory)->CreateInstance(get_abi(baseInterface), put_abi(innerInterface), &value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Xaml::Printing::IPrintDocumentStatics)->get_DocumentSourceProperty(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        int32_t WINRT_CALL get_PrintTaskOptions(void** value) noexcept final try
        {
            clear_abi(value);
    ...
    {
        int32_t WINRT_CALL get_PageNumber(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::UI::Xaml::Printing::IPaginateEventArgs> : produce_base<D, Windows::UI::Xaml::Printing::IPaginateEventArgs>
    {
        ...
        int32_t WINRT_CALL get_CurrentPreviewPageNumber(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL get_DocumentSource(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL add_Paginate(void* handler, winrt::event_token* token) noexcept final try
        {
        ...
        int32_t WINRT_CALL add_GetPreviewPage(void* handler, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL add_AddPages(void* handler, winrt::event_token* token) noexcept final try
        {
            zero_abi<winrt::event_token>(token);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL AddPage(void* pageVisual) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL AddPagesComplete() noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL SetPreviewPageCount(int32_t count, int32_t type) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL SetPreviewPage(int32_t pageNumber, void* pageVisual) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL InvalidatePreview() noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL get_DocumentSourceProperty(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
