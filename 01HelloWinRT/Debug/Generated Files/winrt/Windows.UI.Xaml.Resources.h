...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderFactory)->CreateInstance(get_abi(baseInterface), put_abi(innerInterface), &value));
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderOverrides)->GetResource(get_abi(resourceId), get_abi(objectType), get_abi(propertyName), get_abi(propertyType), &result));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderStatics)->get_Current(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        int32_t WINRT_CALL GetResource(void* resourceId, void* objectType, void* propertyName, void* propertyType, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderStatics> : produce_base<D, Windows::UI::Xaml::Resources::ICustomXamlResourceLoaderStatics>
    {
        ...
        int32_t WINRT_CALL put_Current(void* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
...
{
    Windows::Foundation::IInspectable GetResource(hstring resourceId, hstring objectType, hstring propertyName, hstring propertyType)
    {
