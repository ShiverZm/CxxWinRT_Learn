...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Contacts::Provider::IContactPickerUI)->get_DesiredFields(&value));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Contacts::Provider::IContactPickerUI2)->get_DesiredFieldsWithContactFieldType(&value));
        return { value, take_ownership_from_abi };
    }
    template <typename D> hstring consume_Windows_ApplicationModel_Contacts_Provider_IContactRemovedEventArgs<D>::Id() const
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Contacts::Provider::IContactRemovedEventArgs)->get_Id(&value));
        return { value, take_ownership_from_abi };
    }
    template <typename D>
    ...
    {
        int32_t WINRT_CALL AddContact(void* id, void* contact, int32_t* result) noexcept final try
        {
        ...
        int32_t WINRT_CALL RemoveContact(void* id) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL ContainsContact(void* id, bool* isContained) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL add_ContactRemoved(void* handler, winrt::event_token* token) noexcept final try
        {
    ...
    {
        int32_t WINRT_CALL AddContact(void* contact, int32_t* result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
