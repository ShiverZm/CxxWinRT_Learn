...
namespace winrt::impl
{
    ...
    {
        void* action{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Preview::InkWorkspace::IInkWorkspaceHostedAppManager)->SetThumbnailAsync(get_abi(bitmap), &action));
    ...
    {
        void* current{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Preview::InkWorkspace::IInkWorkspaceHostedAppManagerStatics)->GetForCurrentApp(&current));
    ...
    {
        int32_t WINRT_CALL SetThumbnailAsync(void* bitmap, void** action) noexcept final try
        {
            clear_abi(action);
