...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Perception::IPerceptionTimestampHelperStatics)->FromHistoricalTargetTime(get_abi(targetTime), &value));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Perception::IPerceptionTimestampHelperStatics2)->FromSystemRelativeTargetTime(get_abi(targetTime), &value));
        return { value, take_ownership_from_abi };
    }
    template <typename D>
    struct produce<D, Windows::Perception::IPerceptionTimestamp> : produce_base<D, Windows::Perception::IPerceptionTimestamp>
    {
        int32_t WINRT_CALL get_TargetTime(int64_t* value) noexcept final try
        {
        ...
        int32_t WINRT_CALL get_PredictionAmount(int64_t* value) noexcept final try
        {
    ...
    {
        int32_t WINRT_CALL get_SystemRelativeTargetTime(int64_t* value) noexcept final try
        {
            zero_abi<Windows::Foundation::TimeSpan>(value);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL FromHistoricalTargetTime(int64_t targetTime, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL FromSystemRelativeTargetTime(int64_t targetTime, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
