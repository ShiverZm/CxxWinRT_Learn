...
namespace winrt::impl
{
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Storage::Compression::ICompressor)->FinishAsync(&operation));
    ...
    {
        void* stream{};
        check_hresult(WINRT_SHIM(Windows::Storage::Compression::ICompressor)->DetachStream(&stream));
    ...
    template <typename D> Windows::Storage::Compression::Compressor consume_Windows_Storage_Compression_ICompressorFactory<D>::CreateCompressor(Windows::Storage::Streams::IOutputStream const& underlyingStream) const
    {
        ...
        check_hresult(WINRT_SHIM(Windows::Storage::Compression::ICompressorFactory)->CreateCompressor(get_abi(underlyingStream), &createdCompressor));
        return { createdCompressor, take_ownership_from_abi };
    }
    ...
    {
        void* createdCompressor{};
        check_hresult(WINRT_SHIM(Windows::Storage::Compression::ICompressorFactory)->CreateCompressorEx(get_abi(underlyingStream), get_abi(algorithm), blockSize, &createdCompressor));
        return { createdCompressor, take_ownership_from_abi };
    }
    ...
    {
        void* stream{};
        check_hresult(WINRT_SHIM(Windows::Storage::Compression::IDecompressor)->DetachStream(&stream));
        return { stream, take_ownership_from_abi };
    }
    template <typename D> Windows::Storage::Compression::Decompressor consume_Windows_Storage_Compression_IDecompressorFactory<D>::CreateDecompressor(Windows::Storage::Streams::IInputStream const& underlyingStream) const
    {
        ...
        check_hresult(WINRT_SHIM(Windows::Storage::Compression::IDecompressorFactory)->CreateDecompressor(get_abi(underlyingStream), &createdDecompressor));
        return { createdDecompressor, take_ownership_from_abi };
    }
    template <typename D>
    ...
    {
        int32_t WINRT_CALL CreateCompressor(void* underlyingStream, void** createdCompressor) noexcept final try
        {
        ...
        int32_t WINRT_CALL CreateCompressorEx(void* underlyingStream, int32_t algorithm, uint32_t blockSize, void** createdCompressor) noexcept final try
        {
            clear_abi(createdCompressor);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL CreateDecompressor(void* underlyingStream, void** createdDecompressor) noexcept final try
        {
