...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::IResourceLoader)->GetString(get_abi(resource), &value));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::IResourceLoader2)->GetStringForUri(get_abi(uri), &value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* loader{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::IResourceLoaderFactory)->CreateResourceLoaderByName(get_abi(name), &loader));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::IResourceLoaderStatics)->GetStringForReference(get_abi(uri), &value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* loader{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::IResourceLoaderStatics2)->GetForCurrentView(&loader));
        return { loader, take_ownership_from_abi };
    }
    ...
    {
        void* loader{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::IResourceLoaderStatics2)->GetForCurrentViewWithName(get_abi(name), &loader));
        return { loader, take_ownership_from_abi };
    }
    ...
    {
        void* loader{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::IResourceLoaderStatics2)->GetForViewIndependentUse(&loader));
        return { loader, take_ownership_from_abi };
    }
    ...
    {
        void* loader{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::IResourceLoaderStatics2)->GetForViewIndependentUseWithName(get_abi(name), &loader));
        return { loader, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::ApplicationModel::Resources::IResourceLoaderStatics3)->GetForUIContext(get_abi(context), &result));
    ...
    {
        int32_t WINRT_CALL GetString(void* resource, void** value) noexcept final try
        {
            clear_abi(value);
    ...
    {
        int32_t WINRT_CALL GetStringForUri(void* uri, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL CreateResourceLoaderByName(void* name, void** loader) noexcept final try
        {
            clear_abi(loader);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL GetStringForReference(void* uri, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::ApplicationModel::Resources::IResourceLoaderStatics2> : produce_base<D, Windows::ApplicationModel::Resources::IResourceLoaderStatics2>
    {
        ...
        int32_t WINRT_CALL GetForCurrentViewWithName(void* name, void** loader) noexcept final try
        {
            clear_abi(loader);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL GetForViewIndependentUseWithName(void* name, void** loader) noexcept final try
        {
            clear_abi(loader);
            typename D::abi_guard guard(this->shim());
