...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Gaming::Input::Preview::IGameControllerProviderInfoStatics)->GetParentProviderId(get_abi(provider), &value));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Gaming::Input::Preview::IGameControllerProviderInfoStatics)->GetProviderId(get_abi(provider), &value));
        return { value, take_ownership_from_abi };
    }
    template <typename D>
    ...
    {
        int32_t WINRT_CALL GetParentProviderId(void* provider, void** value) noexcept final try
        {
            clear_abi(value);
        ...
        int32_t WINRT_CALL GetProviderId(void* provider, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
