...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Media::AppBroadcasting::IAppBroadcastingStatus)->get_Details(&value));
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Media::AppBroadcasting::IAppBroadcastingUI)->GetStatus(&result));
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Media::AppBroadcasting::IAppBroadcastingUIStatics)->GetDefault(&result));
        return { result, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Media::AppBroadcasting::IAppBroadcastingUIStatics)->GetForUser(get_abi(user), &result));
        return { result, take_ownership_from_abi };
    }
    template <typename D>
    ...
    {
        int32_t WINRT_CALL get_IsCurrentAppBroadcasting(bool* value) noexcept final try
        {
        ...
        int32_t WINRT_CALL add_IsCurrentAppBroadcastingChanged(void* handler, winrt::event_token* token) noexcept final try
        {
    ...
    {
        int32_t WINRT_CALL get_CanStartBroadcast(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::Media::AppBroadcasting::IAppBroadcastingUI> : produce_base<D, Windows::Media::AppBroadcasting::IAppBroadcastingUI>
    {
        ...
        int32_t WINRT_CALL ShowBroadcastUI() noexcept final try
        {
            typename D::abi_guard guard(this->shim());
