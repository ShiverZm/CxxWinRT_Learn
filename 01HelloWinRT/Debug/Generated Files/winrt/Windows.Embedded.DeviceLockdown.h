...
namespace winrt::impl
{
    ...
    template <typename D> Windows::Foundation::IAsyncAction consume_Windows_Embedded_DeviceLockdown_IDeviceLockdownProfileStatics<D>::ApplyLockdownProfileAsync(winrt::guid const& profileID) const
    {
        ...
        check_hresult(WINRT_SHIM(Windows::Embedded::DeviceLockdown::IDeviceLockdownProfileStatics)->ApplyLockdownProfileAsync(get_abi(profileID), &ppWaitableOperation));
    ...
    {
        void* ppInformation{};
        check_hresult(WINRT_SHIM(Windows::Embedded::DeviceLockdown::IDeviceLockdownProfileStatics)->GetLockdownProfileInformation(get_abi(profileID), &ppInformation));
