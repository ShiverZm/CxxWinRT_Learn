...
namespace winrt::impl
{
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Web::IUriToStreamResolver)->UriToStreamAsync(get_abi(uri), &operation));
    ...
    {
        int32_t WINRT_CALL UriToStreamAsync(void* uri, void** operation) noexcept final try
        {
            clear_abi(operation);
