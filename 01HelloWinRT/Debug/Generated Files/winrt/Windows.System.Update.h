...
namespace winrt::impl
{
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::System::Update::ISystemUpdateManagerStatics)->BlockAutomaticRebootAsync(get_abi(lockId), &operation));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::System::Update::ISystemUpdateManagerStatics)->UnblockAutomaticRebootAsync(get_abi(lockId), &operation));
        return { operation, take_ownership_from_abi };
    }
