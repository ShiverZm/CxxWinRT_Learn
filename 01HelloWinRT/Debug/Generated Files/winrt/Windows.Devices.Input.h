...
namespace winrt::impl
{
    ...
    {
        void* mouseDevice{};
        check_hresult(WINRT_SHIM(Windows::Devices::Input::IMouseDeviceStatics)->GetForCurrentView(&mouseDevice));
        return { mouseDevice, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Devices::Input::IPenDeviceStatics)->GetFromPointerId(pointerId, &result));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::Input::IPointerDevice)->get_SupportedUsages(&value));
    ...
    {
        void* pointerDevice{};
        check_hresult(WINRT_SHIM(Windows::Devices::Input::IPointerDeviceStatics)->GetPointerDevice(pointerId, &pointerDevice));
        return { pointerDevice, take_ownership_from_abi };
    }
    ...
    {
        void* pointerDevices{};
        check_hresult(WINRT_SHIM(Windows::Devices::Input::IPointerDeviceStatics)->GetPointerDevices(&pointerDevices));
        return { pointerDevices, take_ownership_from_abi };
    }
    ...
    {
        int32_t WINRT_CALL get_KeyboardPresent(int32_t* value) noexcept final try
        {
    ...
    {
        int32_t WINRT_CALL get_MousePresent(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_VerticalWheelPresent(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_HorizontalWheelPresent(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_SwapButtons(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_NumberOfButtons(uint32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL add_MouseMoved(void* handler, winrt::event_token* cookie) noexcept final try
        {
    ...
    {
        int32_t WINRT_CALL GetForCurrentView(void** mouseDevice) noexcept final try
        {
    ...
    {
        int32_t WINRT_CALL get_MouseDelta(struct struct_Windows_Devices_Input_MouseDelta* value) noexcept final try
        {
    ...
    {
        int32_t WINRT_CALL get_PenId(winrt::guid* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL GetFromPointerId(uint32_t pointerId, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::Devices::Input::IPointerDevice> : produce_base<D, Windows::Devices::Input::IPointerDevice>
    {
        ...
        int32_t WINRT_CALL get_IsIntegrated(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_MaxContacts(uint32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_PhysicalDeviceRect(Windows::Foundation::Rect* value) noexcept final try
        {
        ...
        int32_t WINRT_CALL get_ScreenRect(Windows::Foundation::Rect* value) noexcept final try
        {
            zero_abi<Windows::Foundation::Rect>(value);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_SupportedUsages(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL get_MaxPointersWithZDistance(uint32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL GetPointerDevice(uint32_t pointerId, void** pointerDevice) noexcept final try
        {
        ...
        int32_t WINRT_CALL GetPointerDevices(void** pointerDevices) noexcept final try
        {
    ...
    {
        int32_t WINRT_CALL get_TouchPresent(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_Contacts(uint32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
