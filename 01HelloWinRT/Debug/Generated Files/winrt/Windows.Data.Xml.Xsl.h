...
namespace winrt::impl
{
    ...
    {
        void* output{};
        check_hresult(WINRT_SHIM(Windows::Data::Xml::Xsl::IXsltProcessor)->TransformToString(get_abi(inputNode), &output));
    ...
    {
        void* output{};
        check_hresult(WINRT_SHIM(Windows::Data::Xml::Xsl::IXsltProcessor2)->TransformToDocument(get_abi(inputNode), &output));
        return { output, take_ownership_from_abi };
    }
    ...
    {
        void* xsltProcessor{};
        check_hresult(WINRT_SHIM(Windows::Data::Xml::Xsl::IXsltProcessorFactory)->CreateInstance(get_abi(document), &xsltProcessor));
