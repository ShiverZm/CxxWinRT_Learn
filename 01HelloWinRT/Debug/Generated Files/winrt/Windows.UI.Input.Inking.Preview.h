...
namespace winrt::impl
{
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreviewStatics)->CreateForVisual(get_abi(inputPanelVisual), get_abi(inputPanelRect), &result));
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::UI::Input::Inking::Preview::IPalmRejectionDelayZonePreviewStatics)->CreateForVisualWithViewportClip(get_abi(inputPanelVisual), get_abi(inputPanelRect), get_abi(viewportVisual), get_abi(viewportRect), &result));
        return { result, take_ownership_from_abi };
    }
    template <typename D>
