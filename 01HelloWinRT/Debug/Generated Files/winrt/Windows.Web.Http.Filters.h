...
namespace winrt::impl
{
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Web::Http::Filters::IHttpBaseProtocolFilterStatics)->CreateForUser(get_abi(user), &result));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Web::Http::Filters::IHttpFilter)->SendRequestAsync(get_abi(request), &operation));
