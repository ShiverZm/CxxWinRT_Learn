...
namespace winrt::impl
{
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::UI::Input::Preview::IInputActivationListenerPreviewStatics)->CreateForApplicationWindow(get_abi(window), &result));
    ...
    {
        int32_t WINRT_CALL CreateForApplicationWindow(void* window, void** result) noexcept final try
        {
            clear_abi(result);
