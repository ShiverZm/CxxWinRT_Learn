...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::Custom::ICustomDevice)->get_InputStream(&value));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::Custom::ICustomDevice)->get_OutputStream(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::Custom::ICustomDevice)->SendIOControlAsync(get_abi(ioControlCode), get_abi(inputBuffer), get_abi(outputBuffer), &operation));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::Custom::ICustomDevice)->TrySendIOControlAsync(get_abi(ioControlCode), get_abi(inputBuffer), get_abi(outputBuffer), &operation));
        return { operation, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::Custom::ICustomDeviceStatics)->GetDeviceSelector(get_abi(classGuid), &value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::Custom::ICustomDeviceStatics)->FromIdAsync(get_abi(deviceId), get_abi(desiredAccess), get_abi(sharingMode), &operation));
        return { operation, take_ownership_from_abi };
    }
    ...
    {
        void* instance{};
        check_hresult(WINRT_SHIM(Windows::Devices::Custom::IIOControlCodeFactory)->CreateIOControlCode(deviceType, function, get_abi(accessMode), get_abi(bufferingMethod), &instance));
    ...
    struct produce<D, Windows::Devices::Custom::ICustomDevice> : produce_base<D, Windows::Devices::Custom::ICustomDevice>
    {
        ...
        int32_t WINRT_CALL SendIOControlAsync(void* ioControlCode, void* inputBuffer, void* outputBuffer, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL TrySendIOControlAsync(void* ioControlCode, void* inputBuffer, void* outputBuffer, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL GetDeviceSelector(winrt::guid classGuid, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL FromIdAsync(void* deviceId, int32_t desiredAccess, int32_t sharingMode, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::Devices::Custom::IIOControlCode> : produce_base<D, Windows::Devices::Custom::IIOControlCode>
    {
        ...
        int32_t WINRT_CALL get_BufferingMethod(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_Function(uint16_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_DeviceType(uint16_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_ControlCode(uint32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL CreateIOControlCode(uint16_t deviceType, uint16_t function, int32_t accessMode, int32_t bufferingMethod, void** instance) noexcept final try
        {
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL get_Unknown(uint16_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
