...
namespace winrt::impl
{
    ...
    template <typename D> winrt::event_token consume_Windows_Phone_System_Power_IPowerManagerStatics<D>::PowerSavingModeChanged(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler) const
    {
    ...
    template <typename D> void consume_Windows_Phone_System_Power_IPowerManagerStatics<D>::PowerSavingModeChanged(winrt::event_token const& token) const noexcept
    {
        WINRT_VERIFY_(0, WINRT_SHIM(Windows::Phone::System::Power::IPowerManagerStatics)->remove_PowerSavingModeChanged(get_abi(token)));
    }
    ...
    {
        int32_t WINRT_CALL get_PowerSavingMode(int32_t* value) noexcept final try
        {
        ...
        int32_t WINRT_CALL add_PowerSavingModeChanged(void* changeHandler, winrt::event_token* token) noexcept final try
        {
        ...
        int32_t WINRT_CALL remove_PowerSavingModeChanged(winrt::event_token token) noexcept final
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL get_PowerSavingModeEnabled(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
...
namespace winrt::Windows::Phone::System::Power
{
    ...
    {
        return impl::call_factory<PowerManager, Windows::Phone::System::Power::IPowerManagerStatics>([&](auto&& f) { return f.PowerSavingMode(); });
    }
    inline winrt::event_token PowerManager::PowerSavingModeChanged(Windows::Foundation::EventHandler<Windows::Foundation::IInspectable> const& changeHandler)
    {
        return impl::call_factory<PowerManager, Windows::Phone::System::Power::IPowerManagerStatics>([&](auto&& f) { return f.PowerSavingModeChanged(changeHandler); });
    }
    ...
    inline void PowerManager::PowerSavingModeChanged(winrt::event_token const& token)
    {
        impl::call_factory<PowerManager, Windows::Phone::System::Power::IPowerManagerStatics>([&](auto&& f) { return f.PowerSavingModeChanged(token); });
    }
    inline bool PowerManager::PowerSavingModeEnabled()
    {
        return impl::call_factory<PowerManager, Windows::Phone::System::Power::IPowerManagerStatics2>([&](auto&& f) { return f.PowerSavingModeEnabled(); });
    }
}
namespace std
{
    template<> struct hash<winrt::Windows::Phone::System::Power::IPowerManagerStatics> : winrt::impl::hash_base<winrt::Windows::Phone::System::Power::IPowerManagerStatics> {};
    template<> struct hash<winrt::Windows::Phone::System::Power::IPowerManagerStatics2> : winrt::impl::hash_base<winrt::Windows::Phone::System::Power::IPowerManagerStatics2> {};
    template<> struct hash<winrt::Windows::Phone::System::Power::PowerManager> : winrt::impl::hash_base<winrt::Windows::Phone::System::Power::PowerManager> {};
}
#endif
