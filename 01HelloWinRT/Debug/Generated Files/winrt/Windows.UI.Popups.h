...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IMessageDialog)->get_Title(&value));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IMessageDialog)->get_Commands(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IMessageDialog)->get_Content(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    template <typename D> Windows::Foundation::IAsyncOperation<Windows::UI::Popups::IUICommand> consume_Windows_UI_Popups_IMessageDialog<D>::ShowAsync() const
    {
        ...
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IMessageDialog)->ShowAsync(&messageDialogAsyncOperation));
        return { messageDialogAsyncOperation, take_ownership_from_abi };
    }
    ...
    {
        void* messageDialog{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IMessageDialogFactory)->Create(get_abi(content), &messageDialog));
        return { messageDialog, take_ownership_from_abi };
    }
    ...
    {
        void* messageDialog{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IMessageDialogFactory)->CreateWithTitle(get_abi(content), get_abi(title), &messageDialog));
        return { messageDialog, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IPopupMenu)->get_Commands(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* asyncOperation{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IPopupMenu)->ShowAsync(get_abi(invocationPoint), &asyncOperation));
    ...
    {
        void* asyncOperation{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IPopupMenu)->ShowAsyncWithRect(get_abi(selection), &asyncOperation));
        return { asyncOperation, take_ownership_from_abi };
    }
    ...
    {
        void* asyncOperation{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IPopupMenu)->ShowAsyncWithRectAndPlacement(get_abi(selection), get_abi(preferredPlacement), &asyncOperation));
        return { asyncOperation, take_ownership_from_abi };
    }
    template <typename D> hstring consume_Windows_UI_Popups_IUICommand<D>::Label() const
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IUICommand)->get_Label(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IUICommand)->get_Invoked(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IUICommand)->get_Id(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* instance{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IUICommandFactory)->Create(get_abi(label), &instance));
    ...
    {
        void* instance{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IUICommandFactory)->CreateWithHandler(get_abi(label), get_abi(action), &instance));
        return { instance, take_ownership_from_abi };
    }
    ...
    {
        void* instance{};
        check_hresult(WINRT_SHIM(Windows::UI::Popups::IUICommandFactory)->CreateWithHandlerAndId(get_abi(label), get_abi(action), get_abi(commandId), &instance));
        return { instance, take_ownership_from_abi };
    }
    ...
    struct produce<D, Windows::UI::Popups::IMessageDialog> : produce_base<D, Windows::UI::Popups::IMessageDialog>
    {
        ...
        int32_t WINRT_CALL ShowAsync(void** messageDialogAsyncOperation) noexcept final try
        {
    ...
    {
        int32_t WINRT_CALL Create(void* content, void** messageDialog) noexcept final try
        {
        ...
        int32_t WINRT_CALL CreateWithTitle(void* content, void* title, void** messageDialog) noexcept final try
        {
            clear_abi(messageDialog);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::UI::Popups::IPopupMenu> : produce_base<D, Windows::UI::Popups::IPopupMenu>
    {
        ...
        int32_t WINRT_CALL ShowAsync(Windows::Foundation::Point invocationPoint, void** asyncOperation) noexcept final try
        {
        ...
        int32_t WINRT_CALL ShowAsyncWithRect(Windows::Foundation::Rect selection, void** asyncOperation) noexcept final try
        {
            clear_abi(asyncOperation);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL ShowAsyncWithRectAndPlacement(Windows::Foundation::Rect selection, int32_t preferredPlacement, void** asyncOperation) noexcept final try
        {
            clear_abi(asyncOperation);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::UI::Popups::IUICommand> : produce_base<D, Windows::UI::Popups::IUICommand>
    {
        ...
        int32_t WINRT_CALL put_Invoked(void* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL Create(void* label, void** instance) noexcept final try
        {
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL CreateWithHandler(void* label, void* action, void** instance) noexcept final try
        {
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL CreateWithHandlerAndId(void* label, void* action, void* commandId, void** instance) noexcept final try
        {
            clear_abi(instance);
            typename D::abi_guard guard(this->shim());
