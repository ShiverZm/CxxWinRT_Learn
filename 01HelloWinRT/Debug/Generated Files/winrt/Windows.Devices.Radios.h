...
namespace winrt::impl
{
    ...
    {
        void* retval{};
        check_hresult(WINRT_SHIM(Windows::Devices::Radios::IRadio)->SetStateAsync(get_abi(value), &retval));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::Radios::IRadioStatics)->FromIdAsync(get_abi(deviceId), &value));
        return { value, take_ownership_from_abi };
    }
