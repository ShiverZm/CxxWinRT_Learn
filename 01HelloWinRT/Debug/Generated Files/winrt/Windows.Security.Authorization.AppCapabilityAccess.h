...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Security::Authorization::AppCapabilityAccess::IAppCapability)->get_CapabilityName(&value));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Security::Authorization::AppCapabilityAccess::IAppCapability)->get_User(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Security::Authorization::AppCapabilityAccess::IAppCapability)->RequestAccessAsync(&operation));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Security::Authorization::AppCapabilityAccess::IAppCapabilityStatics)->RequestAccessForCapabilitiesAsync(get_abi(capabilityNames), &operation));
        return { operation, take_ownership_from_abi };
    }
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Security::Authorization::AppCapabilityAccess::IAppCapabilityStatics)->RequestAccessForCapabilitiesForUserAsync(get_abi(user), get_abi(capabilityNames), &operation));
        return { operation, take_ownership_from_abi };
    }
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Security::Authorization::AppCapabilityAccess::IAppCapabilityStatics)->Create(get_abi(capabilityName), &result));
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Security::Authorization::AppCapabilityAccess::IAppCapabilityStatics)->CreateWithProcessIdForUser(get_abi(user), get_abi(capabilityName), pid, &result));
        return { result, take_ownership_from_abi };
    }
    template <typename D>
    ...
    {
        int32_t WINRT_CALL get_CapabilityName(void** value) noexcept final try
        {
            clear_abi(value);
        ...
        int32_t WINRT_CALL CheckAccess(int32_t* result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL add_AccessChanged(void* handler, winrt::event_token* token) noexcept final try
        {
    ...
    {
        int32_t WINRT_CALL RequestAccessForCapabilitiesAsync(void* capabilityNames, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL RequestAccessForCapabilitiesForUserAsync(void* user, void* capabilityNames, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL Create(void* capabilityName, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL CreateWithProcessIdForUser(void* user, void* capabilityName, uint32_t pid, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
