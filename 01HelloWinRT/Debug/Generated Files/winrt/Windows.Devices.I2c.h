...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cConnectionSettingsFactory)->Create(slaveAddress, &value));
    ...
    {
        void* device{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cController)->GetDevice(get_abi(settings), &device));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cControllerStatics)->GetControllersAsync(get_abi(provider), &operation));
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cControllerStatics)->GetDefaultAsync(&operation));
        return { operation, take_ownership_from_abi };
    }
    template <typename D> hstring consume_Windows_Devices_I2c_II2cDevice<D>::DeviceId() const
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cDevice)->get_DeviceId(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cDevice)->get_ConnectionSettings(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cDevice)->Read(buffer.size(), put_abi(buffer)));
    }
    ...
    {
        Windows::Devices::I2c::I2cTransferResult result;
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cDevice)->ReadPartial(buffer.size(), put_abi(buffer), put_abi(result)));
        return result;
    }
    ...
    {
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cDevice)->WriteRead(writeBuffer.size(), get_abi(writeBuffer), readBuffer.size(), put_abi(readBuffer)));
    }
    ...
    {
        Windows::Devices::I2c::I2cTransferResult result;
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cDevice)->WriteReadPartial(writeBuffer.size(), get_abi(writeBuffer), readBuffer.size(), put_abi(readBuffer), put_abi(result)));
        return result;
    }
    template <typename D> hstring consume_Windows_Devices_I2c_II2cDeviceStatics<D>::GetDeviceSelector() const
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cDeviceStatics)->GetDeviceSelector(&value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cDeviceStatics)->GetDeviceSelectorFromFriendlyName(get_abi(friendlyName), &value));
        return { value, take_ownership_from_abi };
    }
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Devices::I2c::II2cDeviceStatics)->FromIdAsync(get_abi(deviceId), get_abi(settings), &operation));
        return { operation, take_ownership_from_abi };
    }
    template <typename D>
    struct produce<D, Windows::Devices::I2c::II2cConnectionSettings> : produce_base<D, Windows::Devices::I2c::II2cConnectionSettings>
    {
        int32_t WINRT_CALL get_SlaveAddress(int32_t* value) noexcept final try
        {
        ...
        int32_t WINRT_CALL put_SlaveAddress(int32_t value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL get_BusSpeed(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL put_BusSpeed(int32_t value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL Create(int32_t slaveAddress, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::Devices::I2c::II2cDevice> : produce_base<D, Windows::Devices::I2c::II2cDevice>
    {
        ...
        int32_t WINRT_CALL WritePartial(uint32_t __bufferSize, uint8_t* buffer, struct struct_Windows_Devices_I2c_I2cTransferResult* result) noexcept final try
        {
        ...
        int32_t WINRT_CALL ReadPartial(uint32_t __bufferSize, uint8_t* buffer, struct struct_Windows_Devices_I2c_I2cTransferResult* result) noexcept final try
        {
            zero_abi<Windows::Devices::I2c::I2cTransferResult>(result);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL WriteRead(uint32_t __writeBufferSize, uint8_t* writeBuffer, uint32_t __readBufferSize, uint8_t* readBuffer) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL WriteReadPartial(uint32_t __writeBufferSize, uint8_t* writeBuffer, uint32_t __readBufferSize, uint8_t* readBuffer, struct struct_Windows_Devices_I2c_I2cTransferResult* result) noexcept final try
        {
            zero_abi<Windows::Devices::I2c::I2cTransferResult>(result);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, Windows::Devices::I2c::II2cDeviceStatics> : produce_base<D, Windows::Devices::I2c::II2cDeviceStatics>
    {
        ...
        int32_t WINRT_CALL FromIdAsync(void* deviceId, void* settings, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
