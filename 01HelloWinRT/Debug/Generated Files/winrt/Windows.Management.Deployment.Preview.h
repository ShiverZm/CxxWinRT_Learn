...
namespace winrt::impl
{
    ...
    {
        void* result{};
        check_hresult(WINRT_SHIM(Windows::Management::Deployment::Preview::IClassicAppManagerStatics)->FindInstalledApp(get_abi(appUninstallKey), &result));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Management::Deployment::Preview::IInstalledClassicAppInfo)->get_DisplayName(&value));
    ...
    {
        void* value{};
        check_hresult(WINRT_SHIM(Windows::Management::Deployment::Preview::IInstalledClassicAppInfo)->get_DisplayVersion(&value));
        return { value, take_ownership_from_abi };
    }
    template <typename D>
    ...
    {
        int32_t WINRT_CALL FindInstalledApp(void* appUninstallKey, void** result) noexcept final try
        {
            clear_abi(result);
