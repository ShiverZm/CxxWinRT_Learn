...
namespace winrt::impl
{
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::Phone::StartScreen::IDualSimTileStatics)->UpdateDisplayNameForSim1Async(get_abi(name), &operation));
        return { operation, take_ownership_from_abi };
    }
    ...
    {
        void* notifier{};
        check_hresult(WINRT_SHIM(Windows::Phone::StartScreen::IToastNotificationManagerStatics3)->CreateToastNotifierForSecondaryTile(get_abi(tileId), &notifier));
        return { notifier, take_ownership_from_abi };
    }
    template <typename D>
