...
namespace winrt::impl
{
    ...
    {
        void* operation{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::IPreallocatedWorkItem)->RunAsync(&operation));
    ...
    {
        void* workItem{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::IPreallocatedWorkItemFactory)->CreateWorkItem(get_abi(handler), &workItem));
        return { workItem, take_ownership_from_abi };
    }
    ...
    {
        void* WorkItem{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::IPreallocatedWorkItemFactory)->CreateWorkItemWithPriority(get_abi(handler), get_abi(priority), &WorkItem));
        return { WorkItem, take_ownership_from_abi };
    }
    ...
    {
        void* WorkItem{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::IPreallocatedWorkItemFactory)->CreateWorkItemWithPriorityAndOptions(get_abi(handler), get_abi(priority), get_abi(options), &WorkItem));
        return { WorkItem, take_ownership_from_abi };
    }
    ...
    {
        void* signalNotifier{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::ISignalNotifierStatics)->AttachToEvent(get_abi(name), get_abi(handler), &signalNotifier));
        return { signalNotifier, take_ownership_from_abi };
    }
    ...
    {
        void* signalNotifier{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::ISignalNotifierStatics)->AttachToEventWithTimeout(get_abi(name), get_abi(handler), get_abi(timeout), &signalNotifier));
        return { signalNotifier, take_ownership_from_abi };
    }
    ...
    {
        void* signalNotifier{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::ISignalNotifierStatics)->AttachToSemaphore(get_abi(name), get_abi(handler), &signalNotifier));
        return { signalNotifier, take_ownership_from_abi };
    }
    ...
    {
        void* signalNotifier{};
        check_hresult(WINRT_SHIM(Windows::System::Threading::Core::ISignalNotifierStatics)->AttachToSemaphoreWithTimeout(get_abi(name), get_abi(handler), get_abi(timeout), &signalNotifier));
        return { signalNotifier, take_ownership_from_abi };
    }
    ...
    {
        int32_t WINRT_CALL RunAsync(void** operation) noexcept final try
        {
            clear_abi(operation);
    ...
    {
        int32_t WINRT_CALL CreateWorkItem(void* handler, void** workItem) noexcept final try
        {
            clear_abi(workItem);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL CreateWorkItemWithPriority(void* handler, int32_t priority, void** WorkItem) noexcept final try
        {
            clear_abi(WorkItem);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL CreateWorkItemWithPriorityAndOptions(void* handler, int32_t priority, uint32_t options, void** WorkItem) noexcept final try
        {
            clear_abi(WorkItem);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t WINRT_CALL AttachToEvent(void* name, void* handler, void** signalNotifier) noexcept final try
        {
        ...
        int32_t WINRT_CALL AttachToEventWithTimeout(void* name, void* handler, int64_t timeout, void** signalNotifier) noexcept final try
        {
            clear_abi(signalNotifier);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL AttachToSemaphore(void* name, void* handler, void** signalNotifier) noexcept final try
        {
            clear_abi(signalNotifier);
            typename D::abi_guard guard(this->shim());
        ...
        int32_t WINRT_CALL AttachToSemaphoreWithTimeout(void* name, void* handler, int64_t timeout, void** signalNotifier) noexcept final try
        {
            clear_abi(signalNotifier);
            typename D::abi_guard guard(this->shim());
