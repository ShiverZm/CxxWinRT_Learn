...
namespace winrt::impl
{
    ...
    {
        void* text{};
        check_hresult(WINRT_SHIM(Windows::Data::Html::IHtmlUtilities)->ConvertToText(get_abi(html), &text));
        return { text, take_ownership_from_abi };
    }
    template <typename D>
    struct produce<D, Windows::Data::Html::IHtmlUtilities> : produce_base<D, Windows::Data::Html::IHtmlUtilities>
    {
        int32_t WINRT_CALL ConvertToText(void* html, void** text) noexcept final try
        {
            clear_abi(text);
